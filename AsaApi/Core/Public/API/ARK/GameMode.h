...
struct AShooterGameState : AGameState
{
	...
	TArray<TWeakObjectPtr<AActor, FWeakObjectPtr>, TSizedDefaultAllocator<32> >& ForcedRelevantPOIActorsField() { return *GetNativePointerField<TArray<TWeakObjectPtr<AActor, FWeakObjectPtr>, TSizedDefaultAllocator<32> >*>(this, "AShooterGameState.ForcedRelevantPOIActors"); }
	...
	TSharedPtr<IDataLayerWatcher, 1>& DataLayerWatcherPtrField() { return *GetNativePointerField<TSharedPtr<IDataLayerWatcher, 1>*>(this, "AShooterGameState.DataLayerWatcherPtr"); }
...
struct ABasePrimalWorldSettings : AInfo
{
	...
	TArray<TWeakObjectPtr<AActor, FWeakObjectPtr>, TSizedDefaultAllocator<32> >& QuickTickUnstasisListField() { return *GetNativePointerField<TArray<TWeakObjectPtr<AActor, FWeakObjectPtr>, TSizedDefaultAllocator<32> >*>(this, "ABasePrimalWorldSettings.QuickTickUnstasisList"); }
	...
	TArray<TWeakObjectPtr<AActor, FWeakObjectPtr>, TSizedDefaultAllocator<32> >[37] & ActorListsField() { return *GetNativePointerField<TArray<TWeakObjectPtr<AActor, FWeakObjectPtr>, TSizedDefaultAllocator<32> >[37] *>(this, "ABasePrimalWorldSettings.ActorLists"); }
...
struct AARKNXWorldSettings : AWorldSettings
{
	...
	TArray<TWeakObjectPtr<UAudioComponent, FWeakObjectPtr>, TSizedDefaultAllocator<32> >& DeferredAudioActivatesField() { return *GetNativePointerField<TArray<TWeakObjectPtr<UAudioComponent, FWeakObjectPtr>, TSizedDefaultAllocator<32> >*>(this, "AARKNXWorldSettings.DeferredAudioActivates"); }
	TArray<TWeakObjectPtr<UHierarchicalInstancedStaticMeshComponent, FWeakObjectPtr>, TSizedDefaultAllocator<32> >& DeferredMeshNavigationUpdatesField() { return *GetNativePointerField<TArray<TWeakObjectPtr<UHierarchicalInstancedStaticMeshComponent, FWeakObjectPtr>, TSizedDefaultAllocator<32> >*>(this, "AARKNXWorldSettings.DeferredMeshNavigationUpdates"); }
...
struct APrimalWorldSettings : AARKNXWorldSettings
{
	...
	TSet<TWeakObjectPtr<UNiagaraComponent, FWeakObjectPtr>, DefaultKeyFuncs<TWeakObjectPtr<UNiagaraComponent, FWeakObjectPtr>, 0>, FDefaultSetAllocator>& GloballyLimitedNiagaraComponentsField() { return *GetNativePointerField<TSet<TWeakObjectPtr<UNiagaraComponent, FWeakObjectPtr>, DefaultKeyFuncs<TWeakObjectPtr<UNiagaraComponent, FWeakObjectPtr>, 0>, FDefaultSetAllocator>*>(this, "APrimalWorldSettings.GloballyLimitedNiagaraComponents"); }
	...
	TSet<TWeakObjectPtr<UFXSystemComponent, FWeakObjectPtr>, DefaultKeyFuncs<TWeakObjectPtr<UFXSystemComponent, FWeakObjectPtr>, 0>, FDefaultSetAllocator>& DeferredFXActivationsField() { return *GetNativePointerField<TSet<TWeakObjectPtr<UFXSystemComponent, FWeakObjectPtr>, DefaultKeyFuncs<TWeakObjectPtr<UFXSystemComponent, FWeakObjectPtr>, 0>, FDefaultSetAllocator>*>(this, "APrimalWorldSettings.DeferredFXActivations"); }
...
struct AShooterGameMode : APrimalGameMode
{
	...
	TArray<TWeakObjectPtr<APrimalStructure, FWeakObjectPtr>, TSizedDefaultAllocator<32> >& PendingStructureDestroysField() { return *GetNativePointerField<TArray<TWeakObjectPtr<APrimalStructure, FWeakObjectPtr>, TSizedDefaultAllocator<32> >*>(this, "AShooterGameMode.PendingStructureDestroys"); }
	...
	TMap<FName, TWeakObjectPtr<UClass, FWeakObjectPtr>, FDefaultSetAllocator, TDefaultMapHashableKeyFuncs<FName, TWeakObjectPtr<UClass, FWeakObjectPtr>, 0> >& PrioritizedObjectMapField() { return *GetNativePointerField<TMap<FName, TWeakObjectPtr<UClass, FWeakObjectPtr>, FDefaultSetAllocator, TDefaultMapHashableKeyFuncs<FName, TWeakObjectPtr<UClass, FWeakObjectPtr>, 0> >*>(this, "AShooterGameMode.PrioritizedObjectMap"); }
	...
	void RemoveLoginLock(const TSharedPtr<FUniqueNetId const, 1>* UniqueNetId) { NativeCall<void, const TSharedPtr<FUniqueNetId const, 1>*>(this, "AShooterGameMode.RemoveLoginLock(TSharedPtr<FUniqueNetId,1>*)", UniqueNetId); }
	void RemoveConnectedPlayer(const TSharedPtr<FUniqueNetId const, 1>* UniqueNetId) { NativeCall<void, const TSharedPtr<FUniqueNetId const, 1>*>(this, "AShooterGameMode.RemoveConnectedPlayer(TSharedPtr<FUniqueNetId,1>*)", UniqueNetId); }
	...
	TSharedPtr<FWriteFileTaskInfo, 1>* SavePlayerData(TSharedPtr<FWriteFileTaskInfo, 1>* result, UPrimalPlayerData* PlayerData, bool bSaveBackup) { return NativeCall<TSharedPtr<FWriteFileTaskInfo, 1> *, TSharedPtr<FWriteFileTaskInfo, 1>*, UPrimalPlayerData*, bool>(this, "AShooterGameMode.SavePlayerData(TSharedPtr<FWriteFileTaskInfo,1>*,UPrimalPlayerData*,bool)", result, PlayerData, bSaveBackup); }
	TSharedPtr<FWriteFileTaskInfo, 1>* SaveTribeData(TSharedPtr<FWriteFileTaskInfo, 1>* result, const FTribeData* TribeData, bool bCanDeferToTick) { return NativeCall<TSharedPtr<FWriteFileTaskInfo, 1> *, TSharedPtr<FWriteFileTaskInfo, 1>*, const FTribeData*, bool>(this, "AShooterGameMode.SaveTribeData(TSharedPtr<FWriteFileTaskInfo,1>*,FTribeData*,bool)", result, TribeData, bCanDeferToTick); }
	...
	static void AddPlayerID() { NativeCall<void>(nullptr, "AShooterGameMode.AddPlayerID()"); }
