...
struct UPrimalItem : UObject
{
    ...
    TWeakObjectPtr<UPrimalInventoryComponent, FWeakObjectPtr>& OwnerInventoryField() { return *GetNativePointerField<TWeakObjectPtr<UPrimalInventoryComponent, FWeakObjectPtr>*>(this, "UPrimalItem.OwnerInventory"); }
    ...
    TWeakObjectPtr<AShooterWeapon, FWeakObjectPtr>& AssociatedWeaponField() { return *GetNativePointerField<TWeakObjectPtr<AShooterWeapon, FWeakObjectPtr>*>(this, "UPrimalItem.AssociatedWeapon"); }
    ...
    TWeakObjectPtr<AShooterCharacter, FWeakObjectPtr>& LastOwnerPlayerField() { return *GetNativePointerField<TWeakObjectPtr<AShooterCharacter, FWeakObjectPtr>*>(this, "UPrimalItem.LastOwnerPlayer"); }
...
struct ADroppedItem : AActor
{
    ...
    TWeakObjectPtr<AActor, FWeakObjectPtr>& DroppedByActorField() { return *GetNativePointerField<TWeakObjectPtr<AActor, FWeakObjectPtr>*>(this, "ADroppedItem.DroppedByActor"); }
...
struct UPrimalInventoryComponent : UActorComponent
{
    ...
    TMap<TWeakObjectPtr<UClass, FWeakObjectPtr>, FWirelessResourceData, FDefaultSetAllocator, TDefaultMapHashableKeyFuncs<TWeakObjectPtr<UClass, FWeakObjectPtr>, FWirelessResourceData, 0> >& WirelessResourceMapField() { return *GetNativePointerField<TMap<TWeakObjectPtr<UClass, FWeakObjectPtr>, FWirelessResourceData, FDefaultSetAllocator, TDefaultMapHashableKeyFuncs<TWeakObjectPtr<UClass, FWeakObjectPtr>, FWirelessResourceData, 0> >*>(this, "UPrimalInventoryComponent.WirelessResourceMap"); }
