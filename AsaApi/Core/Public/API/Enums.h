...
enum tagApplicationType:int
{
	ServerApplication = 0x0,
	LibraryApplication = 0x1
};

enum _URLZONEREG:int
{
...
enum tagShutdownType:int
{
	IdleShutdown = 0x0,
	ForcedShutdown = 0x1
};

enum PIDMSI_STATUS_VALUE:int
{
...
enum tagGLOBALOPT_EH_VALUES:int
{
...
enum APPLICATION_VIEW_STATE:int
{
...
enum DEFAULTSAVEFOLDERTYPE:int
{
	DSFT_DETECT = 0x1,
	DSFT_PRIVATE = 0x2,
	DSFT_PUBLIC = 0x3
...
enum NATIVE_DISPLAY_ORIENTATION:int
{
	NDO_LANDSCAPE = 0x0,
	NDO_PORTRAIT = 0x1
};

enum APPLICATION_VIEW_ORIENTATION:int
{
	AVO_LANDSCAPE = 0x0,
	AVO_PORTRAIT = 0x1
};
...
enum KNOWNDESTCATEGORY:int
{
	KDC_FREQUENT = 0x1,
	KDC_RECENT = 0x2
};

enum tagBANDSITECID:int
{
	BSID_BANDADDED = 0x0,
...
enum tagCONDITION_OPERATION:int
{
	COP_IMPLICIT = 0x0,
	COP_EQUAL = 0x1,
	COP_NOTEQUAL = 0x2,
...
enum VkQueueGlobalPriorityEXT:int
{
...
enum NvAPIPrivateConstDataSlot:int
{
...
enum _NVAPI_VIDEO_STATE_COMPONENT_ID:int
{
...
enum NV_GPU_PERF_CHANGE_SEQ_2X_STEP_ID:int
{
...
enum NV_GPU_PERF_VPSTATES_IDX:int
{
...
enum NV_GPU_PERF_CHANGE_SEQ_PMU_STEP_ID:int
{
...
enum _NVAPI_VIDEO_CONTROL_COMPONENT_ALGORITHM:int
{
...
enum NV_GPU_PERF_RATED_TDP_CLIENT:int
{
...
enum NV_GPU_CLOCK_CLK_VF_POINT_TYPE:int
{
...
enum VkAccelerationStructureTypeNV:int
{
...
enum VkRayTracingShaderGroupTypeNV:int
{
...
enum VkCopyAccelerationStructureModeNV:int
{
...
enum VkSamplerReductionModeEXT:int
{
...
enum VkIndirectCommandsTokenTypeNVX:int
{
...
enum VkShaderFloatControlsIndependenceKHR:int
{
...
enum VkSemaphoreImportFlagBits:int
{
...
enum FWPI_VPN_TRIGGER_EVENT_TYPE_:int
{
...
enum FWPM_PROVIDER_CONTEXT_TYPE_:int
{
...
enum FWPM_EVENT_PROVIDER_TYPE_:int
{
...
enum FWPM_CONNECTION_EVENT_TYPE_:int
{
...
enum IKEEXT_AUTHENTICATION_METHOD_TYPE_:int
{
...
enum IKEEXT_CERT_CONFIG_TYPE_:int
{
...
enum FWPM_VSWITCH_EVENT_TYPE_:int
{
...
enum _NDIS_NET_BUFFER_LIST_INFO:int
{
...
enum IKEEXT_CERT_POLICY_PROTOCOL_TYPE_:int
{
...
enum FWPM_APPC_NETWORK_CAPABILITY_TYPE_:int
{
...
enum FWP_VSWITCH_NETWORK_TYPE_:int
{
...
enum _NDIS_802_11_WEP_STATUS:int
{
...
enum IKEEXT_CERT_CRITERIA_NAME_TYPE_:int
{
...
enum FWPS_ALE_PORT_STATUS0_:int
{
...
enum _NPI_MODULEID_TYPE:int
{
	MIT_GUID = 0x1,
	MIT_IF_LUID = 0x2
};

enum FWPM_SERVICE_STATE_:int
{
...
enum IKEEXT_AUTHENTICATION_IMPERSONATION_TYPE_:int
{
...
enum _NDIS_PROCESSOR_VENDOR:int
{
...
enum FWP_FILTER_ENUM_TYPE_:int
{
...
enum IKEEXT_INTEGRITY_TYPE_:int
{
...
enum FWP_CLASSIFY_OPTION_TYPE_:int
{
...
enum IPSEC_TRANSFORM_TYPE_:int
{
...
enum FWPP_SUBLAYER_INTERNAL_:int
{
...
enum FWPS_GENERAL_DISCARD_REASON_:int
{
...
enum IKEEXT_KEY_MODULE_TYPE_:int
{
...
enum FWPM_NET_FAILURE_CAUSE_:int
{
...
enum NETIO_TRIAGE_BLOCK_ID:int
{
...
enum IPSEC_TOKEN_PRINCIPAL_:int
{
...
enum FWPS_DISCARD_MODULE0_:int
{
...
enum IPSEC_SA_CONTEXT_EVENT_TYPE0_:int
{
...
enum FWPS_NET_BUFFER_LIST_EVENT_TYPE0_:int
{
...
enum FWPS_CALLOUT_NOTIFY_TYPE_:int
{
...
enum _FILE_INFORMATION_CLASS:int
{
...
enum _WHEA_ERROR_PACKET_DATA_FORMAT:int
{
...
enum _IO_ALLOCATION_ACTION:int
{
	KeepObject = 0x1,
...
enum _WHEA_ERROR_SOURCE_TYPE:int
{
...
enum _WHEA_EVENT_LOG_ENTRY_TYPE:int
{
...
enum FWPS_NET_BUFFER_LIST_TYPE_:int
{
...
enum _BasicControlMode_e:int
{
	BasicControlMode_Manual = 0x0,
	BasicControlMode_Auto = 0x1
};

enum _SAR_STREAM_INVALIDATION_EVENT_TYPE:int
{
...
enum WINDOWTHEMEATTRIBUTETYPE:int
{
	WTA_NONCLIENT = 0x1
};

enum DIT_HITTESTATTRIBUTES:int
{
...
enum SET_WINDOW_GROUP_OPTIONS:int
{
	SWGO_NONE = 0x0,
	SWGO_TEMPLATE = 0x1,
	SWGO_NOZORDER = 0x2,
...
enum SPATIAL_INPUT_ACTIVATION_POLICY:int
{
	SIAP_ACTIVATE = 0x0,
	SIAP_NOACTIVATE = 0x1,
...
enum INPUTDELEGATION_MODE_FLAGS:int
{
	IDLM_OFF = 0x0,
	IDLM_KEYBOARD = 0x1,
	IDLM_SPATIAL = 0x2,
...
enum INPUT_DESTINATION_ROUTING_MODE:int
{
	IDRM_DEFAULT = 0x0,
	IDRM_OBSERVE = 0x1,
	IDRM_ISM = 0x2,
...
enum InteractionSourceTypes:int
{
	None = 0x0,
	Dmanip = 0x1,
	VisualInteractionSource = 0x2,
	Other = 0x4,
	All = 0x7
};

enum GROUP_WINDOW_MANAGEMENT_POLICY:int
{
	GWMP_NONE = 0x0,
...
enum INPUT_DESTINATION_IDENTITY:int
{
	IDID_NONE = 0x0,
	IDID_LUID = 0x1,
...
enum EClassCastFlags:unsigned __int64
{
	CASTCLASS_None = 0x0,
...
enum EClassFlags:unsigned __int64
{
	CLASS_None = 0x0,
	CLASS_Abstract = 0x1,
...
enum EMaterialValueType:unsigned __int64
{
	MCT_Float1 = 0x1,
	MCT_Float2 = 0x2,
	MCT_Float3 = 0x4,
...
enum ENameCase:unsigned char
{
	CaseSensitive = 0x0,
	IgnoreCase = 0x1
};

enum ModItemStatus:int
{
	IS_None = 0x0,
	IS_Ready = 0x1,
...
enum EUniformBufferBaseType:unsigned char
{
	UBMT_INVALID = 0x0,
	UBMT_BOOL = 0x1,
	UBMT_INT32 = 0x2,
...
enum EVRSRateCombiner:unsigned char
{
...
enum EParticleStates:unsigned __int64
{
...
enum EParticleVertexFactoryType:int
{
	PVFT_Sprite = 0x0,
	PVFT_BeamTrail = 0x1,
	PVFT_Mesh = 0x2,
...
enum EBulkDataFlags:unsigned int
{
	BULKDATA_None = 0x0,
...
enum EPixelFormat:unsigned char
{
	PF_Unknown = 0x0,
...
enum GPUSkinBoneInfluenceType:int
{
	DefaultBoneInfluence = 0x0,
	UnlimitedBoneInfluence = 0x1
};

enum ELightInteractionType:int
{
...
enum EStructFlags:unsigned __int64
{
	STRUCT_NoFlags = 0x0,
	STRUCT_Native = 0x1,
...
enum EVRSAxisShadingRate:unsigned char
{
	VRSASR_1X = 0x0,
	VRSASR_2X = 0x1,
	VRSASR_4X = 0x2
...
enum ERangeCompressionMode:int
{
	RCM_UNorm = 0x0,
	RCM_SNorm = 0x1,
	RCM_MinMaxNorm = 0x2,
...
enum EShadowMapInteractionType:int
{
	SMIT_None = 0x0,
...
enum EPolyFlags:unsigned __int64
{
	PF_Invisible = 0x1,
	PF_NotSolid = 0x8,
	PF_Semisolid = 0x20,
...
enum ELightMapInteractionType:int
{
	LMIT_None = 0x0,
...
enum EShaderPlatform:unsigned short
{
	SP_PCD3D_SM5 = 0x0,
	SP_METAL = 0xB,
	SP_METAL_MRT = 0xC,
...
enum EFunctionFlags:unsigned int
{
	FUNC_None = 0x0,
	FUNC_Final = 0x1,
...
enum EConsoleVariableFlags:unsigned __int64
{
...
enum EPackageFlags:unsigned __int64
{
	PKG_None = 0x0,
...
enum EUnrealEngineObjectUE4Version:int
{
	VER_UE4_OLDEST_LOADABLE_PACKAGE = 0xD6,
	...
	VER_UE4_FIX_REFRACTION_INPUT_MASKING = 0x192,
	VER_UE4_GLOBAL_EMITTER_SPAWN_RATE_SCALE = 0x193,
	VER_UE4_CLEAN_DESTRUCTIBLE_SETTINGS = 0x194,
	VER_UE4_CHARACTER_MOVEMENT_UPPER_IMPACT_BEHAVIOR = 0x195,
	VER_UE4_BP_MATH_VECTOR_EQUALITY_USES_EPSILON = 0x196,
	VER_UE4_FOLIAGE_STATIC_LIGHTING_SUPPORT = 0x197,
	VER_UE4_SLATE_COMPOSITE_FONTS = 0x198,
	VER_UE4_REMOVE_SAVEGAMESUMMARY = 0x199,
	VER_UE4_REMOVE_SKELETALMESH_COMPONENT_BODYSETUP_SERIALIZATION = 0x19A,
	VER_UE4_SLATE_BULK_FONT_DATA = 0x19B,
	VER_UE4_ADD_PROJECTILE_FRICTION_BEHAVIOR = 0x19C,
	VER_UE4_MOVEMENTCOMPONENT_AXIS_SETTINGS = 0x19D,
	VER_UE4_GRAPH_INTERACTIVE_COMMENTBUBBLES = 0x19E,
	VER_UE4_LANDSCAPE_SERIALIZE_PHYSICS_MATERIALS = 0x19F,
	VER_UE4_RENAME_WIDGET_VISIBILITY = 0x1A0,
	VER_UE4_ANIMATION_ADD_TRACKCURVES = 0x1A1,
	VER_UE4_MONTAGE_BRANCHING_POINT_REMOVAL = 0x1A2,
	VER_UE4_BLUEPRINT_ENFORCE_CONST_IN_FUNCTION_OVERRIDES = 0x1A3,
	VER_UE4_ADD_PIVOT_TO_WIDGET_COMPONENT = 0x1A4,
	VER_UE4_PAWN_AUTO_POSSESS_AI = 0x1A5,
	VER_UE4_FTEXT_HISTORY_DATE_TIMEZONE = 0x1A6,
	VER_UE4_SORT_ACTIVE_BONE_INDICES = 0x1A7,
	VER_UE4_PERFRAME_MATERIAL_UNIFORM_EXPRESSIONS = 0x1A8,
	VER_UE4_MIKKTSPACE_IS_DEFAULT = 0x1A9,
	VER_UE4_LANDSCAPE_GRASS_COOKING = 0x1AA,
	VER_UE4_FIX_SKEL_VERT_ORIENT_MESH_PARTICLES = 0x1AB,
	VER_UE4_LANDSCAPE_STATIC_SECTION_OFFSET = 0x1AC,
	VER_UE4_ADD_MODIFIERS_RUNTIME_GENERATION = 0x1AD,
	VER_UE4_MATERIAL_MASKED_BLENDMODE_TIDY = 0x1AE,
	VER_UE4_MERGED_ADD_MODIFIERS_RUNTIME_GENERATION_TO_4_7_DEPRECATED = 0x1AF,
	VER_UE4_AFTER_MERGED_ADD_MODIFIERS_RUNTIME_GENERATION_TO_4_7_DEPRECATED = 0x1B0,
	VER_UE4_MERGED_ADD_MODIFIERS_RUNTIME_GENERATION_TO_4_7 = 0x1B1,
	VER_UE4_AFTER_MERGING_ADD_MODIFIERS_RUNTIME_GENERATION_TO_4_7 = 0x1B2,
	VER_UE4_SERIALIZE_LANDSCAPE_GRASS_DATA = 0x1B3,
	VER_UE4_OPTIONALLY_CLEAR_GPU_EMITTERS_ON_INIT = 0x1B4,
	VER_UE4_SERIALIZE_LANDSCAPE_GRASS_DATA_MATERIAL_GUID = 0x1B5,
	VER_UE4_BLUEPRINT_GENERATED_CLASS_COMPONENT_TEMPLATES_PUBLIC = 0x1B6,
	VER_UE4_ACTOR_COMPONENT_CREATION_METHOD = 0x1B7,
	VER_UE4_K2NODE_EVENT_MEMBER_REFERENCE = 0x1B8,
	VER_UE4_STRUCT_GUID_IN_PROPERTY_TAG = 0x1B9,
	VER_UE4_REMOVE_UNUSED_UPOLYS_FROM_UMODEL = 0x1BA,
	VER_UE4_REBUILD_HIERARCHICAL_INSTANCE_TREES = 0x1BB,
	VER_UE4_PACKAGE_SUMMARY_HAS_COMPATIBLE_ENGINE_VERSION = 0x1BC,
	VER_UE4_TRACK_UCS_MODIFIED_PROPERTIES = 0x1BD,
	VER_UE4_LANDSCAPE_SPLINE_CROSS_LEVEL_MESHES = 0x1BE,
	VER_UE4_DEPRECATE_USER_WIDGET_DESIGN_SIZE = 0x1BF,
	VER_UE4_ADD_EDITOR_VIEWS = 0x1C0,
	VER_UE4_FOLIAGE_WITH_ASSET_OR_CLASS = 0x1C1,
	VER_UE4_BODYINSTANCE_BINARY_SERIALIZATION = 0x1C2,
	VER_UE4_SERIALIZE_BLUEPRINT_EVENTGRAPH_FASTCALLS_IN_UFUNCTION = 0x1C3,
	VER_UE4_INTERPCURVE_SUPPORTS_LOOPING = 0x1C4,
	VER_UE4_MATERIAL_INSTANCE_BASE_PROPERTY_OVERRIDES_DITHERED_LOD_TRANSITION = 0x1C5,
	VER_UE4_SERIALIZE_LANDSCAPE_ES2_TEXTURES = 0x1C6,
	VER_UE4_CONSTRAINT_INSTANCE_MOTOR_FLAGS = 0x1C7,
	VER_UE4_SERIALIZE_PINTYPE_CONST = 0x1C8,
	VER_UE4_LIBRARY_CATEGORIES_AS_FTEXT = 0x1C9,
	VER_UE4_SKIP_DUPLICATE_EXPORTS_ON_SAVE_PACKAGE = 0x1CA,
	VER_UE4_SERIALIZE_TEXT_IN_PACKAGES = 0x1CB,
	VER_UE4_ADD_BLEND_MODE_TO_WIDGET_COMPONENT = 0x1CC,
	VER_UE4_NEW_LIGHTMASS_PRIMITIVE_SETTING = 0x1CD,
	VER_UE4_REPLACE_SPRING_NOZ_PROPERTY = 0x1CE,
	VER_UE4_TIGHTLY_PACKED_ENUMS = 0x1CF,
	VER_UE4_ASSET_IMPORT_DATA_AS_JSON = 0x1D0,
	VER_UE4_TEXTURE_LEGACY_GAMMA = 0x1D1,
	VER_UE4_ADDED_NATIVE_SERIALIZATION_FOR_IMMUTABLE_STRUCTURES = 0x1D2,
	VER_UE4_DEPRECATE_UMG_STYLE_OVERRIDES = 0x1D3,
	VER_UE4_STATIC_SHADOWMAP_PENUMBRA_SIZE = 0x1D4,
	VER_UE4_NIAGARA_DATA_OBJECT_DEV_UI_FIX = 0x1D5,
	VER_UE4_FIXED_DEFAULT_ORIENTATION_OF_WIDGET_COMPONENT = 0x1D6,
	VER_UE4_REMOVED_MATERIAL_USED_WITH_UI_FLAG = 0x1D7,
	VER_UE4_CHARACTER_MOVEMENT_ADD_BRAKING_FRICTION = 0x1D8,
	VER_UE4_BSP_UNDO_FIX = 0x1D9,
	VER_UE4_DYNAMIC_PARAMETER_DEFAULT_VALUE = 0x1DA,
	VER_UE4_STATIC_MESH_EXTENDED_BOUNDS = 0x1DB,
	VER_UE4_ADDED_NON_LINEAR_TRANSITION_BLENDS = 0x1DC,
	VER_UE4_AO_MATERIAL_MASK = 0x1DD,
	VER_UE4_NAVIGATION_AGENT_SELECTOR = 0x1DE,
	VER_UE4_MESH_PARTICLE_COLLISIONS_CONSIDER_PARTICLE_SIZE = 0x1DF,
	VER_UE4_BUILD_MESH_ADJ_BUFFER_FLAG_EXPOSED = 0x1E0,
	VER_UE4_MAX_ANGULAR_VELOCITY_DEFAULT = 0x1E1,
	VER_UE4_APEX_CLOTH_TESSELLATION = 0x1E2,
	VER_UE4_DECAL_SIZE = 0x1E3,
	VER_UE4_KEEP_ONLY_PACKAGE_NAMES_IN_STRING_ASSET_REFERENCES_MAP = 0x1E4,
	VER_UE4_COOKED_ASSETS_IN_EDITOR_SUPPORT = 0x1E5,
	VER_UE4_DIALOGUE_WAVE_NAMESPACE_AND_CONTEXT_CHANGES = 0x1E6,
	VER_UE4_MAKE_ROT_RENAME_AND_REORDER = 0x1E7,
	VER_UE4_K2NODE_VAR_REFERENCEGUIDS = 0x1E8,
	VER_UE4_SOUND_CONCURRENCY_PACKAGE = 0x1E9,
	VER_UE4_USERWIDGET_DEFAULT_FOCUSABLE_FALSE = 0x1EA,
	VER_UE4_BLUEPRINT_CUSTOM_EVENT_CONST_INPUT = 0x1EB,
	VER_UE4_USE_LOW_PASS_FILTER_FREQ = 0x1EC,
	VER_UE4_NO_ANIM_BP_CLASS_IN_GAMEPLAY_CODE = 0x1ED,
	VER_UE4_SCS_STORES_ALLNODES_ARRAY = 0x1EE,
	VER_UE4_FBX_IMPORT_DATA_RANGE_ENCAPSULATION = 0x1EF,
	VER_UE4_CAMERA_COMPONENT_ATTACH_TO_ROOT = 0x1F0,
	VER_UE4_INSTANCED_STEREO_UNIFORM_UPDATE = 0x1F1,
	VER_UE4_STREAMABLE_TEXTURE_MIN_MAX_DISTANCE = 0x1F2,
	VER_UE4_INJECT_BLUEPRINT_STRUCT_PIN_CONVERSION_NODES = 0x1F3,
	VER_UE4_INNER_ARRAY_TAG_INFO = 0x1F4,
	VER_UE4_FIX_SLOT_NAME_DUPLICATION = 0x1F5,
	VER_UE4_STREAMABLE_TEXTURE_AABB = 0x1F6,
	VER_UE4_PROPERTY_GUID_IN_PROPERTY_TAG = 0x1F7,
	VER_UE4_NAME_HASHES_SERIALIZED = 0x1F8,
	VER_UE4_INSTANCED_STEREO_UNIFORM_REFACTOR = 0x1F9,
	VER_UE4_COMPRESSED_SHADER_RESOURCES = 0x1FA,
	VER_UE4_PRELOAD_DEPENDENCIES_IN_COOKED_EXPORTS = 0x1FB,
	VER_UE4_TemplateIndex_IN_COOKED_EXPORTS = 0x1FC,
	VER_UE4_PROPERTY_TAG_SET_MAP_SUPPORT = 0x1FD,
	VER_UE4_ADDED_SEARCHABLE_NAMES = 0x1FE,
	VER_UE4_64BIT_EXPORTMAP_SERIALSIZES = 0x1FF,
	VER_UE4_SKYLIGHT_MOBILE_IRRADIANCE_MAP = 0x200,
	VER_UE4_ADDED_SWEEP_WHILE_WALKING_FLAG = 0x201,
	VER_UE4_ADDED_SOFT_OBJECT_PATH = 0x202,
	VER_UE4_POINTLIGHT_SOURCE_ORIENTATION = 0x203,
	VER_UE4_ADDED_PACKAGE_SUMMARY_LOCALIZATION_ID = 0x204,
	VER_UE4_FIX_WIDE_STRING_CRC = 0x205,
	VER_UE4_ADDED_PACKAGE_OWNER = 0x206,
	VER_UE4_SKINWEIGHT_PROFILE_DATA_LAYOUT_CHANGES = 0x207,
	VER_UE4_NON_OUTER_PACKAGE_IMPORT = 0x208,
	VER_UE4_ASSETREGISTRY_DEPENDENCYFLAGS = 0x209,
	VER_UE4_CORRECT_LICENSEE_FLAG = 0x20A,
	VER_UE4_AUTOMATIC_VERSION_PLUS_ONE = 0x20B,
	VER_UE4_AUTOMATIC_VERSION = 0x20A
};
...
enum EShaderFrequency:unsigned char
{
	SF_Vertex = 0x0,
	SF_Mesh = 0x1,
...
enum ELoadFlags:unsigned __int64
{
	LOAD_None = 0x0,
	LOAD_Async = 0x1,
	LOAD_NoWarn = 0x2,
...
enum ERDGViewType:unsigned char
{
	TextureUAV = 0x0,
	TextureSRV = 0x1,
	BufferUAV = 0x2,
...
enum EShaderCompileJobType:unsigned char
{
	Single = 0x0,
	Pipeline = 0x1,
	Num = 0x2
...
enum EUnrealEngineObjectLicenseeUEVersion:int
{
	VER_LIC_NONE = 0x0,
	...
	VER_LIC_PRIMAL2 = 0xB,
	VER_LIC_FLOATACCURACY_INSTANCES = 0xC,
	VER_LIC_AUTOMATIC_VERSION_PLUS_ONE = 0xD,
	VER_LIC_AUTOMATIC_VERSION = 0xC
};

enum EGBufferCompression:int
{
	GBC_Invalid = 0x0,
...
enum ENetworkVersionHistory:int
{
...
enum EAsyncIOPriorityAndFlags:int
{
...
enum EResourceAlignment:int
{
	VERTEXBUFFER_ALIGNMENT = 0x0,
	INDEXBUFFER_ALIGNMENT = 0x0
};

enum EMemoryTraceRootHeap:unsigned char
{
	SystemMemory = 0x0,
	VideoMemory = 0x1,
	EndHardcoded = 0x1,
...
enum EIoDispatcherPriority:unsigned __int64
{
...
enum ESaveFlags:unsigned __int64
{
	SAVE_None = 0x0,
	SAVE_NoError = 0x1,
...
enum ECameraShakePlaySpace:unsigned char
{
	CameraLocal = 0x0,
	World = 0x1,
	UserDefined = 0x2
...
enum ERHIAccess:unsigned int
{
	...
	BVHWrite = 0x10000,
	Discard = 0x20000,
	ShadingRateSource = 0x40000,
	Last = 0x40000,
	None = 0x0,
	Mask = 0x7FFFF,
	SRVMask = 0x30,
	UAVMask = 0x600,
	ReadOnlyExclusiveMask = 0xFFFF80FF,
	ReadOnlyExclusiveComputeMask = 0xFFFF8055,
	ReadOnlyMask = 0x481FF,
	ReadableMask = 0x487FF,
	WriteOnlyExclusiveMask = 0x3800,
	WriteOnlyMask = 0x7800,
	WritableMask = 0x17E00
};
...
enum ETextureCreateFlags:unsigned __int64
{
	...
	ResolveTargetable = 0x2,
	DepthStencilTargetable = 0x4,
	ShaderResource = 0x8,
	SRGB = 0x10,
	CPUWritable = 0x20,
	NoTiling = 0x40,
	...
	Tiling3D = 0x800,
	Memoryless = 0x1000,
	GenerateMipCapable = 0x2000,
	FastVRAMPartialAlloc = 0x4000,
	DisableSRVCreation = 0xFFFF8000,
	DisableDCC = 0x10000,
	UAV = 0x20000,
	Presentable = 0x40000,
	CPUReadback = 0x80000,
	OfflineProcessed = 0x100000,
	FastVRAM = 0x200000,
	HideInVisualizeTexture = 0x400000,
	Virtual = 0x800000,
	TargetArraySlicesIndependently = 0x1000000,
	Shared = 0x2000000,
	NoFastClear = 0x4000000,
	DepthStencilResolveTarget = 0x8000000,
	Streamable = 0x10000000,
	NoFastClearFinalize = 0x20000000,
	Atomic64Compatible = 0x40000000,
	ReduceMemoryWithTilingMode = 0x80000000,
...
enum EImportStaticMeshVersion:int
{
...
enum ERHITextureSRVOverrideSRGBType:unsigned char
{
	SRGBO_Default = 0x0,
...
enum ERepDataBufferType:int
{
	ObjectBuffer = 0x0,
	ShadowBuffer = 0x1
};

enum EGCReferenceType:int
{
	GCRT_None = 0x0,
	GCRT_Object = 0x1,
...
enum ECbFieldType:unsigned char
{
	...
	BoolFalse = 0xC,
	BoolTrue = 0xD,
	ObjectAttachment = 0xE,
	BinaryAttachment = 0xF,
	Hash = 0x10,
	Uuid = 0x11,
	DateTime = 0x12,
	TimeSpan = 0x13,
...
enum ETranslucencyVolumeCascade:int
{
	TVC_Inner = 0x0,
	TVC_Outer = 0x1,
	TVC_MAX = 0x2
...
enum ESlateTextureAtlasPaddingStyle:int
{
	NoPadding = 0x0,
	DilateBorder = 0x1,
	PadWithZero = 0x2
...
enum EVRSShadingRate:unsigned char
{
	VRSSR_1x1 = 0x0,
	VRSSR_1x2 = 0x1,
	VRSSR_2x1 = 0x4,
...
enum EConstructTextureFlags:int
{
	CTF_Compress = 0x1,
...
enum ESamplerCompareFunction:int
{
	SCF_Never = 0x0,
	SCF_Less = 0x1
};
...
enum EShaderParameterFlags:int
{
	SPF_Optional = 0x0,
	SPF_Mandatory = 0x1
};
...
enum EEngineNetworkVersionHistory:int
{
	HISTORY_INITIAL = 0x1,
	HISTORY_REPLAY_BACKWARDS_COMPAT = 0x2,
	HISTORY_MAX_ACTOR_CHANNELS_CUSTOMIZATION = 0x3,
	HISTORY_REPCMD_CHECKSUM_REMOVE_PRINTF = 0x4,
	HISTORY_NEW_ACTOR_OVERRIDE_LEVEL = 0x5,
	HISTORY_CHANNEL_NAMES = 0x6,
	HISTORY_CHANNEL_CLOSE_REASON = 0x7,
	HISTORY_ACKS_INCLUDED_IN_HEADER = 0x8,
	HISTORY_NETEXPORT_SERIALIZATION = 0x9,
	HISTORY_NETEXPORT_SERIALIZE_FIX = 0xA,
	HISTORY_FAST_ARRAY_DELTA_STRUCT = 0xB,
	HISTORY_FIX_ENUM_SERIALIZATION = 0xC,
	HISTORY_OPTIONALLY_QUANTIZE_SPAWN_INFO = 0xD,
	HISTORY_JITTER_IN_HEADER = 0xE,
	HISTORY_CLASSNETCACHE_FULLNAME = 0xF,
	HISTORY_REPLAY_DORMANCY = 0x10,
	HISTORY_ENUM_SERIALIZATION_COMPAT = 0x11,
	HISTORY_SUBOBJECT_OUTER_CHAIN = 0x12,
	HISTORY_HITRESULT_INSTANCEHANDLE = 0x13,
	HISTORY_INTERFACE_PROPERTY_SERIALIZATION = 0x14,
	HISTORY_MONTAGE_PLAY_INST_ID_SERIALIZATION = 0x15,
	HISTORY_SERIALIZE_DOUBLE_VECTORS_AS_DOUBLES = 0x16,
	HISTORY_PACKED_VECTOR_LWC_SUPPORT = 0x17,
	HISTORY_PAWN_REMOTEVIEWPITCH = 0x18,
	HISTORY_REPMOVE_SERVERFRAME_AND_HANDLE = 0x19,
	HISTORY_21_AND_VIEWPITCH_ONLY_DO_NOT_USE = 0x1A,
	HISTORY_PLACEHOLDER = 0x1B,
	HISTORY_RUNTIME_FEATURES_COMPATIBILITY = 0x1C,
	HISTORY_SOFTOBJECTPTR_NETGUIDS = 0x1D,
	HISTORY_SUBOBJECT_DESTROY_FLAG = 0x1E,
	HISTORY_GAMESTATE_REPLCIATED_TIME_AS_DOUBLE = 0x1F,
	HISTORY_CUSTOMVERION = 0x20,
	HISTORY_ENGINENETVERSION_PLUS_ONE = 0x21,
...
enum ELifetimeRepNotifyCondition:int
{
...
enum ERayTracingGeometryType:int
{
	RTGT_Triangles = 0x0,
	RTGT_Procedural = 0x1
};
...
enum EFontFallback:unsigned char
{
	FF_NoFallback = 0x0,
...
enum EActorRepListTypeFlags:unsigned char
{
	Default = 0x0,
	FastShared = 0x1,
	Max = 0x2
...
enum EFriendInvitePolicy:unsigned char
{
	Public = 0x0,
...
enum EInitStateDefaultsResult:unsigned char
{
	Initialized = 0x0,
	NotInitialized = 0x1
};
...
enum EOnlineSharingCategory:unsigned int
{
	...
	ProfileInfo = 0x20,
	LocationInfo = 0x40,
	ReadPermissionMask = 0xFFFFFFFF,
	DefaultRead = 0x60,
	SubmitPosts = 0x10000,
	ManageFriends = 0x20000,
	AccountAdmin = 0x40000,
	Events = 0x80000,
	PublishPermissionMask = 0xFFFF0000,
	DefaultPublish = 0x0
};

enum EOnlineStatusUpdatePrivacy:unsigned char
{
	OnlyMe = 0x0,
	OnlyFriends = 0x1,
	Everyone = 0x2
...
enum ESleepFamily:unsigned char
{
	Normal = 0x0,
	Sensitive = 0x1,
	Custom = 0x2
...
enum EUniqueIdEncodingFlags:unsigned char
{
	NotEncoded = 0x0,
	IsEncoded = 0x1,
	IsEmpty = 0x2,
...
enum EGuidFormats:int
{
	Digits = 0x0,
	DigitsLower = 0x1,
	DigitsWithHyphens = 0x2,
	DigitsWithHyphensLower = 0x3,
	DigitsWithHyphensInBraces = 0x4,
	DigitsWithHyphensInParentheses = 0x5,
	HexValuesInBraces = 0x6,
	UniqueObjectGuid = 0x7,
	Short = 0x8,
	Base36Encoded = 0x9
};
...
enum EAnimAlphaInputType:unsigned char
{
	Float = 0x0,
	Bool = 0x1,
	Curve = 0x2
...
enum ERemoveStreamingViews:int
{
...
enum EAnimSyncGroupScope:unsigned char
{
	Local = 0x0,
	Component = 0x1
};
...
enum ETransitionRequestQueueMode:unsigned char
{
	Shared = 0x0,
	Unique = 0x1
};

enum ETransitionRequestOverwriteMode:unsigned char
{
	Append = 0x0,
	Ignore = 0x1,
	Overwrite = 0x2
...
enum EAnimCurveType:unsigned char
{
	AttributeCurve = 0x0,
	MaterialCurve = 0x1,
...
enum EPhysicsProxyType:unsigned int
{
	NoneType = 0x0,
	StaticMeshType = 0x1,
	GeometryCollectionType = 0x2,
	FieldType = 0x3,
	SkeletalMeshType = 0x4,
	JointConstraintType = 0x8,
	SuspensionConstraintType = 0x9,
	CharacterGroundConstraintType = 0xA,
	SingleParticleProxy = 0xB,
	Count = 0xC
};
...
enum ERPCBlockState:unsigned char
{
	Unchecked = 0x0,
	OnAllowList = 0x1,
	NotBlocked = 0x2,
...
enum EScreenPhysicalAccuracy:int
{
	Unknown = 0x0,
	Approximation = 0x1,
	Truth = 0x2
...
enum EQuotaType:unsigned char
{
	EscalateQuota = 0x0,
	DeescalateQuota = 0x1
};

enum EMaterialParameterType:unsigned char
{
	Scalar = 0x0,
	Vector = 0x1,
	DoubleVector = 0x2,
...
enum ERHIPipeline:unsigned char
{
	Graphics = 0x1,
	AsyncCompute = 0x2,
	None = 0x0,
...
enum EIoContainerFlags:unsigned char
{
	None = 0x0,
	Compressed = 0x1,
	Encrypted = 0x2,
...
enum EBufferUsageFlags:unsigned int
{
	None = 0x0,
	Static = 0x1,
	Dynamic = 0x2,
...
enum ETextureReallocationStatus:int
{
...
enum EGestureEvent:unsigned char
{
	None = 0x0,
	Scroll = 0x1,
	Magnify = 0x2,
...
enum EFocusCause:unsigned char
{
	Mouse = 0x0,
	Navigation = 0x1,
	SetDirectly = 0x2,
...
enum EPluginEnabledByDefault:unsigned char
{
	Unspecified = 0x0,
	Enabled = 0x1,
	Disabled = 0x2
...
enum EMouseCaptureMode:unsigned char
{
	NoCapture = 0x0,
...
enum EUniformBufferValidation:int
{
	None = 0x0,
	ValidateResources = 0x1
};

enum EFootPlacementLockType:unsigned char
{
	Unlocked = 0x0,
	PivotAroundBall = 0x1,
...
enum EStreamingSourceTargetState:unsigned char
{
	Loaded = 0x0,
	Activated = 0x1
};

enum ERTAccelerationStructureBuildPriority:int
{
	Immediate = 0x0,
	High = 0x1,
	Normal = 0x2,
...
enum EPelvisHeightMode:unsigned char
{
	AllLegs = 0x0,
	AllPlantedFeet = 0x1,
...
enum EActorMovementCompensationMode:unsigned char
{
	ComponentSpace = 0x0,
	WorldSpace = 0x1,
...
enum EWarpingEvaluationMode:unsigned char
{
	Manual = 0x0,
	Graph = 0x1
};

enum ESoundwaveSampleRateSettings:unsigned char
{
	Max = 0x0,
	High = 0x1,
	Medium = 0x2,
...
enum EBulkDataLockFlags:int
{
	LOCK_READ_ONLY = 0x1,
	LOCK_READ_WRITE = 0x2
};

enum EOffsetRootBoneMode:unsigned char
{
	Accumulate = 0x0,
	Interpolate = 0x1,
	Hold = 0x2,
...
enum EPackageExtension:unsigned char
{
	Unspecified = 0x0,
	Asset = 0x1,
	Map = 0x2,
...
enum ERPCDoSSeverityUpdate:unsigned char
{
	Escalate = 0x0,
	AutoEscalate = 0x1,
	Deescalate = 0x2
...
enum ERPCDoSEscalateReason:unsigned char
{
	CountLimit = 0x0,
	TimeLimit = 0x1,
	AutoEscalate = 0x2,
...
enum ERPCNotifyResult:unsigned char
{
	ExecuteRPC = 0x0,
	BlockRPC = 0x1
};

enum EPostSequentialRPCType:unsigned char
{
	MidPacket = 0x0,
	PostPacket = 0x1
};

enum EStaticMeshVertexTangentBasisType:int
{
	Default = 0x0,
	HighPrecision = 0x1
};

enum EGetSparseClassDataMethod:unsigned char
{
	CreateIfNull = 0x0,
	ArchetypeIfNull = 0x1,
	ReturnIfNull = 0x2
...
enum EFindFirstObjectOptions:int
{
	None = 0x0,
	ExactClass = 0x2,
	NativeFirst = 0x4,
...
enum EPhysicsAssetSolverType:unsigned char
{
	RBAN = 0x0,
	World = 0x1
};
...
enum EActorIteratorType:int
{
	End = 0x0
};

enum EClearDepthStencil:int
{
	Depth = 0x0,
	Stencil = 0x1,
	DepthStencil = 0x2
...
enum ERayTracingInstanceLayer:unsigned char
{
	NearField = 0x0,
	FarField = 0x1
};

enum EWarpingVectorMode:unsigned char
{
...
enum EAudioChunkLoadResult:unsigned char
{
	Completed = 0x0,
	AlreadyLoaded = 0x1,
	Interrupted = 0x2,
...
enum EChannelCreateFlags:unsigned int
{
	None = 0x1,
	OpenedLocally = 0x2
};

enum ESetChannelActorFlags:unsigned int
{
	None = 0x0,
...
enum EShaderCodeFeatures:unsigned short
{
	None = 0x0,
	WaveOps = 0x1,
	SixteenBitTypes = 0x2,
...
enum ETimerStatus:unsigned char
{
	Pending = 0x0,
	Active = 0x1,
	Paused = 0x2,
...
enum ELevelCollectionType:unsigned char
{
...
enum ESkinCacheDefaultBehavior:unsigned char
{
	Exclusive = 0x0,
	Inclusive = 0x1
};

enum EFieldIterationFlags:unsigned char
{
	None = 0x0,
	IncludeSuper = 0x1,
	IncludeDeprecated = 0x2,
	IncludeInterfaces = 0x4,
	IncludeAll = 0x7,
	Default = 0x3
};

enum EAssociativity:int
{
	RightToLeft = 0x0,
	LeftToRight = 0x1
};

enum ELightmapType:unsigned char
{
	Default = 0x0,
	ForceSurface = 0x1,
	ForceVolumetric = 0x2
...
enum EPropertyValueIteratorFlags:unsigned char
{
	NoRecursion = 0x0,
	FullRecursion = 0x1
};

enum EPlatformFileRead:unsigned char
{
	None = 0x0,
	AllowWrite = 0x1
};

enum EPlatformFileWrite:unsigned char
{
	None = 0x0,
	AllowRead = 0x1
};

enum EItemDropZone:int
{
	AboveItem = 0x0,
	OntoItem = 0x1,
	BelowItem = 0x2
...
enum ELatentActionChangeType:unsigned char
{
	ActionsRemoved = 0x0,
	ActionsAdded = 0x1
};

enum EStereoscopicEye:int
{
...
enum EIoErrorCode:int
{
	...
	CorruptToc = 0x9,
	UnknownChunkID = 0xA,
	InvalidParameter = 0xB,
	SignatureError = 0xC,
	InvalidEncryptionKey = 0xD,
	CompressionError = 0xE
};
...
enum ERuntimeVirtualTextureShaderUniform:int
{
...
enum EReferencerFinderFlags:unsigned char
{
	None = 0x0,
	SkipInnerReferences = 0x1,
	SkipWeakReferences = 0x2
};
...
enum ECoreRedirectFlags:unsigned int
{
	None = 0x0,
	Type_Object = 0x1,
	Type_Class = 0x2,
	...
	Type_Property = 0x20,
	Type_Package = 0x40,
	Type_AllMask = 0xFFFFFFFF,
	Category_InstanceOnly = 0x10000,
	Category_Removed = 0x20000,
	Category_AllMask = 0xFF0000,
	Option_MatchSubstring = 0x1000000,
	Option_MissingLoad = 0x2000000,
	Option_AllMask = 0xFF000000,
	Option_InstanceOnly = 0x10000,
	Option_Removed = 0x20000,
	Option_ExactMatchMask = 0xFF0000
};

enum EActiveTimerReturnType:unsigned char
{
	Stop = 0x0,
	Continue = 0x1
};

enum EWidgetClipping:unsigned char
{
	Inherit = 0x0,
	ClipToBounds = 0x1,
...
enum EFlowDirectionPreference:unsigned char
{
	Inherit = 0x0,
	Culture = 0x1,
	LeftToRight = 0x2,
...
enum EInvalidateWidgetReason:unsigned char
{
	None = 0x0,
	Layout = 0x1,
	Paint = 0x2,
	Volatility = 0x4,
	ChildOrder = 0x8,
	RenderTransform = 0x10,
	Visibility = 0x20,
	AttributeRegistration = 0x40,
	Prepass = 0x80,
	PaintAndVolatility = 0x6,
	LayoutAndVolatility = 0x5,
	All = 0xFF
};

enum EUINavigation:unsigned char
{
	Left = 0x0,
	Right = 0x1,
	Up = 0x2,
...
enum ESlateDrawPrimitive:unsigned char
{
	None = 0x0,
	LineList = 0x1,
	TriangleList = 0x2
...
enum ERuntimeVirtualTextureMaterialType:unsigned char
{
	BaseColor = 0x0,
	BaseColor_Normal_DEPRECATED = 0x1,
...
enum EShaderParameterType:unsigned char
{
	LooseData = 0x0,
	UniformBuffer = 0x1,
	Sampler = 0x2,
	SRV = 0x3,
	UAV = 0x4,
	BindlessResourceIndex = 0x5,
	BindlessSamplerIndex = 0x6,
	Num = 0x7
};
...
enum EAudioDeviceScope:unsigned char
{
	Default = 0x0,
	Shared = 0x1,
	Unique = 0x2
...
enum ENDISkeletalMesh_FilterMode:unsigned char
{
	None = 0x0,
	SingleRegion = 0x1,
	MultiRegion = 0x2
...
enum ENDISkelMesh_AreaWeightingMode:unsigned char
{
	None = 0x0,
	AreaWeighted = 0x1
};

enum ENDISkeletalMesh_SkinningMode:unsigned char
{
	Invalid = 0xFF,
	None = 0x0,
	SkinOnTheFly = 0x1,
...
enum EMovieSceneBlendType:unsigned char
{
	Invalid = 0x0,
	Absolute = 0x1,
	Additive = 0x2,
...
enum EBitwiseOperatorFlags:int
{
	MaxSize = 0x1,
	MinSize = 0x2,
	MaintainSize = 0x4,
	OneFillMissingBits = 0x10
};
...
enum EMovieSceneServerClientMask:unsigned char
{
	None = 0x0,
	Server = 0x1,
	Client = 0x2,
...
enum EMovieSceneSequenceFlags:unsigned char
{
	None = 0x0,
	Volatile = 0x1,
...
enum EMovieSceneCompletionMode:unsigned char
{
	KeepState = 0x0,
	RestoreState = 0x1,
	ProjectDefault = 0x2
...
enum EConvertFromTypeResult:int
{
...
enum EShaderCompileJobPriority:unsigned char
{
	None = 0xFF,
	Low = 0x0,
	Normal = 0x1,
...
enum EMovieSceneChannelProxyType:unsigned char
{
	Static = 0x0,
	Dynamic = 0x1
};

enum EAsyncTaskNotificationState:unsigned char
{
	None = 0x0,
	Pending = 0x1,
	Success = 0x2,
...
enum EMovieSceneTransformChannel:unsigned int
{
	None = 0x0,
	TranslationX = 0x1,
	TranslationY = 0x2,
...
enum EDisplayOutputFormat:int
{
	SDR_sRGB = 0x0,
	SDR_Rec709 = 0x1,
	SDR_ExplicitGammaMapping = 0x2,
	HDR_ACES_1000nit_ST2084 = 0x3,
	HDR_ACES_2000nit_ST2084 = 0x4,
	HDR_ACES_1000nit_ScRGB = 0x5,
	HDR_ACES_2000nit_ScRGB = 0x6,
	HDR_LinearEXR = 0x7,
	HDR_LinearNoToneCurve = 0x8,
	HDR_LinearWithToneCurve = 0x9,
	MAX = 0xA
};

enum ETextShapingMethod:unsigned char
{
	Auto = 0x0,
	KerningOnly = 0x1,
	FullShaping = 0x2
...
enum EWriteDemoFrameFlags:unsigned int
{
	None = 0x0,
	SkipGameSpecific = 0x1
};

enum ERootMotionAccumulateMode:unsigned char
{
	Override = 0x0,
	Additive = 0x1
};

enum ERootMotionFinishVelocityMode:unsigned char
{
...
enum ERootMotionSourceStatusFlags:unsigned char
{
	Prepared = 0x1,
	Finished = 0x2,
...
enum ERootMotionSourceSettingsFlags:unsigned char
{
...
enum EAsyncTaskNotificationPromptAction:unsigned char
{
	None = 0x0,
	Continue = 0x1,
	Cancel = 0x2,
...
enum ESkinCacheUsage:unsigned char
{
	Auto = 0x0,
	Disabled = 0xFF,
	Enabled = 0x1
...
enum EResendAllDataState:unsigned char
{
	None = 0x0,
	SinceOpen = 0x1,
	SinceCheckpoint = 0x2
...
enum ESectionEvaluationFlags:unsigned char
{
	None = 0x0,
	PreRoll = 0x1,
	PostRoll = 0x2
...
enum EShaderCompilerWorkerType:unsigned char
{
	None = 0x0,
	LocalThread = 0x1,
	Distributed = 0x2
...
enum ELightUnits:unsigned char
{
	Unitless = 0x0,
	Candelas = 0x1,
	Lumens = 0x2
...
enum EMovieSceneTrackEasingSupportFlags:int
{
	None = 0x0,
	AutomaticEaseIn = 0x1,
...
enum ETickableTickType:unsigned char
{
	Conditional = 0x0,
	Always = 0x1,
	Never = 0x2
...
enum EMeshMergeType:unsigned char
{
	MeshMergeType_Default = 0x0,
	MeshMergeType_MergeActor = 0x1
};

namespace FGameNetworkCustomVersion
{
	enum Type:int
	{
		BeforeCustomVersionWasAdded = 0x0,
...
enum EMovieSceneCompileResult:unsigned char
{
	Success = 0x0,
	Failure = 0x1,
	Unimplemented = 0x2
...
enum EEvaluationMethod:unsigned char
{
	Static = 0x0,
	Swept = 0x1
};

enum ERayTracingGlobalIlluminationType:unsigned char
{
	Disabled = 0x0,
	BruteForce = 0x1,
	FinalGather = 0x2
...
enum EReflectionsType:unsigned char
{
	ScreenSpace = 0x0,
	RayTracing = 0x1
};

enum ELumenRayLightingModeOverride:unsigned char
{
	Default = 0x0,
	SurfaceCache = 0x1,
	HitLighting = 0x2
...
enum EReflectedAndRefractedRayTracedShadows:unsigned char
{
	Disabled = 0x0,
	Hard_shadows = 0x1,
	Area_shadows = 0x2
...
enum ETranslucencyType:unsigned char
{
	Raster = 0x0,
	RayTracing = 0x1
};

enum EStringTableLoadingPolicy:unsigned char
{
	Find = 0x0,
	FindOrLoad = 0x1,
	FindOrFullyLoad = 0x2
...
enum EQuartzCommandType:unsigned char
{
	PlaySound = 0x0,
...
enum ETextIdenticalModeFlags:unsigned char
{
	None = 0x0,
	DeepCompare = 0x1,
	LexicalCompareInvariants = 0x2
};
...
enum EUniformBufferBindingFlags:unsigned char
{
	Shader = 0x1,
	Static = 0x2,
	StaticAndShader = 0x3
...
enum EChaosSolverTickMode:unsigned char
{
	Fixed = 0x0,
	Variable = 0x1,
	VariableCapped = 0x2,
...
enum EHotReloadFlags:unsigned char
{
	None = 0x0,
	WaitForCompletion = 0x1
};

enum EMovieSceneEvaluationType:unsigned char
{
	FrameLocked = 0x0,
	WithSubFrames = 0x1
};

enum EUpdateClockSource:unsigned char
{
	Tick = 0x0,
	Platform = 0x1,
	Audio = 0x2,
...
enum ESpawnOwnership:unsigned char
{
	InnerSequence = 0x0,
	RootSequence = 0x1,
	External = 0x2
...
enum EPropertyPointerType:int
{
	Direct = 0x0,
	Container = 0x1
};

enum EMultipleKeyBindingIndex:unsigned char
{
	Primary = 0x0,
	Secondary = 0x1,
	NumChords = 0x2
...
enum ERDGBarrierLocation:unsigned char
{
	Prologue = 0x0,
	Epilogue = 0x1
};

enum ERHITransitionCreateFlags:int
{
	None = 0x0,
	NoFence = 0x1,
	NoSplit = 0x2,
...
enum ERayTracingMode:unsigned char
{
	Disabled = 0x0,
	Enabled = 0x1,
	Dynamic = 0x2
...
enum EResourceTransitionFlags:int
{
	None = 0x0,
...
enum EQueryFlags:unsigned short
{
	None = 0x0,
	PreFilter = 0x4,
	PostFilter = 0x8,
...
enum ERDGPassFlags:unsigned short
{
	None = 0x0,
	Raster = 0x1,
	Compute = 0x2,
...
enum EMeshApproximationType:unsigned char
{
	MeshAndMaterials = 0x0,
	MeshShapeOnly = 0x1
};

enum EMeshApproximationBaseCappingType:unsigned char
{
	NoBaseCapping = 0x0,
	ConvexPolygon = 0x1,
	ConvexSolid = 0x2
...
enum EOccludedGeometryFilteringPolicy:unsigned char
{
	NoOcclusionFiltering = 0x0,
	VisibilityBasedFiltering = 0x1
};

enum EMeshApproximationSimplificationPolicy:unsigned char
{
...
enum EMeshApproximationGroundPlaneClippingPolicy:unsigned char
{
...
enum EMeshApproximationUVGenerationPolicy:unsigned char
{
	PreferUVAtlas = 0x0,
	PreferXAtlas = 0x1,
...
enum EPropertyObjectReferenceType:unsigned int
{
	None = 0x0,
	Strong = 0x1,
	Weak = 0x2
...
enum EPlayDirection:int
{
	Forwards = 0x0,
	Backwards = 0x1
};

enum ESkeletalMeshVertexFlags:unsigned char
{
	None = 0x0,
...
enum ESubmixSendMethod:unsigned char
{
	Linear = 0x0,
	CustomCurve = 0x1,
	Manual = 0x2
...
enum ECheckBoxState:unsigned char
{
	Unchecked = 0x0,
	Checked = 0x1,
	Undetermined = 0x2
...
enum ERDGBuilderFlags:int
{
	None = 0x0,
	AllowParallelExecute = 0x1
};

enum ERDGTextureFlags:unsigned char
{
	None = 0x0,
	MultiFrame = 0x1,
	SkipTracking = 0x2,
...
enum ERDGBufferFlags:unsigned char
{
	None = 0x0,
	MultiFrame = 0x1,
	SkipTracking = 0x2,
...
enum ERDGUnorderedAccessViewFlags:unsigned char
{
	None = 0x0,
	SkipBarrier = 0x1
};

enum ERDGInitialDataFlags:unsigned char
{
	None = 0x0,
	NoCopy = 0x1
};

enum ERDGResourceExtractionFlags:unsigned char
{
	None = 0x0,
	AllowTransient = 0x1
};

enum ERasterizerDepthClipMode:unsigned char
{
	DepthClip = 0x0,
	DepthClamp = 0x1,
	Num = 0x2,
...
enum EUpdateTransformFlags:int
{
	None = 0x0,
...
enum EVoiceBlockReasons:unsigned char
{
	None = 0x0,
	Muted = 0x1,
	MutedBy = 0x2,
...
enum EMovieSceneBuiltInEasing:unsigned char
{
	Linear = 0x0,
	SinIn = 0x1,
	SinOut = 0x2,
...
enum EAutomationComparisonToleranceLevel:unsigned char
{
	Zero = 0x0,
	Low = 0x1,
	Medium = 0x2,
...
enum EArrayPropertyFlags:int
{
	None = 0x0,
	UsesMemoryImageAllocator = 0x1
};

enum ESlateTextureAtlasThreadId:int
{
	Unknown = 0xFF,
	Game = 0x0,
	Render = 0x1
...
enum ERayTracingPipelineCacheFlags:unsigned char
{
	Default = 0x0,
	NonBlocking = 0x1
};
...
enum ELANBeaconVersionHistory:unsigned char
{
	HISTORY_INITIAL = 0xB,
...
enum EMontageSubStepResult:unsigned char
{
	Moved = 0x0,
	NotMoved = 0x1,
	InvalidSection = 0x2,
...
enum ESocketProtocolFamily:unsigned char
{
	None = 0x0,
	IPv4 = 0x1,
	IPv6 = 0x2
...
enum ESocketConnectionState:int
{
...
enum EAddressInfoFlags:unsigned short
{
	AllResults = 0x1,
	NoResolveHost = 0x2,
...
enum ERecvMultiFlags:unsigned int
{
	None = 0x0,
	RetrieveTimestamps = 0x1
};

enum ETimestampTranslation:unsigned char
{
	LocalTimestamp = 0x0,
	TimeDelta = 0x1
};

enum EAllowOverscroll:unsigned char
{
	Yes = 0x0,
	No = 0x1
};

enum ESoundWaveLoadingBehavior:unsigned char
{
	Inherited = 0x0,
	RetainOnLoad = 0x1,
	PrimeOnLoad = 0x2,
...
enum ERawCurveTrackTypes:unsigned char
{
	RCT_Float = 0x0,
	RCT_Vector = 0x1,
	RCT_Transform = 0x2,
...
enum EFastArraySerializerDeltaFlags:unsigned char
{
	None = 0x0,
...
enum EShaderPermutationFlags:unsigned int
{
	None = 0x0,
	HasEditorOnlyData = 0x1
};

enum EAnimNodeDataFlags:unsigned int
{
	None = 0x0,
...
enum EWindowDrawAttentionRequestType:int
{
	UntilActivated = 0x0,
	Stop = 0x1
};

enum EIoChunkType:unsigned char
{
	Invalid = 0x0,
...
enum EBoneFilterActionOption:unsigned char
{
	Remove = 0x0,
	Keep = 0x1,
	Invalid = 0x2
...
enum EForkProcessRole:unsigned char
{
	Parent = 0x0,
	Child = 0x1
};
...
enum ESoftObjectPathCollectType:unsigned char
{
	NonPackage = 0x0,
	NeverCollect = 0x1,
...
enum EFontHinting:unsigned char
{
	Default = 0x0,
	Auto = 0x1,
	AutoLight = 0x2,
...
enum ETaskTag:int
{
	...
	ESlateThread = 0x4,
	EAudioThread = 0x8,
	ERenderingThread = 0x10,
	ERhiThread = 0x20,
	EAsyncLoadingThread = 0x40,
	ENamedThreadBits = 0x7F,
	EParallelThread = 0x100,
	EWorkerThread = 0x180,
	EParallelRenderingThread = 0x110,
	EParallelGameThread = 0x102,
	EParallelRhiThread = 0x120
};

enum EFVisibleMeshDrawCommandFlags:unsigned char
{
	Default = 0x0,
...
enum ESkinVertexFactoryMode:int
{
	Default = 0x0,
	RayTracing = 0x1
};

enum EPackageExternalResource:int
{
...
enum ERecompileModuleFlags:unsigned char
{
	None = 0x0,
...
enum EAsyncComputePriority:int
{
...
enum EDrawingPolicyOverrideFlags:int
{
	None = 0x0,
	TwoSided = 0x1,
...
enum EElementType:unsigned char
{
	ET_Box = 0x0,
	ET_DebugQuad = 0x1,
	ET_Text = 0x2,
...
enum EVTPageTableFormat:unsigned char
{
	UInt16 = 0x0,
	UInt32 = 0x1
};

enum BodyInstanceSceneState:unsigned char
{
	NotAdded = 0x0,
	AwaitingAdd = 0x1,
	Added = 0x2,
...
enum EBatchProcessingMode:unsigned int
{
	Generic = 0x0,
	UnCulled = 0x1,
	Num = 0x2
...
enum EInstanceCullingFlags:unsigned char
{
	None = 0x0,
...
enum EInstanceCullingMode:int
{
	Normal = 0x0,
	Stereo = 0x1
};

enum EPrimitiveDirtyState:unsigned char
{
	None = 0x0,
	ChangedId = 0x1,
...
enum EGPUSceneGPUWritePass:signed char
{
	None = 0xFF,
	PostOpaqueRendering = 0x0,
	Num = 0x1
};

enum ERayTracingSceneLifetime:int
{
...
enum EAccelerationStructureBuildMode:int
{
	Build = 0x0,
	Update = 0x1
};
...
enum ERenderTargetLoadAction:unsigned char
{
	ENoAction = 0x0,
	ELoad = 0x1,
	EClear = 0x2,
...
enum ERenderTargetStoreAction:unsigned char
{
	ENoAction = 0x0,
	EStore = 0x1,
...
enum ESubpassHint:unsigned char
{
	None = 0x0,
...
enum EConservativeRasterization:unsigned char
{
	Disabled = 0x0,
	Overestimated = 0x1
};
...
enum ESceneTextureExtracts:unsigned int
{
	None = 0x0,
	Depth = 0x1,
	CustomDepth = 0x2,
...
enum ESceneTextureSetupMode:unsigned int
{
	None = 0x0,
	SceneColor = 0x1,
	SceneDepth = 0x2,
...
enum EMobileSceneTextureSetupMode:unsigned int
{
	None = 0x0,
	SceneColor = 0x1,
	SceneDepth = 0x2,
...
enum ETextureColorSpace:unsigned char
{
	TCS_None = 0x0,
	TCS_sRGB = 0x1,
	TCS_Rec2020 = 0x2,
...
enum EAnimInterpolationType:unsigned char
{
	Linear = 0x0,
	Step = 0x1
};

enum EAppendNetExportFlags:unsigned int
{
	None = 0x0,
	ForceExportDirtyGroups = 0x1
};

enum EVectorVMOpCategory:unsigned char
{
	Input = 0x0,
	Output = 0x1,
	Op = 0x2,
...
enum EVectorVMOp:unsigned char
{
	done = 0x0,
	add = 0x1,
	sub = 0x2,
...
enum ECollisionQueryHitType:unsigned char
{
	None = 0x0,
	Touch = 0x1,
	Block = 0x2
...
enum EStreamingOperationResult:int
{
	Success = 0x0,
	Unsupported = 0x1,
	ReplayNotFound = 0x2,
...
enum EReplayCheckpointType:unsigned char
{
	Full = 0x0,
	Delta = 0x1
};

enum EReplayStreamerState:unsigned char
{
	Idle = 0x0,
	Recording = 0x1,
	Playback = 0x2
...
enum ELinkerNameTableConstructor:int
{
	ENAME_LinkerConstructor = 0x0
};

enum ERepLayoutCmdType:unsigned char
{
	DynamicArray = 0x0,
	Return = 0x1,
	Property = 0x2,
...
enum ERepLayoutCmdFlags:unsigned char
{
	None = 0x0,
...
enum EConstraintTransformComponentFlags:unsigned char
{
	None = 0x0,
	ChildPosition = 0x1,
	ChildRotation = 0x2,
...
enum ETextOverflowDirection:unsigned char
{
	NoOverflow = 0x0,
	LeftToRight = 0x1,
	RightToLeft = 0x2
...
enum ERepParentFlags:unsigned int
{
	None = 0x0,
	IsLifetime = 0x1,
	IsConditional = 0x2,
...
enum ECreateRepLayoutFlags:int
{
	None = 0x0,
	MaySendProperties = 0x1
};

enum ECreateReplicationChangelistMgrFlags:int
{
	None = 0x0,
	SkipDeltaCustomState = 0x1
};

enum ECreateRepStateFlags:unsigned int
{
	None = 0x0,
	SkipCreateReceivingState = 0x1
};

enum EReceivePropertiesFlags:unsigned int
{
	None = 0x0,
	RepNotifies = 0x1,
	SkipRoleSwap = 0x2
...
enum ECustomDepthMode:unsigned int
{
	Disabled = 0x0,
	Enabled = 0x1,
...
enum ERepLayoutFlags:unsigned char
{
	None = 0x0,
	IsActor = 0x1,
...
enum ESerializePropertyType:unsigned char
{
	Handle = 0x0,
	Name = 0x1
};
...
enum ESoundAssetCompressionType:unsigned char
{
	BinkAudio = 0x0,
	ADPCM = 0x1,
	PCM = 0x2,
...
enum ESoundWavePrecacheState:int
{
	NotStarted = 0x0,
	InProgress = 0x1,
	Done = 0x2
...
enum EStaticMeshVertexUVType:int
{
	Default = 0x0,
	HighPrecision = 0x1
};

enum ERHIInterfaceType:int
{
	Hidden = 0x0,
	Null = 0x1,
	D3D11 = 0x2,
...
enum ERayTracingAccelerationStructureFlags:int
{
	None = 0x0,
	AllowUpdate = 0x1,
	AllowCompaction = 0x2,
...
enum EPSOPrecachePriority:unsigned char
{
	Medium = 0x0,
	High = 0x1
};

enum EMaterialGetParameterValueFlags:unsigned int
{
	None = 0x0,
...
enum EMaterialShaderPrecompileMode:int
{
	None = 0x0,
	Background = 0x1,
	Synchronous = 0x2,
...
enum ENCPoolMethod:unsigned char
{
	None = 0x0,
	AutoRelease = 0x1,
	ManualRelease = 0x2,
...
enum EInstancePropertyValueFlags:int
{
	None = 0x0,
...
enum ENavigationGenesis:unsigned char
{
	Keyboard = 0x0,
	Controller = 0x1,
	User = 0x2
...
enum ENavigationSource:unsigned char
{
	FocusedWidget = 0x0,
	WidgetUnderCursor = 0x1
};

enum ESleepEvent:unsigned char
{
	SET_Wakeup = 0x0,
	SET_Sleep = 0x1
};
...
enum EAttachmentRule:unsigned char
{
	KeepRelative = 0x0,
	KeepWorld = 0x1,
	SnapToTarget = 0x2,
...
enum ETabIdFlags:unsigned char
{
	None = 0x0,
	SaveLayout = 0x1
};
...
enum ERayTracingBindingType:unsigned char
{
	HitGroup = 0x0,
	CallableShader = 0x1,
	MissShader = 0x2
...
enum EParticleAllocationMode:unsigned char
{
...
enum ERendererStencilMask:unsigned char
{
	ERSM_Default = 0x0,
	ERSM_255 = 0x1,
	ERSM_1 = 0x2,
...
enum ETextureDimension:unsigned char
{
	Texture2D = 0x0,
	Texture2DArray = 0x1,
	Texture3D = 0x2,
...
enum EStaticMeshReductionTerimationCriterion:unsigned char
{
	Triangles = 0x0,
	Vertices = 0x1,
	Any = 0x2
...
enum EGPUSortFlags:unsigned int
{
	None = 0x0,
...
enum EPrintStaleReferencesOptions:int
{
	None = 0x0,
	Log = 0x1,
	Display = 0x2,
...
enum EPreLoadScreenTypes:unsigned char
{
...
enum EInstallBundleSourceType:int
{
	Bulk = 0x0,
	Launcher = 0x1,
...
enum EInstallBundleInstallState:int
{
	NotInstalled = 0x0,
	NeedsUpdate = 0x1,
	UpToDate = 0x2,
...
enum EInstallBundleRequestFlags:unsigned int
{
	None = 0x0,
...
enum ECoreRedirectMatchFlags:int
{
	None = 0x0,
	AllowPartialMatch = 0x1
};

enum ELocMetadataType:int
{
	None = 0x0,
	Boolean = 0x1,
	String = 0x2,
...
enum EInstallBundlePriority:unsigned char
{
	High = 0x0,
	Normal = 0x1,
	Low = 0x2,
...
enum EInstallBundleCacheDumpToLog:signed char
{
	None = 0x0,
	Default = 0x1,
	CSV = 0x2
...
enum EInstallBundleManagerInitState:int
{
	NotInitialized = 0x0,
	Failed = 0x1,
	Succeeded = 0x2
...
enum EInstallBundleGetContentStateFlags:unsigned int
{
	None = 0x0,
	ForceNoPatching = 0x1
};

enum EInstallBundleReleaseRequestFlags:unsigned int
{
	None = 0x0,
...
enum EDelayedRegisterRunPhase:unsigned char
{
	StartOfEnginePreInit = 0x0,
	FileSystemReady = 0x1,
	TaskGraphSystemReady = 0x2,
	StatSystemReady = 0x3,
	IniSystemReady = 0x4,
	EarliestPossiblePluginsLoaded = 0x5,
	ShaderTypesReady = 0x6,
	PreObjectSystemReady = 0x7,
	ObjectSystemReady = 0x8,
	DeviceProfileManagerReady = 0x9,
	EndOfEngineInit = 0xA,
	NumPhases = 0xB
};
...
enum EInputOutputFlags:unsigned char
{
	BlockingInput = 0x1,
	BlockingOutput = 0x2,
	BlockingOther = 0x4,
...
enum EMemcpyCachePolicy:unsigned char
{
	StoreCached = 0x0,
	StoreUncached = 0x1
};
...
enum EWindowActivation:unsigned char
{
	Activate = 0x0,
	ActivateByMouse = 0x1,
	Deactivate = 0x2
...
enum EInGamePerfTrackers:unsigned char
{
	VFXSignificance = 0x0,
	Num = 0x1
};

enum EInGamePerfTrackerThreads:unsigned char
{
	GameThread = 0x0,
	RenderThread = 0x1,
	OtherThread = 0x2,
...
enum EPinContainerType:unsigned char
{
	None = 0x0,
	Array = 0x1,
	Set = 0x2,
...
enum EThreadCreateFlags:signed char
{
	None = 0x0,
	SMTExclusive = 0x1
};

enum EStreamableManagerCombinedHandleOptions:unsigned char
{
	None = 0x0,
	MergeDebugNames = 0x1,
	RedirectParents = 0x2,
...
enum EVolumeCacheType:unsigned char
{
	OpenVDB = 0x0
};

enum EMaterialInstanceClearParameterFlag:int
{
	None = 0x0,
	Numeric = 0x1,
	Texture = 0x2,
...
enum EListItemAlignment:unsigned char
{
...
enum EScriptExecutionMode:unsigned char
{
	EveryParticle = 0x0,
...
enum ETextureClass:unsigned char
{
	Invalid = 0x0,
	TwoD = 0x1,
	Cube = 0x2,
...
enum ERHIBindlessConfiguration:int
{
	Disabled = 0x0,
	AllShaders = 0x1,
...
enum ENDISkeletalMesh_SourceMode:unsigned char
{
	Default = 0x0,
	Source = 0x1,
	AttachParent = 0x2
...
enum ESendLevelControlMethod:unsigned char
{
	Linear = 0x0,
	CustomCurve = 0x1,
	Manual = 0x2
...
enum ESubmixSendStage:unsigned char
{
...
enum ENDIStaticMesh_SourceMode:unsigned char
{
	Default = 0x0,
	Source = 0x1,
	AttachParent = 0x2,
...
enum EPSCPoolMethod:unsigned char
{
	None = 0x0,
	AutoRelease = 0x1,
	ManualRelease = 0x2,
...
enum EPrimaryScreenPercentageMethod:int
{
	SpatialUpscale = 0x0,
	TemporalUpscale = 0x1,
	RawOutput = 0x2
...
enum EMaterialTextureParameterType:unsigned int
{
	Standard2D = 0x0,
	Cube = 0x1,
	Array2D = 0x2,
...
enum ENDIActorComponentSourceMode:unsigned char
{
	Default = 0x0,
	AttachParent = 0x1,
	LocalPlayer = 0x2
...
enum ETextureLayoutAspectRatio:int
{
	None = 0x0,
	Force2To1 = 0x1,
	ForceSquare = 0x2
...
enum EProcessRemoteFunctionFlags:unsigned int
{
	None = 0x0,
	ReplicatedActor = 0x1
};

enum EAutomationEventType:unsigned char
{
	Info = 0x0,
	Warning = 0x1,
	Error = 0x2
...
enum ERayTracingInstanceFlags:unsigned char
{
	None = 0x0,
...
enum ERayTracingSceneState:int
{
	Writable = 0x0,
	Readable = 0x1
};

enum EDefaultAudioCompressionType:unsigned char
{
	BinkAudio = 0x0,
	ADPCM = 0x1,
	PCM = 0x2,
...
enum ETextWrappingPolicy:unsigned char
{
	DefaultWrapping = 0x0,
	AllowPerCharacterWrapping = 0x1
};

enum EUIActionRepeatMode:int
{
	RepeatDisabled = 0x0,
	RepeatEnabled = 0x1
};

enum ECurveEaseFunction:unsigned char
{
	Linear = 0x0,
	QuadIn = 0x1,
	QuadOut = 0x2,
...
enum EDetachmentRule:unsigned char
{
	KeepRelative = 0x0,
	KeepWorld = 0x1
};

enum ENaturalSoundFalloffMode:unsigned char
{
	Continues = 0x0,
	Silent = 0x1,
	Hold = 0x2
...
enum ETextTransformPolicy:unsigned char
{
	None = 0x0,
	ToLower = 0x1,
	ToUpper = 0x2
...
enum ETextOverflowPolicy:unsigned char
{
	Clip = 0x0,
	Ellipsis = 0x1
};

enum EAudioVolumeLocationState:unsigned char
{
	InsideTheVolume = 0x0,
...
enum EFontLoadingPolicy:unsigned char
{
	LazyLoad = 0x0,
	Stream = 0x1,
	Inline = 0x2
...
enum ELocalizedTextSourceCategory:unsigned char
{
	Game = 0x0,
	Engine = 0x1,
	Editor = 0x2
...
enum ECameraShakeDurationType:unsigned char
{
	Fixed = 0x0,
	Infinite = 0x1,
	Custom = 0x2
...
enum EVTProducePageFlags:unsigned char
{
	None = 0x0,
	SkipPageBorders = 0x1,
...
enum EBase64Mode:unsigned char
{
	Standard = 0x0,
	UrlSafe = 0x1
};

enum ECameraShakeUpdateResultFlags:unsigned char
{
	ApplyAsAbsolute = 0x1,
	SkipAutoScale = 0x2,
...
enum ESlateDebuggingNavigationMethod:unsigned char
{
	Unknown = 0x0,
	Explicit = 0x1,
...
enum EQuartzCommandQuantization:unsigned char
{
	Bar = 0x0,
	Beat = 0x1,
...
enum EUpdateStaticMeshFlags:unsigned char
{
	RasterCommands = 0x2,
...
enum EPrimitiveAddToSceneOps:int
{
	None = 0x0,
	AddStaticMeshes = 0x1,
...
enum ERayTracingPrimitiveFlags:unsigned char
{
...
enum EOnlineStoreOfferDiscountType:unsigned char
{
	NotOnSale = 0x0,
	Percentage = 0x1,
	DiscountAmount = 0x2,
...
enum EInputDeviceConnectionState:unsigned char
{
	Invalid = 0x0,
	Unknown = 0x1,
	Disconnected = 0x2,
...
enum EEncryptionFailureAction:unsigned char
{
	Default = 0x0,
...
enum EStreamableRenderAssetType:unsigned char
{
	None = 0x0,
	Texture = 0x1,
	StaticMesh = 0x2,
...
enum EUnrealEngineObjectUE5Version:unsigned int
{
	INITIAL_VERSION = 0x3E8,
	NAMES_REFERENCED_FROM_EXPORT_DATA = 0x3E9,
	PAYLOAD_TOC = 0x3EA,
	OPTIONAL_RESOURCES = 0x3EB,
	LARGE_WORLD_COORDINATES = 0x3EC,
	REMOVE_OBJECT_EXPORT_PACKAGE_GUID = 0x3ED,
	TRACK_OBJECT_EXPORT_IS_INHERITED = 0x3EE,
	FSOFTOBJECTPATH_REMOVE_ASSET_PATH_FNAMES = 0x3EF,
	ADD_SOFTOBJECTPATH_LIST = 0x3F0,
	DATA_RESOURCES = 0x3F1,
	AUTOMATIC_VERSION_PLUS_ONE = 0x3F2,
	AUTOMATIC_VERSION = 0x3F1
};
...
enum ESourceBusSendLevelControlMethod:unsigned char
{
	Linear = 0x0,
	CustomCurve = 0x1,
	Manual = 0x2
...
enum ESlateDebuggingInputEvent:unsigned char
{
	MouseMove = 0x0,
	MouseEnter = 0x1,
	MouseLeave = 0x2,
...
enum EPimplPtrMode:unsigned char
{
	NoCopy = 0x0,
	DeepCopy = 0x1
};

enum EOnlineErrorResult:unsigned char
{
	Success = 0x0,
	NoConnection = 0x1,
	RequestFailure = 0x2,
...
enum EMemoryTraceHeapAllocationFlags:unsigned char
{
	None = 0x0,
	Heap = 0x1
};
...
enum ELocalizationLoadFlags:unsigned char
{
	None = 0x0,
	Native = 0x1,
	Editor = 0x2,
	...
	Engine = 0x8,
	Additional = 0x10,
	ForceLocalizedGame = 0x20
};

enum EClothingTeleportMode:unsigned char
{
	None = 0x0,
	Teleport = 0x1,
...
enum ERayTracingMeshCommandsMode:unsigned char
{
	RAY_TRACING = 0x0,
	PATH_TRACING = 0x1,
...
enum EUpdateAllPrimitiveSceneInfosAsyncOps:int
{
	None = 0x0,
...
enum EGammaSpace:unsigned char
{
	Linear = 0x0,
	Pow22 = 0x1,
	sRGB = 0x2,
...
enum EBasePassDrawListType:int
{
...
enum EWindowTransparency:int
{
	None = 0x0,
	PerWindow = 0x1
};

enum EUserActivityContext:unsigned char
{
	Game = 0x0,
	Editor = 0x1,
	Other = 0x2
...
enum EOnlineNotificationResult:int
{
	None = 0x0,
	Handled = 0x1
};
...
enum EComponentPhysicsStateChange:unsigned char
{
	Created = 0x0,
	Destroyed = 0x1
};

enum EMemberConnectionStatus:unsigned char
{
	Uninitialized = 0x0,
	Disconnected = 0x1,
	Initializing = 0x2,
...
enum EConcurrencyMode:unsigned char
{
	Group = 0x0,
	Owner = 0x1,
	OwnerPerSound = 0x2,
...
enum EJoinRequestAction:unsigned char
{
	Manual = 0x0,
	AutoApprove = 0x1,
	AutoReject = 0x2
...
enum EPackageFormat:unsigned char
{
	Binary = 0x0,
	Text = 0x1
};

enum EPartyState:unsigned char
{
	None = 0x0,
	CreatePending = 0x1,
	JoinPending = 0x2,
...
enum ECreatePartyCompletionResult:signed char
{
	UnknownClientFailure = 0x9C,
	AlreadyInPartyOfSpecifiedType = 0x9D,
	AlreadyCreatingParty = 0x9E,
	AlreadyInParty = 0x9F,
	FailedToCreateMucRoom = 0xA0,
	NoResponse = 0xA1,
	LoggedOut = 0xA2,
	NotPrimaryUser = 0xA3,
	UnknownInternalFailure = 0x0,
	Succeeded = 0x1
};

enum EJoinPartyCompletionResult:signed char
{
	UnknownClientFailure = 0x9C,
	BadBuild = 0x9D,
	InvalidAccessKey = 0x9E,
	AlreadyInLeadersJoiningList = 0x9F,
	AlreadyInLeadersPartyRoster = 0xA0,
	NoSpace = 0xA1,
	NotApproved = 0xA2,
	RequesteeNotMember = 0xA3,
	RequesteeNotLeader = 0xA4,
	NoResponse = 0xA5,
	LoggedOut = 0xA6,
	UnableToRejoin = 0xA7,
	IncompatiblePlatform = 0xA8,
	AlreadyJoiningParty = 0xA9,
	AlreadyInParty = 0xAA,
	JoinInfoInvalid = 0xAB,
	AlreadyInPartyOfSpecifiedType = 0xAC,
	MessagingFailure = 0xAD,
	GameSpecificReason = 0xAE,
	MismatchedApp = 0xAF,
	UnknownInternalFailure = 0x0,
	Succeeded = 0x1
};

enum EHitFlags:unsigned short
{
	None = 0x0,
	Position = 0x1,
	Normal = 0x2,
...
enum ELeavePartyCompletionResult:signed char
{
	UnknownClientFailure = 0x9C,
	NoResponse = 0x9D,
	LoggedOut = 0x9E,
	UnknownParty = 0x9F,
	LeavePending = 0xA0,
	UnknownLocalUser = 0xA1,
	NotMember = 0xA2,
	MessagingFailure = 0xA3,
	UnknownTransportFailure = 0xA4,
	UnknownInternalFailure = 0x0,
	Succeeded = 0x1
};

enum EUpdateConfigCompletionResult:signed char
{
	UnknownClientFailure = 0x9C,
	UnknownParty = 0x9D,
	LocalMemberNotMember = 0x9E,
	LocalMemberNotLeader = 0x9F,
	RemoteMemberNotMember = 0xA0,
	MessagingFailure = 0xA1,
	NoResponse = 0xA2,
	UnknownInternalFailure = 0x0,
	Succeeded = 0x1
};

enum ESendPartyInvitationCompletionResult:signed char
{
	NotLoggedIn = 0x9C,
	InvitePending = 0x9D,
	AlreadyInParty = 0x9E,
...
enum EKickMemberCompletionResult:signed char
{
	UnknownClientFailure = 0x9C,
	UnknownParty = 0x9D,
	LocalMemberNotMember = 0x9E,
...
enum EPromoteMemberCompletionResult:signed char
{
	UnknownClientFailure = 0x9C,
	UnknownServiceFailure = 0x9D,
	UnknownParty = 0x9E,
	LocalMemberNotMember = 0x9F,
	LocalMemberNotLeader = 0xA0,
	PromotionAlreadyPending = 0xA1,
	TargetIsSelf = 0xA2,
	TargetNotMember = 0xA3,
	MessagingFailure = 0xA4,
	NoResponse = 0xA5,
	LoggedOut = 0xA6,
	UnknownInternalFailure = 0x0,
	Succeeded = 0x1
...
enum ERequestToJoinPartyCompletionResult:signed char
{
	ValidationFailure = 0x9C,
	NotAuthorized = 0x9D,
	Forbidden = 0x9E,
	UserNotFound = 0x9F,
	AlreadyExists = 0xA0,
	RateLimited = 0xA1,
	UnknownInternalFailure = 0xA2,
	Succeeded = 0x1
};
...
enum EObjectInitializerOptions:int
{
	None = 0x0,
...
enum EMemberExitedReason:unsigned char
{
	Unknown = 0x0,
	Left = 0x1,
	Removed = 0x2,
...
enum EPartyInvitationRemovedReason:unsigned char
{
	Unknown = 0x0,
	Accepted = 0x1,
	Declined = 0x2,
...
enum EPartySystemState:unsigned char
{
	Initializing = 0x0,
	Initialized = 0x1,
...
enum EPartyRequestToJoinRemovedReason:unsigned char
{
	Unknown = 0x0,
	Cancelled = 0x1,
	Expired = 0x2,
...
enum EInvitationResponse:unsigned char
{
	UnknownFailure = 0x0,
	BadBuild = 0x1,
	Rejected = 0x2,
...
enum EStreamingSourceTargetBehavior:unsigned char
{
	Include = 0x0,
	Exclude = 0x1
};

enum EOnSessionParticipantLeftReason:unsigned char
{
	Left = 0x0,
	Disconnected = 0x1,
	Kicked = 0x2,
...
enum EAnimDataModelNotifyType:unsigned char
{
	BracketOpened = 0x0,
	BracketClosed = 0x1,
	TrackAdded = 0x2,
...
enum FForceFeedbackChannelType:int
{
	LEFT_LARGE = 0x0,
	LEFT_SMALL = 0x1,
	RIGHT_LARGE = 0x2,
...
enum ESpawnActorCollisionHandlingMethod:unsigned char
{
	Undefined = 0x0,
	AlwaysSpawn = 0x1,
...
enum ESpawnActorScaleMethod:unsigned char
{
...
enum EVisibilityBasedAnimTickOption:unsigned char
{
...
enum EPurchaseTransactionState:unsigned char
{
	NotStarted = 0x0,
	Processing = 0x1,
	Purchased = 0x2,
...
enum ENavDataGatheringMode:unsigned char
{
	Default = 0x0,
	Instant = 0x1,
	Lazy = 0x2
...
enum EOnlineSharingPermissionState:unsigned char
{
	Unknown = 0x0,
	Declined = 0x1,
	Granted = 0x2
...
enum ERecentPlayerEncounterType:unsigned char
{
	Default = 0x0,
	Teammate = 0x1,
	Opponent = 0x2
...
enum EPairedAxis:unsigned char
{
	Unpaired = 0x0,
	X = 0x1,
	Y = 0x2,
...
enum _MM_MANTISSA_NORM_ENUM:int
{
...
enum EBlueprintNativizationFlag:unsigned char
{
	Disabled = 0x0,
	Dependency = 0x1,
...
enum ETextureSamplerFilter:unsigned char
{
	Point = 0x0,
	Bilinear = 0x1,
	Trilinear = 0x2,
...
enum ETextureMipLoadOptions:unsigned char
{
	Default = 0x0,
	AllMips = 0x1,
	OnlyFirstMip = 0x2
...
enum ETextureDownscaleOptions:unsigned char
{
	Default = 0x0,
	Unfiltered = 0x1,
	SimpleAverage = 0x2,
...
enum EOnlineTournamentFormat:unsigned char
{
...
enum EOnlineTournamentState:unsigned char
{
	Created = 0x0,
...
enum EWidgetUpdateFlags:unsigned char
{
	None = 0x0,
	NeedsTick = 0x4,
...
enum EOnlineTournamentParticipantType:unsigned char
{
	Individual = 0x0,
	Team = 0x1
};
...
enum EOnlineTournamentParticipantState:unsigned char
{
	Registered = 0x0,
	CheckedIn = 0x1,
	Present = 0x2,
...
enum EOnlineTournamentMatchState:unsigned char
{
	Created = 0x0,
	InProgress = 0x1,
	Finished = 0x2
...
enum ESizingRule:unsigned char
{
	FixedSize = 0x0,
	Autosized = 0x1,
	UserSized = 0x2
...
enum ECheckModuleCompatibilityFlags:int
{
	None = 0x0,
	DisplayUpToDateModules = 0x1
};

enum ETextGender:unsigned char
{
	Masculine = 0x0,
	Feminine = 0x1,
	Neuter = 0x2
...
enum ETrackingStatus:unsigned char
{
	NotTracked = 0x0,
	InertialOnly = 0x1,
	Tracked = 0x2
...
enum EUpdateTextureValueType:int
{
	Float = 0x0,
	Int32 = 0x1,
	Uint32 = 0x2
...
enum ESpectatorScreenMode:unsigned char
{
	Disabled = 0x0,
...
enum EHandKeypoint:unsigned char
{
	Palm = 0x0,
	Wrist = 0x1,
	ThumbMetacarpal = 0x2,
...
enum EBlendProfileMode:unsigned char
{
	TimeFactor = 0x0,
	WeightFactor = 0x1,
	BlendMask = 0x2
...
enum EXRTrackedDeviceType:unsigned char
{
...
enum EControllerHand:unsigned char
{
	Left = 0x0,
	Right = 0x1,
	AnyHand = 0x2,
...
enum EXRVisualType:unsigned char
{
	Controller = 0x0,
	Hand = 0x1
};

enum ESpatialInputGestureAxis:unsigned char
{
	None = 0x0,
	Manipulation = 0x1,
	Navigation = 0x2,
...
enum EMessageScope:unsigned char
{
	Thread = 0x0,
	Process = 0x1,
	Network = 0x2,
...
enum EMessageFlags:unsigned int
{
	None = 0x0,
	Reliable = 0x1
};

enum EMessageBusNotification:unsigned char
{
	Registered = 0x0,
	Unregistered = 0x1
};
...
enum ETransformCurveChannel:unsigned char
{
	Position = 0x0,
	Rotation = 0x1,
	Scale = 0x2,
...
enum EVectorCurveChannel:unsigned char
{
	X = 0x0,
	Y = 0x1,
	Z = 0x2,
...
enum EMobileHapticsType:unsigned char
{
	FeedbackSuccess = 0x0,
	FeedbackWarning = 0x1,
	FeedbackError = 0x2,
	SelectionChanged = 0x3,
	ImpactLight = 0x4,
	ImpactMedium = 0x5,
	ImpactHeavy = 0x6
};
...
enum EConfigCacheType:unsigned char
{
	DiskBacked = 0x0,
	Temporary = 0x1
};

enum EVertexStreamUsage:unsigned char
{
	Default = 0x0,
	Instancing = 0x1,
	Overridden = 0x2,
...
enum EMaterialLayerLinkState:unsigned char
{
	Uninitialized = 0x0,
	LinkedToParent = 0x1,
...
enum ETargetDeviceFeatures:int
{
	MultiLaunch = 0x0,
	PowerOff = 0x1,
	PowerOn = 0x2,
...
enum EPlatformAuthentication:int
{
	Never = 0x0,
	Possible = 0x1,
	Always = 0x2
...
enum ETargetPlatformFeatures:int
{
	AudioStreaming = 0x0,
...
enum ETextPluralType:unsigned char
{
	Cardinal = 0x0,
	Ordinal = 0x1
};
...
enum EFlowDirection:unsigned char
{
	LeftToRight = 0x0,
	RightToLeft = 0x1
};
...
enum ETargetDeviceThreadStates:int
{
	Unknown = 0x0,
	CanRun = 0x1,
	Inactive = 0x2,
...
enum ETargetDeviceThreadWaitStates:int
{
	Unknown = 0x0,
	Locked = 0x1,
	Sleeping = 0x2,
...
enum EUniqueObjectNameOptions:int
{
	None = 0x0,
	GloballyUnique = 0x2
};

enum EShaderFundamentalType:unsigned char
{
	Bool = 0x0,
	Int = 0x1,
	Uint = 0x2,
...
enum EShaderFundamentalDimensionType:unsigned char
{
	Scalar = 0x0,
	Vector = 0x1,
	Matrix = 0x2
...
enum EShaderResourceType:unsigned char
{
	None = 0x0,
	Texture1D = 0x1,
	Texture2D = 0x2,
...
enum EShaderParamBindingType:unsigned char
{
	None = 0x0,
...
enum EQueryLocalizedResourceResult:unsigned char
{
	Found = 0x0,
	NotFound = 0x1,
	NotImplemented = 0x2
...
enum EEngineNetworkRuntimeFeatures:unsigned short
{
	None = 0x0,
	IrisEnabled = 0x1
};

enum ERegexPatternFlags:int
{
	None = 0x0,
	CaseInsensitive = 0x1
};

enum ERayTracingPayloadType:unsigned int
{
	None = 0x0,
	Minimal = 0x1,
	Default = 0x2,
...
enum ERayTracingSceneLayer:unsigned char
{
	Base = 0x0,
	Decals = 0x1,
	NUM = 0x2
...
enum EPanningMethod:signed char
{
	Linear = 0x0,
	EqualPower = 0x1
};

enum EInterfaceValidResult:unsigned char
{
	Valid = 0x0,
	Invalid = 0x1
};
...
enum EComputeKernelFlags:unsigned int
{
	IsDefaultKernel = 0x1,
...
enum EAudioSpectrumBandPresetType:unsigned char
{
	KickDrum = 0x0,
	SnareDrum = 0x1,
	Voice = 0x2,
...
enum EMontageBlendMode:unsigned char
{
	Standard = 0x0,
	Inertialization = 0x1
};
...
enum ETextLocalizationManagerInitializedFlags:unsigned char
{
	None = 0x0,
	Engine = 0x1,
	Game = 0x2,
...
enum ECFCoreChildFileType:unsigned char
{
	None = 0x0,
	ServerPack = 0x1,
	Source = 0x2
...
enum ECompressionError:unsigned char
{
	None = 0x0,
	FailedToReadZip = 0x1,
...
enum ECFCoreExternalAuthProvider:unsigned char
{
	None = 0x0,
	Steam = 0x1,
	PSN = 0x2,
...
enum EFileSystemError:unsigned char
{
	None = 0x0,
...
enum ECFCoreInstallationCommands:unsigned char
{
	Download = 0x0,
	VerifyHash = 0x1,
	Unzip = 0x2,
...
enum EMaterialExpressionSetParameterValueFlags:unsigned int
{
	None = 0x0,
...
enum ESlateDebuggingFocusEvent:unsigned char
{
	FocusChanging = 0x0,
	FocusLost = 0x1,
	FocusReceived = 0x2,
...
enum EInAppPurchaseStatus:unsigned char
{
	Invalid = 0x0,
	Failed = 0x1,
	Deferred = 0x2,
...
enum EOnlineProxyStoreOfferDiscountType:unsigned char
{
	NotOnSale = 0x0,
	Percentage = 0x1,
	DiscountAmount = 0x2,
...
enum EPopupMethod:unsigned char
{
	CreateNewWindow = 0x0,
	UseCurrentWindow = 0x1
};

enum EConfigTestEnum:int
{
	A = 0x0,
	B = 0x1
};

enum EMovieSceneSequenceCompilerMask:unsigned char
{
	Hierarchy = 0x1,
...
enum EBeaconConnectionState:unsigned char
{
	Invalid = 0x0,
	Closed = 0x1,
	Pending = 0x2,
...
enum EMovieSceneObjectBindingSpace:unsigned char
{
	Local = 0x0,
	Root = 0x1,
	Unused = 0x2
...
enum ENetCloseResult:unsigned int
{
	NetDriverAlreadyExists = 0x0,
	NetDriverCreateFailure = 0x1,
	NetDriverListenFailure = 0x2,
...
enum EPlatformInfoType:unsigned char
{
	TruePlatformsOnly = 0x0,
	AllPlatformInfos = 0x1
};

enum EAnimSyncMethod:unsigned char
{
	DoNotSync = 0x0,
	SyncGroup = 0x1,
	Graph = 0x2
...
enum EShouldThrottle:unsigned char
{
	No = 0x0,
	Yes = 0x1
};

enum ECrashHandlingType:unsigned char
{
	Default = 0x0,
	Disabled = 0x1
};

enum EVertexFactoryFlags:unsigned int
{
	None = 0x0,
...
enum EToolContextCoordinateSystem:int
{
	World = 0x0,
	Local = 0x1
};

enum EInputCaptureSide:int
{
	None = 0x0,
	Left = 0x1,
	Right = 0x2,
...
enum ETextureStreamingBuildType:int
{
	TSB_MapBuild = 0x0,
	TSB_ActorBuild = 0x1,
...
enum ERHITransientAllocationType:unsigned char
{
	Heap = 0x0,
	Page = 0x1
};

enum EEdGraphNodeDeprecationMessageType:int
{
	None = 0x0,
	Note = 0x1,
	Warning = 0x2
...
enum EViewInteractionState:int
{
	None = 0x0,
	Hovered = 0x1,
	Focused = 0x2
...
enum ESpaceCurveControlPointTransformMode:int
{
	Shared = 0x0,
	PerVertex = 0x1
};

enum ESpaceCurveControlPointOriginMode:int
{
	Shared = 0x0,
	First = 0x1,
	Last = 0x2
...
enum ESpaceCurveControlPointFalloffType:int
{
	Linear = 0x0,
	Smooth = 0x1
};
...
enum EIncomingResult:unsigned char
{
	Success = 0x0,
	Error = 0x1
};

enum ENotifyRegistrationPhase:int
{
	NRP_Added = 0x0,
	NRP_Started = 0x1,
	NRP_Finished = 0x2
...
enum ECompiledMaterialProperty:int
{
...
enum EQuartzCommandDelegateSubType:unsigned char
{
...
enum EObjectIteratorThreadSafetyOptions:unsigned char
{
	None = 0x0,
	ThreadSafe = 0x1,
...
enum ECreateObjectTypeHint:unsigned char
{
	Undefined = 0x0,
	StaticMesh = 0x1,
	Volume = 0x2,
...
namespace FEngineNetworkCustomVersion
{
	enum Type:int
	{
		BeforeCustomVersionWasAdded = 0x0,
		Initial = 0x1,
		ReplayBackwardsCompat = 0x2,
		MaxActorChannelsCustomization = 0x3,
		RepCmdChecksumRemovePrintf = 0x4,
		NewActorOverrideLevel = 0x5,
		ChannelNames = 0x6,
		ChannelCloseReason = 0x7,
		AcksIncludedInHeader = 0x8,
		NetExportSerialization = 0x9,
		NetExportSerializeFix = 0xA,
		FastArrayDeltaStruct = 0xB,
		FixEnumSerialization = 0xC,
		OptionallyQuantizeSpawnInfo = 0xD,
		JitterInHeader = 0xE,
		ClassNetCacheFullName = 0xF,
		ReplayDormancy = 0x10,
		EnumSerializationCompat = 0x11,
		SubObjectOuterChain = 0x12,
		HitResultInstanceHandle = 0x13,
		InterfacePropertySerialization = 0x14,
		MontagePlayInstIdSerialization = 0x15,
		SerializeDoubleVectorsAsDoubles = 0x16,
		PackedVectorLWCSupport = 0x17,
		PawnRemoteViewPitch = 0x18,
		RepMoveServerFrameAndHandle = 0x19,
		Ver21AndViewPitchOnly_DONOTUSE = 0x1A,
		Placeholder = 0x1B,
		RuntimeFeaturesCompatibility = 0x1C,
		SoftObjectPtrNetGuids = 0x1D,
		SubObjectDestroyFlag = 0x1E,
		GameStateReplicatedTimeAsDouble = 0x1F,
		CustomVersions = 0x20,
		VersionPlusOne = 0x21,
		LatestVersion = 0x20
	};
...
enum ESkeletalMeshAsyncProperties:unsigned __int64
{
	None = 0x0,
	Materials = 0x1,
	Skeleton = 0x2,
...
enum EAccessibleBehavior:unsigned char
{
	NotAccessible = 0x0,
	Auto = 0x1,
	Summary = 0x2,
...
enum EFontCacheType:unsigned char
{
	Offline = 0x0,
	Runtime = 0x1
};

enum ECustomAttributeBlendType:unsigned char
{
	Override = 0x0,
	Blend = 0x1
};

enum EAudioFaderCurve:unsigned char
{
	Linear = 0x0,
	Logarithmic = 0x1,
	SCurve = 0x2,
...
enum EDirectoryVisitorFlags:unsigned char
{
	None = 0x0,
	ThreadSafe = 0x1
};

enum EBlueprintTextLiteralType:unsigned char
{
	Empty = 0x0,
	LocalizedText = 0x1,
	InvariantText = 0x2,
...
enum EAudioEncodeHint:unsigned char
{
	VoiceEncode_Voice = 0x0,
	VoiceEncode_Audio = 0x1
};

enum ETypedElementWorldType:unsigned char
{
	Game = 0x0,
	Editor = 0x1
};

enum EReloadCompleteReason:int
{
	None = 0x0,
...
enum EMultiBoxType:unsigned char
{
	MenuBar = 0x0,
	ToolBar = 0x1,
	VerticalToolBar = 0x2,
...
enum EClientRequestType:unsigned char
{
	NonePending = 0x0,
...
enum EMapPropertyFlags:int
{
	None = 0x0,
	UsesMemoryImageAllocator = 0x1
};

enum ERuntimeVirtualTextureDebugType:int
{
	None = 0x0,
	Debug = 0x1
};

enum ESkinnedAssetAsyncPropertyLockType:int
{
	None = 0x0,
	ReadOnly = 0x1,
	WriteOnly = 0x2,
...
enum ENDILandscape_SourceMode:unsigned char
{
	Default = 0x0,
	Source = 0x1,
	AttachParent = 0x2
...
enum EShadowCacheInvalidationBehavior:unsigned char
{
	Auto = 0x0,
	Always = 0x1,
	Rigid = 0x2,
...
enum ERuntimeVirtualTextureMainPassType:unsigned char
{
	Never = 0x0,
	Exclusive = 0x1,
	Always = 0x2
...
enum EScreenPercentageMode:int
{
	Manual = 0x0,
...
enum EEncryptionResponse:unsigned char
{
	Failure = 0x0,
	Success = 0x1,
	InvalidToken = 0x2,
...
enum EGpuVendorId:unsigned __int64
{
	Unknown = 0xFF,
	NotQueried = 0x0,
	Amd = 0x1002,
...
enum EMeshAttributeFlags:unsigned int
{
	None = 0x0,
	Lerpable = 0x1,
	AutoGenerated = 0x2,
...
enum ETextureEncodeSpeed:unsigned char
{
	Final = 0x0,
...
enum ECFCoreAutoCookingType:unsigned char
{
	All = 0x0,
	PCOnly = 0x1,
	Manual = 0x2
...
enum ENDIMeshRendererInfoVersion:unsigned int
{
	InitialVersion = 0x0,
...
enum EModsDirectoryMode:unsigned char
{
	None = 0x0,
	CFCore = 0x1,
	Flat = 0x2
...
enum ECFCoreModLoaderType:unsigned char
{
	Any = 0x0,
	Forge = 0x1,
	Cauldron = 0x2,
...
enum ECFCoreSortOrder:unsigned char
{
	None = 0x0,
	Asc = 0x1,
	Desc = 0x2
...
enum ECFCoreModsSearchSortField:unsigned char
{
	None = 0x0,
	Featured = 0x1,
	Popularity = 0x2,
...
enum ECFCoreMakrupType:unsigned char
{
...
enum ECFCoreChangelogMarkupType:unsigned char
{
	PlaceHolderDoNotUse = 0x0,
	Text = 0x1,
	HTML = 0x2,
...
enum ECFCoreFileReleaseType:unsigned char
{
	None = 0x0,
	Release = 0x1,
	Beta = 0x2,
...
enum ECFCoreErrorCodes:unsigned char
{
	None = 0x0,
	ApiError = 0x1,
	FileSystemError = 0x2,
...
enum ECFCoreStatus:unsigned char
{
	None = 0x0,
	Draft = 0x1,
	Test = 0x2,
...
enum ECFCoreApiStatus:unsigned char
{
	None = 0x0,
	Private = 0x1,
	Public = 0x2
...
enum ECFCoreHashAlgo:unsigned char
{
	None = 0x0,
	Sha1 = 0x1,
	Md5 = 0x2
...
enum ECFCoreFileRelationType:unsigned char
{
	None = 0x0,
	EmbeddedLibrary = 0x1,
...
enum ECFCoreFileStatus:unsigned char
{
	None = 0x0,
	Processing = 0x1,
	ChangesRequired = 0x2,
...
enum ECFCoreModStatus:unsigned char
{
	None = 0x0,
	New = 0x1,
	ChangesRequired = 0x2,
...
enum EMeshVertexChangeComponents:unsigned char
{
	None = 0x0,
	VertexPositions = 0x1,
	VertexColors = 0x2,
...
enum ECFCorePlatform:unsigned char
{
	None = 0x0,
	Windows = 0x1,
	XboxOne = 0x2,
...
enum EInstalledModStatus:unsigned char
{
	Pending = 0x0,
	OutOfDate = 0x1,
	Normal = 0x2,
...
enum ELibraryProgressState:unsigned char
{
	Pending = 0x0,
	Downloading = 0x1,
	Uploading = 0x2,
...
enum EModsUpdateProgressState:unsigned char
{
	Validating = 0x0,
	Installing = 0x1,
...
enum EHierarchicalSimplificationMethod:unsigned char
{
	None = 0x0,
	Merge = 0x1,
	Simplify = 0x2,
...
enum EGeometryScriptIndexType:unsigned char
{
	Any = 0x0,
	Triangle = 0x1,
	Vertex = 0x2,
...
enum EGeometryScriptDebugMessageType:unsigned char
{
	ErrorMessage = 0x0,
	WarningMessage = 0x1
};

enum EGeometryScriptErrorType:unsigned char
{
	NoError = 0x0,
	UnknownError = 0x1,
	InvalidInputs = 0x2,
...
enum EGeometryScriptOutcomePins:unsigned char
{
	Failure = 0x0,
	Success = 0x1
};

enum EGeometryScriptSearchOutcomePins:unsigned char
{
	Found = 0x0,
	NotFound = 0x1
};

enum EGeometryScriptContainmentOutcomePins:unsigned char
{
	Inside = 0x0,
	Outside = 0x1
};

enum EGeometryScriptLODType:unsigned char
{
	MaxAvailable = 0x0,
...
enum EGeometryScriptAxis:unsigned char
{
	X = 0x0,
	Y = 0x1,
	Z = 0x2
...
enum EMonoChannelUpmixMethod:signed char
{
	Linear = 0x0,
	EqualPower = 0x1,
	FullVolume = 0x2
...
enum EVirtualStackAllocatorDecommitMode:unsigned char
{
...
enum EDynamicMeshChangeType:unsigned char
{
	GeneralEdit = 0x0,
	MeshChange = 0x1,
...
enum EDynamicMeshAttributeChangeFlags:unsigned char
{
	Unknown = 0x0,
	MeshTopology = 0x1,
	VertexPositions = 0x2,
...
enum EGeometryScriptCollisionGenerationMethod:unsigned char
{
	AlignedBoxes = 0x0,
	OrientedBoxes = 0x1,
	MinimalSpheres = 0x2,
...
enum EGeometryScriptSweptHullAxis:unsigned char
{
	X = 0x0,
	Y = 0x1,
	Z = 0x2,
...
enum EDynamicMeshComponentRenderUpdateMode:int
{
	NoUpdate = 0x0,
	FullUpdate = 0x1,
	FastUpdate = 0x2
...
enum EMeshRenderAttributeFlags:unsigned char
{
	None = 0x0,
	Positions = 0x1,
	VertexColors = 0x2,
...
enum EDynamicMeshComponentTangentsMode:unsigned char
{
	NoTangents = 0x0,
	AutoCalculated = 0x1,
...
enum EMatchMakingServerResponse:int
{
...
enum ELeaderboardUploadScoreMethod:int
{
...
enum ELeaderboardSortMethod:int
{
...
enum EFriendFlags:unsigned __int64
{
...
enum EActivateGameOverlayToWebPageMode:int
{
...
enum ESteamIPType:int
{
	k_ESteamIPTypeIPv4 = 0x0,
	k_ESteamIPTypeIPv6 = 0x1
};

enum EPlatformMemorySizeBucket:int
{
	Largest = 0x0,
	Larger = 0x1,
	Default = 0x2,
...
enum ESecondaryScreenPercentageMethod:int
{
	NearestSpatialUpscale = 0x0,
	LowerPixelDensitySimulation = 0x1
};

enum ESteamEncryptedAppTicketState:int
{
	None = 0x0,
	TicketRequested = 0x1,
	TicketAvailable = 0x2,
...
enum EAnimSubsystemEnumeration:int
{
	Stop = 0x0,
	Continue = 0x1
};
...
enum ESteamIPv6ConnectivityState:int
{
...
enum ESteamIPv6ConnectivityProtocol:int
{
...
enum EGameSearchErrorCode_t:int
{
...
enum EGameDelegates_SaveGame:short
{
	MaxSize = 0x0,
	Icon = 0x1,
	Title = 0x2,
...
enum ESNetSocketConnectionType:int
{
...
enum ERemoteStorageLocalFileChange:int
{
...
enum ERemoteStorageFilePathType:int
{
...
enum ESteamPartyBeaconLocationType:int
{
...
enum ESteamInputActionEventType:int
{
...
enum FSteamConnectionMethod:signed char
{
	None = 0x0,
	Direct = 0x1,
	P2P = 0x2,
...
enum EColorVisionDeficiency:unsigned char
{
	NormalVision = 0x0,
	Deuteranope = 0x1,
	Protanope = 0x2,
...
enum EAudioParameterType:unsigned char
{
	None = 0x0,
	Boolean = 0x1,
	Integer = 0x2,
...
enum ETextureChromaticAdaptationMethod:unsigned char
{
	TCAM_None = 0x0,
	TCAM_Bradford = 0x1,
	TCAM_CAT02 = 0x2
...
enum EModulationRouting:unsigned char
{
	Disable = 0x0,
	Inherit = 0x1,
	Override = 0x2,
...
enum EVectorQuantization:unsigned char
{
...
enum EDynamicMeshComponentColorOverrideMode:unsigned char
{
	None = 0x0,
	VertexColors = 0x1,
	Polygroups = 0x2,
...
enum ECustomBoneAttributeLookup:unsigned char
{
	BoneOnly = 0x0,
	ImmediateParent = 0x1,
	ParentHierarchy = 0x2
...
enum ETextFlowDirection:unsigned char
{
	Auto = 0x0,
	LeftToRight = 0x1,
	RightToLeft = 0x2,
...
enum EPackageReloadPhase:unsigned char
{
	PrePackageLoad = 0x0,
	PrePackageFixup = 0x1,
	OnPackageFixup = 0x2,
...
enum EHoudiniParameterType:unsigned char
{
	Invalid = 0x0,
	Button = 0x1,
	ButtonStrip = 0x2,
...
enum EHoudiniRampInterpolationType:signed char
{
	InValid = 0xFF,
	CONSTANT = 0x0,
	LINEAR = 0x1,
...
enum EProcessDiagnosticFlags:unsigned int
{
	None = 0x0,
	MemorySanitizer = 0x1,
	AnsiMalloc = 0x2,
...
enum EPageFaultFlags:unsigned char
{
	SoftPageFaults = 0x1,
	HardPageFaults = 0x2,
	TotalPageFaults = 0x4,
...
enum EContextSwitchFlags:unsigned char
{
	VoluntaryContextSwitches = 0x1,
	InvoluntaryContextSwitches = 0x2,
	TotalContextSwitches = 0x4,
	All = 0xFF
};

enum ESteamAuthStatus:unsigned char
{
	None = 0x0,
	AuthSuccess = 0x1,
	AuthFail = 0x2,
...
enum EFlushLevelStreamingType:unsigned char
{
	None = 0x0,
	Full = 0x1,
	Visibility = 0x2
...
enum ENetworkConnectionStatus:unsigned char
{
	Unknown = 0x0,
	Disabled = 0x1,
	Local = 0x2,
...
enum ENetworkConnectionType:unsigned char
{
	Unknown = 0x0,
	None = 0x1,
	AirplaneMode = 0x2,
...
enum EDeviceScreenOrientation:unsigned char
{
	Unknown = 0x0,
	Portrait = 0x1,
...
enum EConvertibleLaptopMode:int
{
	NotSupported = 0x0,
	Laptop = 0x1,
	Tablet = 0x2
...
enum EAsyncTraceType:unsigned char
{
	Test = 0x0,
	Single = 0x1,
	Multi = 0x2
...
enum EHoudiniFolderParameterType:unsigned char
{
	Invalid = 0x0,
	Collapsible = 0x1,
	Simple = 0x2,
...
enum EUserVerificationStatus:int
{
	NotStarted = 0x0,
...
enum EAuthPhaseFailureCode:int
{
	Success = 0x0,
...
enum EEOSNetDriverRole:signed char
{
	DedicatedServer = 0x0,
	ListenServer = 0x1,
...
enum EStatTypingRule:unsigned char
{
	Int32 = 0x0,
	Bool = 0x1,
	FloatTruncated = 0x2,
...
enum EGeometryScriptMeshSelectionType:unsigned char
{
	Vertices = 0x0,
	Triangles = 0x1,
	Polygroups = 0x2
...
enum EGeometryScriptCombineSelectionMode:unsigned char
{
	Add = 0x0,
	Subtract = 0x1,
	Intersection = 0x2
...
enum ESteamAuthMsgType:unsigned char
{
	None = 0x0,
	Auth = 0x1,
	Result = 0x2,
...
enum ESteamAuthResponseCode:unsigned char
{
	OK = 0x0,
...
enum EOS_EAntiCheatCommonClientAuthStatus:int
{
...
enum EOS_EAntiCheatCommonClientAction:int
{
	EOS_ACCCA_Invalid = 0x0,
	EOS_ACCCA_RemovePlayer = 0x1
};

enum EGeometryScriptMeshSelectionConversionType:unsigned char
{
	NoConversion = 0x0,
	ToVertices = 0x1,
	ToTriangles = 0x2,
...
enum EGeometryScriptEmptySelectionBehavior:unsigned char
{
	FullMeshSelection = 0x0,
	EmptySelection = 0x1
};

enum EMultiBlockType:unsigned char
{
	None = 0x0,
	ButtonRow = 0x1,
	EditableText = 0x2,
...
enum ENetPingControlMessage:unsigned char
{
	SetPingAddress = 0x0,
	PingFailure = 0x1,
	Max = 0x1
...
enum EPingAverageType:unsigned char
{
	None = 0x0,
	MovingAverage = 0x1,
	PlayerStateAvg = 0x2
...
enum EDynamicResolutionStatus:int
{
	Unsupported = 0x0,
	Disabled = 0x1,
	Paused = 0x2,
...
enum ERDGPooledBufferAlignment:unsigned char
{
	None = 0x0,
	Page = 0x1,
	PowerOfTwo = 0x2
...
enum ERootMotionModifierState:unsigned char
{
	Waiting = 0x0,
	Active = 0x1,
...
enum EWarpPointAnimProvider:unsigned char
{
	None = 0x0,
	Static = 0x1,
	Bone = 0x2
...
enum EMotionWarpRotationType:unsigned char
{
	Default = 0x0,
	Facing = 0x1
};
...
enum EVTRequestPagePriority:int
{
	Normal = 0x0,
	High = 0x1
};
...
enum ovrPlatformInitializeResult_:int
{
...
enum ovrLeaderboardStartAt_:int
{
...
enum ovrLeaderboardFilterType_:int
{
...
enum ovrUserPresenceStatus_:int
{
...
enum ovrPeerConnectionState_:int
{
...
enum ovrMatchmakingCriterionImportance_:int
{
...
enum EStreamingSourcePriority:unsigned char
{
	Highest = 0x0,
	High = 0x40,
	Normal = 0x80,
...
enum EComputeNTBsFlags:unsigned int
{
	None = 0x0,
	Normals = 0x1,
	Tangents = 0x2,
...
enum EGeometryScriptBakeCurvatureClampMode:unsigned char
{
	None = 0x0,
	OnlyPositive = 0x1,
	OnlyNegative = 0x2
...
enum EGeometryScriptBakeCurvatureColorMode:unsigned char
{
	Grayscale = 0x0,
	RedBlue = 0x1,
	RedGreenBlue = 0x2
...
enum EGeometryScriptBakeCurvatureTypeMode:unsigned char
{
	Mean = 0x0,
	Max = 0x1,
	Min = 0x2,
...
enum EGeometryScriptBakeTypes:unsigned char
{
...
enum EGeometryScriptBakeNormalSpace:unsigned char
{
	Tangent = 0x0,
	Object = 0x1
};

enum ERDGHandleRegistryDestructPolicy:int
{
	Registry = 0x0,
	Allocator = 0x1,
	Never = 0x2
...
enum EGeometryScriptBakeResolution:unsigned char
{
	Resolution16 = 0x0,
	Resolution32 = 0x1,
	Resolution64 = 0x2,
...
enum EGeometryScriptBakeBitDepth:unsigned char
{
	ChannelBits8 = 0x0,
	ChannelBits16 = 0x1
};

enum EGeometryScriptBakeSamplesPerPixel:unsigned char
{
	Sample1 = 0x0,
	Sample4 = 0x1,
	Sample16 = 0x2,
...
enum EGeometryScriptBakeOutputMode:unsigned char
{
	RGBA = 0x0,
	PerChannel = 0x1
};

enum EMeshLODIdentifier:int
{
	LOD0 = 0x0,
	LOD1 = 0x1,
	LOD2 = 0x2,
...
enum ENodeEnabledState:unsigned char
{
	Enabled = 0x0,
	Disabled = 0x1,
	DevelopmentOnly = 0x2
...
enum ESaveOrphanPinMode:unsigned char
{
	SaveNone = 0x0,
	SaveAll = 0x1,
	SaveAllButExec = 0x2
...
enum EByteOrderMark:signed char
{
	UTF8 = 0x0,
	Unspecified = 0x1
};

enum ELargeMemoryReaderFlags:unsigned char
{
	None = 0x0,
	TakeOwnership = 0x1,
	Persistent = 0x2
...
enum EBufferWriterFlags:unsigned char
{
	None = 0x0,
	TakeOwnership = 0x1,
	AllowResize = 0x2
...
enum ECFCoreThumbsUpDirection:unsigned char
{
	None = 0x0,
	Up = 0x1,
	Down = 0x2
...
enum ECppProperty:int
{
	EC_CppProperty = 0x0
};

enum EImageFormat:signed char
{
	Invalid = 0xFF,
	PNG = 0x0,
	JPEG = 0x1,
...
enum EHttpFlushReason:unsigned char
{
	Default = 0x0,
	Background = 0x1,
	Shutdown = 0x2,
...
enum EReportNewBugStatus:unsigned char
{
	NotReporting = 0x0,
...
enum EBakeTextureResolution:int
{
	Resolution16 = 0x10,
	Resolution32 = 0x20,
	Resolution64 = 0x40,
...
enum EBakeTextureSamplesPerPixel:int
{
	Sample1 = 0x1,
	Sample4 = 0x4,
	Sample16 = 0x10,
...
enum ECollisionQuery:unsigned char
{
	ObjectQuery = 0x0,
	TraceQuery = 0x1
};

enum EGeometryScriptCombineAttributesMode:unsigned char
{
...
enum EGeometryScriptSmoothBoneWeightsType:unsigned char
{
	DirectDistance = 0x0,
	GeodesicVoxel = 0x1
};
...
enum EGeometryScriptBooleanOperation:unsigned char
{
	Union = 0x0,
	Intersection = 0x1,
	Subtract = 0x2
...
enum ECollisionShapeType:unsigned char
{
	Sphere = 0x0,
	Plane = 0x1,
	Box = 0x2,
...
enum EEulerRotationOrder:unsigned char
{
	XYZ = 0x0,
	XZY = 0x1,
	YXZ = 0x2,
...
enum ETextPluralForm:unsigned char
{
	Zero = 0x0,
	One = 0x1,
	Two = 0x2,
...
enum TextureCookPlatformTilingSettings:unsigned char
{
...
enum ENavigationDataResolution:unsigned char
{
	Low = 0x0,
	Default = 0x1,
	High = 0x2,
...
enum EUpdateRateShiftBucket:unsigned char
{
	ShiftBucket0 = 0x0,
	ShiftBucket1 = 0x1,
	ShiftBucket2 = 0x2,
...
enum ERigElementType:unsigned char
{
	None = 0x0,
	Bone = 0x1,
	Null = 0x2,
...
enum EShowFlagShippingValue:int
{
	Dynamic = 0x0,
	ForceEnabled = 0x1,
	ForceDisabled = 0x2
...
enum EGeometryScriptMathWarpType:unsigned char
{
	SinWave1D = 0x0,
	SinWave2D = 0x1,
	SinWave3D = 0x2
...
enum EGeometryScriptFlareType:unsigned char
{
	SinMode = 0x0,
	SinSquaredMode = 0x1,
	TriangleMode = 0x2
...
enum EGroomViewMode:unsigned char
{
	None = 0x0,
	SimHairStrands = 0x1,
...
enum ERDGImportedBufferFlags:int
{
	None = 0x0,
	CreateSRV = 0x1,
	CreateUAV = 0x2,
...
enum EGeometryScriptMeshEditPolygroupMode:unsigned char
{
...
enum EGeometryScriptMeshBevelSelectionMode:unsigned char
{
	TriangleArea = 0x0,
...
enum EGeometryScriptLinearExtrudeDirection:unsigned char
{
	FixedDirection = 0x0,
	AverageFaceNormal = 0x1
};

enum EGeometryScriptPolyOperationArea:unsigned char
{
	EntireSelection = 0x0,
	PerPolygroup = 0x1,
	PerTriangle = 0x2
...
enum EGeometryScriptOffsetFacesType:unsigned char
{
	VertexNormal = 0x0,
	FaceNormal = 0x1,
...
enum EReplicationGraphBehavior:unsigned char
{
	Default = 0x0,
	NotRouted = 0x1,
...
enum EHairStrandsAllocationType:unsigned char
{
	Immediate = 0x0,
	Deferred = 0x1
};

enum EHairResourceLoadingType:unsigned char
{
	Async = 0x0,
	Sync = 0x1
};

enum EHairResourceStatus:unsigned char
{
	None = 0x0,
	Loading = 0x1,
	Valid = 0x2
...
enum EHairStrandsResourcesType:unsigned char
{
	Guides = 0x0,
	Strands = 0x1,
	Cards = 0x2
...
enum EGeometryScriptTopologyConnectionType:unsigned char
{
	Geometric = 0x0,
	Polygroup = 0x1,
	MaterialID = 0x2
...
enum EGroomInterpolationQuality:unsigned char
{
	Low = 0x0,
	Medium = 0x1,
	High = 0x2,
...
enum EGroomInterpolationWeight:unsigned char
{
	Parametric = 0x0,
	Root = 0x1,
	Index = 0x2,
...
enum EAutoPossessAI:unsigned char
{
	Disabled = 0x0,
	PlacedInWorld = 0x1,
	Spawned = 0x2,
...
enum EGeometryScriptTangentTypes:unsigned char
{
	FastMikkT = 0x0,
	PerTriangle = 0x1
};

enum EMaterialFunctionUsage:unsigned char
{
	Default = 0x0,
	MaterialLayer = 0x1,
...
enum EGroomInterpolationType:unsigned char
{
	None = 0x0,
	RigidTransform = 0x2,
	OffsetTransform = 0x4,
...
enum EGroomGeometryType:unsigned char
{
	Strands = 0x0,
	Cards = 0x1,
	Meshes = 0x2
...
enum EGroomBindingType:unsigned char
{
	NoneBinding = 0x0,
	Rigid = 0x1,
	Skinning = 0x2
...
enum EGroomStrandsSize:unsigned char
{
	None = 0x0,
	Size2 = 0x2,
	Size4 = 0x4,
...
enum EHairInterpolationQuality:unsigned char
{
	Low = 0x0,
	Medium = 0x1,
	High = 0x2,
...
enum EHairInterpolationWeight:unsigned char
{
	Parametric = 0x0,
	Root = 0x1,
	Index = 0x2,
...
enum EGeometryScriptPrimitiveOriginMode:unsigned char
{
	Center = 0x0,
	Base = 0x1
};

enum EGeometryScriptPrimitivePolygroupMode:unsigned char
{
	SingleGroup = 0x0,
	PerFace = 0x1,
	PerQuad = 0x2
...
enum EGeometryScriptPrimitiveUVMode:unsigned char
{
	Uniform = 0x0,
	ScaleToFill = 0x1
};

enum EGroomOverrideType:unsigned char
{
	Auto = 0x0,
	Enable = 0x1,
	Disable = 0x2
...
enum EAttenuationDistanceModel:unsigned char
{
	Linear = 0x0,
	Logarithmic = 0x1,
	Inverse = 0x2,
...
enum EHairCardsSourceType:unsigned char
{
	Procedural = 0x0,
	Imported = 0x1
};

enum EHairCardsClusterType:unsigned char
{
	Low = 0x0,
	High = 0x1
};

enum EHairCardsGenerationType:unsigned char
{
	CardsCount = 0x0,
	UseGuides = 0x1
};

enum EPropertyExportCPPFlags:int
{
	CPPF_None = 0x0,
...
enum EHairAtlasTextureType:unsigned char
{
	Depth = 0x0,
	Tangent = 0x1,
	Attribute = 0x2,
...
enum ENotifyRegistrationType:int
{
	NRT_Class = 0x0,
	NRT_ClassCDO = 0x1,
	NRT_Struct = 0x2,
...
enum EGroomCacheAttributes:unsigned char
{
	None = 0x0,
	Position = 0x1,
	Width = 0x2,
...
enum EGroomCacheType:unsigned char
{
	None = 0x0,
	Strands = 0x1,
	Guides = 0x2
...
enum EToolShutdownType:unsigned char
{
	Completed = 0x0,
	Accept = 0x1,
	Cancel = 0x2
...
enum ECheatPunishType:unsigned char
{
	Unknown = 0x0,
	KickClient = 0x1,
	KickMatch = 0x2,
...
enum EGeometryScriptRemeshSmoothingType:unsigned char
{
	Uniform = 0x0,
	UVPreserving = 0x1,
	Mixed = 0x2
...
enum EGeometryScriptRemeshEdgeConstraintType:unsigned char
{
	Fixed = 0x0,
	Refine = 0x1,
	Free = 0x2,
...
enum EGeometryScriptUniformRemeshTargetType:unsigned char
{
	TriangleCount = 0x0,
	TargetEdgeLength = 0x1
};

enum ERemeshType:unsigned char
{
	Standard = 0x0,
	FullPass = 0x1,
	NormalFlow = 0x2
...
enum ERemeshSmoothingType:unsigned char
{
	Uniform = 0x0,
	Cotangent = 0x1,
	MeanValue = 0x2
...
enum EGeometryScriptFillHolesMethod:unsigned char
{
	Automatic = 0x0,
	MinimalFill = 0x1,
...
enum EGeometryScriptRemoveHiddenTrianglesMethod:unsigned char
{
	FastWindingNumber = 0x0,
	RaycastOcclusionTest = 0x1
};

enum EGeometryScriptRepairMeshMode:unsigned char
{
	DeleteOnly = 0x0,
	RepairOrDelete = 0x1,
	RepairOrSkip = 0x2
...
enum EGCTokenType:unsigned int
{
	Native = 0x0,
	NonNative = 0x1
};

enum EHoleFillOpFillType:unsigned char
{
	TriangleFan = 0x0,
...
enum ESelectedObjectsModificationType:int
{
	Replace = 0x0,
	Add = 0x1,
	Remove = 0x2,
...
enum ERigVMMemoryType:unsigned char
{
	Work = 0x0,
	Literal = 0x1,
	External = 0x2,
...
enum ERigVMPropertyPathSegmentType:int
{
	StructMember = 0x0,
	ArrayElement = 0x1,
	MapValue = 0x2
...
enum ERigVMExecuteResult:unsigned char
{
	Failed = 0x0,
	Succeeded = 0x1
};

enum EGeometryScriptSamplingDistributionMode:unsigned char
{
	Uniform = 0x0,
	Smaller = 0x1,
	Larger = 0x2
...
enum EGeometryScriptSamplingWeightMode:unsigned char
{
	WeightToRadius = 0x0,
...
enum ERigVMParameterType:unsigned char
{
	Input = 0x0,
	Output = 0x1,
	Invalid = 0x2
...
enum EEdGraphNodeDeprecationType:int
{
	NodeTypeIsDeprecated = 0x0,
	NodeHasDeprecatedReference = 0x1
};

enum EStandardToolContextMaterials:int
{
	VertexColorMaterial = 0x1
};

enum EMultiTransformerMode:int
{
	DefaultGizmo = 0x1,
	QuickAxisTranslation = 0x2
};

enum ERigVMNameOp:unsigned char
{
	None = 0x0,
	Concat = 0x1,
	Left = 0x2,
...
enum EGeometryScriptRemoveMeshSimplificationType:unsigned char
{
	StandardQEM = 0x0,
...
enum ESelectiveTessellatePatternType:unsigned char
{
	ConcentricRings = 0x0
};

enum ESceneSnapQueryTargetType:unsigned char
{
	None = 0x0,
	MeshVertex = 0x1,
	MeshEdge = 0x2,
...
enum ERigVMRegisterType:unsigned char
{
	Plain = 0x0,
	String = 0x1,
	Name = 0x2,
...
enum EGeometryScriptUVFlattenMethod:unsigned char
{
	ExpMap = 0x0,
	Conformal = 0x1,
...
enum EGeometryScriptUVIslandSource:unsigned char
{
	PolyGroups = 0x0,
	UVIslands = 0x1
};

enum ERigVMPinDirection:unsigned char
{
	Input = 0x0,
	Output = 0x1,
	IO = 0x2,
...
enum ETransformGizmoSubElements:unsigned __int64
{
	None = 0x0,
	TranslateAxisX = 0x2,
	TranslateAxisY = 0x4,
...
enum EGeometryScriptMorphologicalOpType:unsigned char
{
	Dilate = 0x0,
	Contract = 0x1,
	Close = 0x2,
...
enum ERigVMUserWorkflowType:unsigned char
{
	Invalid = 0x0,
	NodeContext = 0x1,
	PinContext = 0x2,
...
enum ESlateInvalidationPaintType:int
{
	None = 0x0,
	Slow = 0x1,
	Fast = 0x2
...
enum EConsumeMouseWheel:unsigned char
{
...
enum EConfigExpansionFlags:int
{
	None = 0x0,
	ForUncooked = 0x1,
	ForCooked = 0x2,
...
enum EGeometryScriptGridSizingMethod:unsigned char
{
	GridCellSize = 0x0,
	GridResolution = 0x1
};

enum ESoftObjectPathSerializeType:unsigned char
{
	NeverSerialize = 0x0,
...
enum ERigVMOpCode:unsigned char
{
...
enum ERigVMCopyType:unsigned char
{
	Default = 0x0,
	FloatToDouble = 0x1,
	DoubleToFloat = 0x2
...
enum EGeometryScriptSampleSpacing:unsigned char
{
	UniformDistance = 0x0,
	UniformTime = 0x1,
	ErrorTolerance = 0x2
...
enum EHoudiniExecutableType:int
{
	HRSHE_Houdini = 0x0,
	HRSHE_HoudiniFX = 0x1,
...
enum EHoudiniRuntimeSettingsRecomputeFlag:int
{
	HRSRF_Always = 0x0,
...
enum EHoudiniRuntimeSettingsSessionType:int
{
	HRSST_InProcess = 0x0,
	HRSST_Socket = 0x1,
	HRSST_NamedPipe = 0x2,
...
enum EHoudiniMultiParmModificationType:unsigned char
{
	None = 0x0,
	Inserted = 0x1,
	Removed = 0x2,
...
enum EHoudiniRampPointConstructStatus:unsigned char
{
	None = 0x0,
	INITIALIZED = 0x1,
...
enum EAudioPlugin:unsigned char
{
	SPATIALIZATION = 0x0,
	REVERB = 0x1,
	OCCLUSION = 0x2,
...
enum EPDGLinkState:unsigned char
{
	Inactive = 0x0,
	Linking = 0x1,
	Linked = 0x2,
...
enum EPDGWorkResultState:unsigned char
{
	None = 0x0,
	ToLoad = 0x1,
	Loading = 0x2,
...
enum EGeometryScriptPixelSamplingMethod:unsigned char
{
	Bilinear = 0x0,
	Nearest = 0x1
};

enum EPDGNodeState:unsigned char
{
	None = 0x0,
	Dirtied = 0x1,
	Dirtying = 0x2,
...
enum ERigControlValueType:unsigned char
{
	Initial = 0x0,
	Current = 0x1,
	Minimum = 0x2,
...
enum ERigControlType:unsigned char
{
	Bool = 0x0,
	Float = 0x1,
	Integer = 0x2,
...
enum ERigControlAxis:unsigned char
{
	X = 0x0,
	Y = 0x1,
	Z = 0x2
...
enum EControlRigContextChannelToKey:unsigned int
{
	None = 0x0,
	TranslationX = 0x1,
	TranslationY = 0x2,
...
enum EControlRigSetKey:unsigned char
{
	DoNotCare = 0x0,
	Always = 0x1,
	Never = 0x2
...
enum ERigMetadataType:unsigned char
{
	Bool = 0x0,
	BoolArray = 0x1,
	Float = 0x2,
...
enum ERigHierarchyNotification:unsigned char
{
	ElementAdded = 0x0,
	ElementRemoved = 0x1,
	ElementRenamed = 0x2,
...
enum ERigBoneType:unsigned char
{
	Imported = 0x0,
	User = 0x1
};

enum ERigControlAnimationType:unsigned char
{
...
enum ERigControlVisibility:unsigned char
{
	UserDefined = 0x0,
	BasedOnSelection = 0x1
};

enum ERigControlTransformChannel:unsigned char
{
	TranslationX = 0x0,
	TranslationY = 0x1,
	TranslationZ = 0x2,
...
enum ERigSpaceType:unsigned char
{
	Global = 0x0,
	Bone = 0x1,
	Control = 0x2,
...
enum EControlRigInteractionType:unsigned char
{
	None = 0x0,
	Translate = 0x1,
	Rotate = 0x2,
...
enum ERigVMNodeCreatedReason:unsigned char
{
	NodeSpawner = 0x0,
	ScriptedEvent = 0x1,
	Paste = 0x2,
...
enum ETransformConstraintType:unsigned char
{
	Translation = 0x0,
	Rotation = 0x1,
	Scale = 0x2,
...
enum EConstraintType:unsigned char
{
	Transform = 0x0,
	Aim = 0x1,
	MAX = 0x2
...
enum EOS_EExternalAccountType:int
{
	EOS_EAT_EPIC = 0x0,
	EOS_EAT_STEAM = 0x1,
	EOS_EAT_PSN = 0x2,
...
enum EOS_EApplicationStatus:int
{
...
enum ERigExecutionType:unsigned char
{
	Runtime = 0x0,
	Editing = 0x1,
	Max = 0x2
...
enum EMovieScenePositionType:unsigned char
{
	Frame = 0x0,
	Time = 0x1,
	MarkedFrame = 0x2
...
enum EUpdatePositionMethod:unsigned char
{
	Play = 0x0,
	Jump = 0x1,
	Scrub = 0x2
...
enum EClothLODBiasMode:unsigned char
{
...
enum ESkeletalMeshGeoImportVersions:unsigned char
{
...
enum ESkeletalMeshSkinningImportVersions:unsigned char
{
	Before_Versionning = 0x0,
	SkeletalMeshBuildRefactor = 0x1,
	VersionPlusOne = 0x2,
...
enum EMovieSceneControlRigSpaceType:unsigned char
{
	Parent = 0x0,
	World = 0x1,
	ControlRig = 0x2
...
enum ETimeStretchCurveMapping:unsigned char
{
	T_Original = 0x0,
	T_TargetMin = 0x1,
	T_TargetMax = 0x2,
...
enum ESidebarLocation:unsigned char
{
	Left = 0x0,
	Right = 0x1,
	None = 0x2
...
enum EShaderResourceUsageFlags:unsigned char
{
...
enum EAllowKinematicDeferral:int
{
	AllowDeferral = 0x0,
...
enum EUVOutput:unsigned char
{
	DoNotOutputChannel = 0x0,
	OutputChannel = 0x1
};

enum EHeaderComboVisibility:int
{
	Always = 0x0,
	Ghosted = 0x1,
	OnHover = 0x2,
...
enum ESlateVertexRounding:unsigned char
{
	Disabled = 0x0,
	Enabled = 0x1
};

enum EMouseLockMode:unsigned char
{
	DoNotLock = 0x0,
	LockOnCapture = 0x1,
	LockAlways = 0x2,
...
enum EPreviewAnimationBlueprintApplicationMethod:unsigned char
{
	LinkedLayers = 0x0,
	LinkedAnimGraph = 0x1
};

enum EControlRigVectorKind:unsigned char
{
	Direction = 0x0,
	Location = 0x1
};

enum ETableRowSignalSelectionMode:int
{
	Deferred = 0x0,
	Instantaneous = 0x1
};

enum EControlRigComponentMapDirection:unsigned char
{
	Input = 0x0,
	Output = 0x1
};

enum EControlRigComponentSpace:unsigned char
{
	WorldSpace = 0x0,
	ActorSpace = 0x1,
	ComponentSpace = 0x2,
...
enum EAirAbsorptionMethod:unsigned char
{
	Linear = 0x0,
	CustomCurve = 0x1
};

enum EReverbSendMethod:unsigned char
{
	Linear = 0x0,
	CustomCurve = 0x1,
	Manual = 0x2
...
enum EPriorityAttenuationMethod:unsigned char
{
	Linear = 0x0,
	CustomCurve = 0x1,
	Manual = 0x2
...
enum ELoadModuleFlags:int
{
	None = 0x0,
	LogFailures = 0x1
};

enum EModuleLoadResult:int
{
	Success = 0x0,
	FileNotFound = 0x1,
...
enum EGoogleExchangeToken:unsigned char
{
	GoogleExchangeToken = 0x0
};

enum EGoogleRefreshToken:unsigned char
{
	GoogleRefreshToken = 0x0
};

enum EGoogleAuthTokenType:unsigned char
{
	ExchangeToken = 0x0,
	RefreshToken = 0x1,
	AccessToken = 0x2
...
enum ECOMModel:unsigned char
{
	Singlethreaded = 0x0,
	Multithreaded = 0x1
};

enum EHandleEvent:unsigned char
{
...
enum EMemoryTraceHeapFlags:unsigned short
{
	None = 0x0,
	Root = 0x1,
	NeverFrees = 0x2
...
enum ERigVMTransformSpace:unsigned char
{
	LocalSpace = 0x0,
	GlobalSpace = 0x1,
	Max = 0x2
...
enum EUsdRootMotionHandling:int
{
...
enum ESchemaTranslationLaunchPolicy:int
{
	ExclusiveSync = 0x0,
	Sync = 0x1,
	Async = 0x2
...
enum EConcurrencyVolumeScaleMode:int
{
	Default = 0x0,
	Distance = 0x1,
	Priority = 0x2
...
enum EApplyRendertargetOption:int
{
	DoNothing = 0x0,
	CheckApply = 0x1,
	ForceApply = 0x1
...
enum ERigVMAnimEasingType:unsigned char
{
	Linear = 0x0,
	QuadraticEaseIn = 0x1,
...
enum ETransformSpaceMode:unsigned char
{
	LocalSpace = 0x0,
	GlobalSpace = 0x1,
	BaseSpace = 0x2,
...
enum ETransformGetterType:unsigned char
{
	Initial = 0x0,
	Current = 0x1,
	Max = 0x2
...
enum EControlRigTestDataPlaybackMode:unsigned char
{
	Live = 0x0,
	ReplayInputs = 0x1,
	GroundTruth = 0x2,
...
enum ESchemaTranslationStatus:int
{
	Pending = 0x0,
	InProgress = 0x1,
	Done = 0x2
...
enum ECRSimConstraintType:unsigned char
{
	Distance = 0x0,
	DistanceFromA = 0x1,
	DistanceFromB = 0x2,
...
enum ECRSimPointForceType:unsigned char
{
	Direction = 0x0
};

enum ECRSimSoftCollisionType:unsigned char
{
	Plane = 0x0,
	Sphere = 0x1,
	Cone = 0x2
...
enum ETransitionType:unsigned char
{
	None = 0x0,
	Paused = 0x1,
	Loading = 0x2,
...
enum ERotatorQuantization:unsigned char
{
	ByteComponents = 0x0,
	ShortComponents = 0x1
};

enum EMeshBufferAccess:unsigned char
{
	Default = 0x0,
	ForceCPUAndGPU = 0x1
};
...
enum _MM_MANTISSA_SIGN_ENUM:int
{
...
enum EResizingAxis:unsigned char
{
	None = 0x0,
	LeftRightMask = 0x1,
	UpDownMask = 0x10,
...
enum ESequenceTimeUnit:unsigned char
{
	DisplayRate = 0x0,
	TickResolution = 0x1
};
...
enum EMovieSceneKeyInterpolation:unsigned char
{
	Auto = 0x0,
	User = 0x1,
	Break = 0x2,
...
enum EVirtualizationMode:unsigned char
{
	Disabled = 0x0,
	PlayWhenSilent = 0x1,
	Restart = 0x2
...
enum EPostCopyOperation:unsigned char
{
	None = 0x0,
	LogicalNegateBool = 0x1
};

enum EHairBufferSwapType:int
{
	BeginOfFrame = 0x0,
	EndOfFrame = 0x1,
	Tick = 0x2,
...
enum ESlateLineJoinType:unsigned char
{
	Sharp = 0x0,
	Simple = 0x1
};

enum EHairStrandsBookmark:unsigned char
{
	ProcessTasks = 0x0,
...
enum EHairResourceUsageType:unsigned char
{
	Static = 0x0,
	Dynamic = 0x1
};
...
enum ERunAttributes:unsigned char
{
	None = 0x0,
	SupportsText = 0x1
};

enum EDepthStencilTargetActions:unsigned char
{
	DepthMask = 0x4,
...
enum EGameplayContainerMatchType:unsigned char
{
	Any = 0x0,
	All = 0x1
};

enum EReplayHeaderFlags:unsigned int
{
	None = 0x0,
	ClientRecorded = 0x1,
...
enum ELaplacianWeightScheme:int
{
	Uniform = 0x0,
	Umbrella = 0x1,
	Valence = 0x2,
...
enum ESoundscapeColorAltitudeClampMode:unsigned char
{
	Relative = 0x0,
	Absolute = 0x1
};

enum EMeshLODSelectionType:unsigned char
{
	AllLODs = 0x0,
	SpecificLOD = 0x1,
	CalculateLOD = 0x2,
...
enum EAutoCenter:unsigned char
{
	None = 0x0,
	PrimaryWorkArea = 0x1,
...
enum ESoundscapeLOD:unsigned char
{
	LOD1 = 0x0,
	LOD2 = 0x1,
	LOD3 = 0x2
...
enum ESlateColorStylingMode:unsigned char
{
...
enum EAudioComponentPlayState:unsigned char
{
	Playing = 0x0,
	Stopped = 0x1,
	Paused = 0x2,
...
enum ERotationComponent:unsigned char
{
	EulerX = 0x0,
	EulerY = 0x1,
	EulerZ = 0x2,
...
enum EBlueprintCompileMode:unsigned char
{
	Default = 0x0,
	Development = 0x1,
	FinalRelease = 0x2
...
enum EEasingFuncType:unsigned char
{
	Linear = 0x0,
	Sinusoidal = 0x1,
	Cubic = 0x2,
...
enum ERenderTargetActions:unsigned char
{
	LoadOpMask = 0x2,
	DontLoad_DontStore = 0x0,
	DontLoad_Store = 0x1,
...
enum ERuntimeVirtualTextureAttributeType:unsigned char
{
	BaseColor = 0x0,
	Normal = 0x1,
	Roughness = 0x2,
...
enum ECustomVersionDifference:int
{
	Missing = 0x0,
	Newer = 0x1,
	Older = 0x2,
...
enum EKnownIniFile:unsigned char
{
	Engine = 0x0,
	Game = 0x1,
	Input = 0x2,
...
enum EShaderCodeResourceBindingType:unsigned char
{
	Invalid = 0x0,
	SamplerState = 0x1,
	Texture2D = 0x2,
...
enum EPCGMetadataTypes:unsigned char
{
	Float = 0x0,
	Double = 0x1,
	Integer32 = 0x2,
...
enum EPCGAttributeAccessorFlags:int
{
	StrictType = 0x1,
	AllowBroadcast = 0x2,
...
enum EPCGPointProperties:unsigned char
{
	Density = 0x0,
	BoundsMin = 0x1,
	BoundsMax = 0x2,
...
enum EPCGAttributePropertySelection:int
{
	Attribute = 0x0,
	PointProperty = 0x1
};

enum EPCGDataType:unsigned int
{
	None = 0x0,
	Point = 0x2,
	Spline = 0x4,
...
enum ERecomputeUVsPropertiesUnwrapType:int
{
	ExpMap = 0x0,
	Conformal = 0x1,
	SpectralConformal = 0x2,
...
enum ERecomputeUVsPropertiesIslandMode:int
{
	PolyGroups = 0x0,
	ExistingUVs = 0x1
};

enum ERecomputeUVsToolOrientationMode:int
{
	None = 0x0,
	MinBounds = 0x1
};

enum ERecomputeUVsPropertiesLayoutType:int
{
	None = 0x0,
	Repack = 0x1,
...
enum ENormalCalculationMethod:unsigned char
{
	AreaWeighted = 0x0,
	AngleWeighted = 0x1,
...
enum ESplitNormalMethod:unsigned char
{
...
enum EPCGMetadataOp:unsigned char
{
	Min = 0x0,
	Max = 0x1,
	Sub = 0x2,
...
enum EPCGMetadataFilterMode:unsigned char
{
...
enum EMorphologyOperation:unsigned char
{
	Dilate = 0x0,
	Contract = 0x1,
	Close = 0x2,
...
enum EDataValidationResult:unsigned char
{
	Invalid = 0x0,
	Valid = 0x1,
	NotValidated = 0x2
...
enum EPCGExecutionPhase:unsigned char
{
	NotExecuted = 0x0,
	PrepareData = 0x1,
	Execute = 0x2,
...
enum EPCGIntersectionDensityFunction:unsigned char
{
	Multiply = 0x0,
	Minimum = 0x1
};

enum EPCGUnionType:unsigned char
{
...
enum EPCGUnionDensityFunction:unsigned char
{
	Maximum = 0x0,
	ClampedAddition = 0x1,
	Binary = 0x2
...
enum EPCGDifferenceDensityFunction:unsigned char
{
	Minimum = 0x0,
...
enum EPCGChangeType:unsigned char
{
	None = 0x0,
	Cosmetic = 0x1,
	Settings = 0x2,
...
enum ESimpleRenderTargetMode:int
{
...
enum EHLODLevelExclusion:unsigned char
{
	HLOD0 = 0x1,
	HLOD1 = 0x2,
	HLOD2 = 0x4,
...
enum ERenderResourceState:unsigned char
{
	Default = 0x0,
	BatchReleased = 0x1,
	Deleted = 0x2
...
enum PCGNormalToDensityMode:signed char
{
	Set = 0x0,
	Minimum = 0x1,
	Maximum = 0x2,
...
enum EQuarztQuantizationReference:unsigned char
{
	BarRelative = 0x0,
...
enum EHoudiniPluginSerializationVersion:int
{
...
enum EApplyTransformMode:unsigned char
{
	Override = 0x0,
	Additive = 0x1,
	Max = 0x2
...
enum EFoliageInstanceFlags:int
{
...
enum EObjectDataResourceFlags:unsigned int
{
	None = 0x0,
	Inline = 0x1,
	Streaming = 0x2,
...
enum EHISMViewRelevanceType:unsigned char
{
	Grass = 0x0,
	Foliage = 0x1,
	HISM = 0x2
...
enum EHoudiniAssetState:unsigned char
{
...
enum EFoliageScaling:unsigned char
{
	Uniform = 0x0,
	Free = 0x1,
	LockXY = 0x2,
...
enum EPCGDifferenceMode:unsigned char
{
	Inferred = 0x0,
	Continuous = 0x1,
	Discrete = 0x2
...
enum ERigSwitchParentMode:unsigned char
{
	World = 0x0,
	DefaultParent = 0x1,
	ParentItem = 0x2
...
enum EPreferredTriangulationDirection:unsigned char
{
	None = 0x0,
	Tangential = 0x1,
	Radial = 0x2
...
enum EBlendSpacePerBoneBlendMode:unsigned char
{
...
enum EQuartzDelegateType:unsigned char
{
	MetronomeTick = 0x0,
	CommandEvent = 0x1,
	Count = 0x2
...
enum ESlateParentWindowSearchMethod:unsigned char
{
	ActiveWindow = 0x0,
	MainWindow = 0x1
};

enum EVertexColorMaskChannel:unsigned char
{
	Red = 0x0,
	Green = 0x1,
	Blue = 0x2,
...
enum EFoliageImplType:unsigned char
{
	Unknown = 0x0,
	StaticMesh = 0x1,
	Actor = 0x2,
...
enum EClippingFlags:unsigned char
{
	None = 0x0,
	AlwaysClip = 0x1
};

enum EClippingMethod:unsigned char
{
	Scissor = 0x0,
	Stencil = 0x1
};

enum ERayTracingGroupCullingPriority:unsigned char
{
	CP_0_NEVER_CULL = 0x0,
	CP_1 = 0x1,
	CP_2 = 0x2,
...
enum ESlateTickType:unsigned char
{
	Time = 0x1,
...
enum EFireEventsAtPosition:unsigned char
{
...
enum EFieldCommandHandlesType:unsigned char
{
	FilteredHandles = 0x0,
	InsideHandles = 0x1,
	NumHandles = 0x2
...
enum EFieldCommandOutputType:unsigned char
{
	LinearForce = 0x0,
	LinearVelocity = 0x1,
	AngularTorque = 0x2,
...
enum EFieldCommandResultType:unsigned char
{
	FinalResult = 0x0,
	TransientResult = 0x1,
	NumResults = 0x2
...
enum EPCGSplineSamplingMode:unsigned char
{
	Subdivision = 0x0,
	Distance = 0x1
};

enum EPCGSplineSamplingDimension:unsigned char
{
	OnSpline = 0x0,
	OnHorizontal = 0x1,
	OnVertical = 0x2,
...
enum EPCGSplineSamplingFill:unsigned char
{
	Fill = 0x0,
	EdgesOnly = 0x1
};

enum EPCGSplineSamplingInteriorOrientation:unsigned char
{
	Uniform = 0x0,
	FollowCurvature = 0x1
};

enum EConstraintsManagerNotifyType:int
{
	ConstraintAdded = 0x0,
...
enum EPCGTextureDensityFunction:unsigned char
{
	Ignore = 0x0,
	Multiply = 0x1
};

enum EPCGTextureColorChannel:unsigned char
{
	Red = 0x0,
	Green = 0x1,
	Blue = 0x2,
...
enum EGeometryCollectionCacheType:unsigned char
{
	None = 0x0,
	Record = 0x1,
	Play = 0x2,
...
enum EHoudiniInputType:unsigned char
{
	Invalid = 0x0,
	Geometry = 0x1,
	Curve = 0x2,
...
enum EHoudiniOutputType:unsigned char
{
	Invalid = 0x0,
	Mesh = 0x1,
	Instancer = 0x2,
...
enum EHoudiniStaticMeshMethod:unsigned char
{
	RawMesh = 0x0,
...
enum EPCGMeshSamplingMethod:int
{
...
enum EPrimaryAssetCookRule:unsigned char
{
	Unknown = 0x0,
	NeverCook = 0x1,
...
enum EPrimaryAssetProductionLevel:int
{
	Development = 0x0,
	Production = 0x1,
	Count = 0x2
...
enum ELODStreamingCallbackResult:int
{
	Success = 0x0,
	TimedOut = 0x1,
	AssetRemoved = 0x2,
...
enum ETextureSourceEncoding:unsigned char
{
	TSE_None = 0x0,
	TSE_Linear = 0x1,
	TSE_sRGB = 0x2,
...
enum EDLSSSettingOverride:unsigned char
{
	Enabled = 0x0,
	Disabled = 0x1,
...
enum EDLSSPreset:unsigned char
{
	Default = 0x0,
	A = 0x1,
	B = 0x2,
...
enum ENGXBinariesSearchOrder:int
{
	MinValue = 0x0,
...
enum ENGXProjectIdentifier:int
{
	MinValue = 0x0,
...
enum ETAAQuality:unsigned char
{
	Low = 0x0,
	Medium = 0x1,
	High = 0x2,
...
enum EMainTAAPassConfig:unsigned char
{
	Disabled = 0x0,
	TAA = 0x1,
	TSR = 0x2,
...
enum ENGXSupport:unsigned char
{
	Supported = 0x0,
	NotSupported = 0x1,
...
enum EDLSSSupport:unsigned char
{
	Supported = 0x0,
	NotSupported = 0x1,
	NotSupportedIncompatibleHardware = 0x2,
...
enum ESentryLevel:unsigned char
{
	Debug = 0x0,
	Info = 0x1,
	Warning = 0x2,
...
enum EMontagePlayReturnType:unsigned char
{
	MontageLength = 0x0,
	Duration = 0x1
};

enum _MM_EXP_ADJ_ENUM:int
{
	_MM_EXPADJ_NONE = 0x0,
	_MM_EXPADJ_4 = 0x1,
	_MM_EXPADJ_5 = 0x2,
...
enum EMaterialInstanceUsedByRTFlag:unsigned int
{
	None = 0x0,
	ResourceCreate = 0x1,
...
enum EChartAggregationMode:unsigned char
{
	TextureSize = 0x0,
	SurfaceArea = 0x1,
	PixelDensity = 0x2,
...
enum EOS_EPacketReliability:int
{
...
enum EOS_EConnectionClosedReason:int
{
	EOS_CCR_Unknown = 0x0,
...
enum EOS_PlayerDataStorage_EReadResult:int
{
...
enum EOS_PlayerDataStorage_EWriteResult:int
{
...
enum EOS_TitleStorage_EReadResult:int
{
...
enum EHairCardsFactoryFlags:unsigned int
{
	InvertedUV = 0x1,
	TextureRootUV = 0x2,
...
enum EPackageSegment:unsigned char
{
	Header = 0x0,
	Exports = 0x1,
	BulkDataDefault = 0x2,
...
enum EHairCardsSimulationType:int
{
	None = 0x0,
	Guide = 0x1,
	RBF = 0x2
...
enum EDeformationType:unsigned char
{
	Simulation = 0x0,
	RestGuide = 0x1,
	OffsetGuide = 0x2
...
enum EHairPatchAttribute:unsigned char
{
	None = 0x0,
	GuideInflucence = 0x1,
...
enum EHairAABBUpdateType:int
{
	UpdateClusterAABB = 0x0,
	UpdateGroupAABB = 0x1
};

enum EHairSimulationInterpolationMode:unsigned char
{
	Rigid = 0x0,
	Skinned = 0x1,
	RBF = 0x2
...
enum ESplineType:unsigned char
{
	BSpline = 0x0,
	Hermite = 0x1,
	Max = 0x2
...
enum EMoviePipelineValidationState:unsigned char
{
	Valid = 0x0,
	Warnings = 0x1,
	Errors = 0x2
...
enum EControlRigCurveAlignment:unsigned char
{
	Front = 0x0,
	Stretched = 0x1
};

enum EMovieRenderPipelineState:unsigned char
{
	Uninitialized = 0x0,
	ProducingFrames = 0x1,
	Finalize = 0x2,
...
enum EMovieRenderShotState:unsigned char
{
	Uninitialized = 0x0,
	WarmingUp = 0x1,
	MotionBlur = 0x2,
...
enum ETextEntryType:unsigned char
{
...
enum ERayTracingGeometryInitializerType:int
{
	Rendering = 0x0,
...
enum EPrimitiveTopologyType:unsigned char
{
	Triangle = 0x0,
	Patch = 0x1,
	Line = 0x2,
...
enum EMoviePipelineShutterTiming:unsigned char
{
	FrameOpen = 0x0,
	FrameCenter = 0x1,
	FrameClose = 0x2
...
enum ECustomTimeStepSynchronizationState:int
{
	Closed = 0x0,
	Error = 0x1,
	Synchronized = 0x2,
...
enum ENetLevelVisibilityRequest:int
{
	MakingVisible = 0x0,
	MakingInvisible = 0x1
};

enum ELevelStreamingState:unsigned char
{
	Removed = 0x0,
	Unloaded = 0x1,
	FailedToLoad = 0x2,
...
enum ELevelStreamingTargetState:unsigned char
{
	Unloaded = 0x0,
...
enum EImageCompressionQuality:unsigned char
{
	Default = 0x0,
	Uncompressed = 0x1
};
...
enum EMoviePipelineEncodeQuality:unsigned char
{
	Low = 0x0,
	Medium = 0x1,
	High = 0x2,
...
enum EAESGCMNetResult:unsigned char
{
	Unknown = 0x0,
	Success = 0x1,
	AESMissingIV = 0x2,
...
enum EOodleNetworkEnableMode:unsigned char
{
	AlwaysEnabled = 0x0,
	WhenCompressedPacketReceived = 0x1
};

enum EPlatformCryptoResult:int
{
	Success = 0x0,
	Failure = 0x1
};

enum EOodleNetResult:unsigned char
{
	Unknown = 0x0,
	Success = 0x1,
...
enum EOpenColorIOViewTransformDirection:unsigned char
{
	Forward = 0x0,
	Inverse = 0x1
};

enum ESubmixEffectDynamicsKeySource:unsigned char
{
	Default = 0x0,
	AudioBus = 0x1,
	Submix = 0x2,
...
enum ESubmixEffectDynamicsProcessorType:unsigned char
{
	Compressor = 0x0,
	Limiter = 0x1,
	Expander = 0x2,
...
enum ESubmixEffectDynamicsPeakMode:unsigned char
{
	MeanSquared = 0x0,
	RootMeanSquared = 0x1,
	Peak = 0x2,
...
enum ESubmixEffectDynamicsChannelLinkMode:unsigned char
{
	Disabled = 0x0,
	Average = 0x1,
	Peak = 0x2,
...
enum EOpenColorIOTransformAlpha:unsigned int
{
	None = 0x0,
	Unpremultiply = 0x1,
...
enum EObjectStateTypeEnum:unsigned char
{
	Chaos_NONE = 0x0,
...
enum EResolveClass:unsigned char
{
	No = 0x0,
	Yes = 0x1
};

enum EFractureEngineClusterSizeMethod:unsigned char
{
	ByNumber = 0x0,
...
enum EAudioMixerChannelType:unsigned char
{
	FrontLeft = 0x0,
	FrontRight = 0x1,
	FrontCenter = 0x2,
...
enum EAudioMixerStreamDataFormatType:unsigned char
{
	Unknown = 0x0,
	Float = 0x1,
	Int16 = 0x2,
...
enum ESwapAudioOutputDeviceResultState:unsigned char
{
	Failure = 0x0,
	Success = 0x1,
	None = 0x2
...
enum EMusicalNoteName:unsigned char
{
	C = 0x0,
	Db = 0x1,
	D = 0x2,
...
enum EAudioRecordingExportType:unsigned char
{
	SoundWave = 0x0,
	WavFile = 0x1
};

enum EFFTSize:unsigned char
{
	DefaultSize = 0x0,
	Min = 0x1,
	Small = 0x2,
...
enum EFFTPeakInterpolationMethod:unsigned char
{
	NearestNeighbor = 0x0,
	Linear = 0x1,
	Quadratic = 0x2,
...
enum EFFTWindowType:unsigned char
{
	None = 0x0,
	Hamming = 0x1,
	Hann = 0x2,
...
enum EAudioSpectrumType:unsigned char
{
...
enum EFontLayoutMethod:unsigned char
{
	Metrics = 0x0,
	BoundingBox = 0x1
};

enum EStructDeserializerBackendTokens:int
{
	ArrayEnd = 0x0,
	ArrayStart = 0x1,
	Comment = 0x2,
...
enum EStructDeserializerErrorPolicies:int
{
	Error = 0x0,
	Ignore = 0x1,
	Warning = 0x2
...
enum EStructDeserializerMapPolicies:int
{
	KeyValuePair = 0x0,
	Array = 0x1
};

enum EStructSerializerBackendFlags:int
{
	None = 0x0,
...
enum EStructSerializerStateFlags:int
{
	None = 0x0,
	WritingContainerElement = 0x1
};

enum EStructSerializerNullValuePolicies:int
{
	Ignore = 0x0,
	Serialize = 0x1
};

enum EStructSerializerReferenceLoopPolicies:int
{
	Error = 0x0,
	Ignore = 0x1,
	Serialize = 0x2
...
enum EStructSerializerMapPolicies:int
{
	KeyValuePair = 0x0,
	Array = 0x1
};

enum EConstructDynamicType:unsigned char
{
...
enum EPostProcessMaterialInput:unsigned int
{
	SceneColor = 0x0,
...
enum EQuartzTimeSignatureQuantization:unsigned char
{
	HalfNote = 0x0,
	QuarterNote = 0x1,
	EighthNote = 0x2,
...
enum EStaticMeshAsyncProperties:unsigned int
{
	None = 0x0,
	RenderData = 0x1,
	SourceModels = 0x4,
...
enum ELumenRayLightingMode:unsigned char
{
	SurfaceCache = 0x0,
	HitLighting = 0x2
};
...
enum EScreenPassDrawFlags:unsigned char
{
	None = 0x0,
	AllowHMDHiddenAreaMask = 0x2
};

enum ESafeZoneType:int
{
	eSZ_TOP = 0x0,
	eSZ_BOTTOM = 0x1,
	eSZ_LEFT = 0x2,
...
enum FCPXMLExportDataSource:unsigned char
{
	OutputMetadata = 0x0,
	SequenceData = 0x1
};

enum EMoviePipelineTextureStreamingMethod:unsigned char
{
	None = 0x0,
	Disabled = 0x1,
	FullyLoad = 0x2
...
enum EHotReloadedClassFlags:int
{
	None = 0x0,
	Changed = 0x1
};

enum EBusSendType:unsigned char
{
	PreEffect = 0x0,
	PostEffect = 0x1,
	Count = 0x2
...
enum EUsdInitialLoadSet:unsigned char
{
	LoadAll = 0x0,
	LoadNone = 0x1
};

enum EUsdInterpolationType:unsigned char
{
	Held = 0x0,
	Linear = 0x1
};

enum EVRSImageDataType:unsigned char
{
...
enum EGroomBindingMeshType:unsigned char
{
	SkeletalMesh = 0x0,
	GeometryCache = 0x1
};

enum ERHITransientResourceType:unsigned char
{
	Texture = 0x0,
	Buffer = 0x1
};

enum EPCGComponentInput:unsigned char
{
	Actor = 0x0,
	Landscape = 0x1,
	Other = 0x2,
...
enum EPCGComponentGenerationTrigger:unsigned char
{
	GenerateOnLoad = 0x0,
	GenerateOnDemand = 0x1
};

enum EActiveReloadType:int
{
	None = 0x0,
	Reinstancing = 0x1
};

enum EPCGComponentDirtyFlag:unsigned char
{
	None = 0x0,
	Actor = 0x1,
	Landscape = 0x2,
...
enum EPCGGraphParameterEvent:int
{
	GraphChanged = 0x0,
	GraphPostLoad = 0x1,
	Added = 0x2,
...
enum EPCGWorldQueryFilterByTag:int
{
	NoTagFilter = 0x0,
	IncludeTagged = 0x1,
	ExcludeTagged = 0x2
...
enum EHairInterpolationType:int
{
	NoneSkinning = 0x0,
	RigidSkinning = 0x1,
	OffsetSkinning = 0x2,
...
enum EPCGMedadataBitwiseOperation:unsigned short
{
	And = 0x0,
	Not = 0x1,
	Or = 0x2,
...
enum EHairLODSelectionType:int
{
	Immediate = 0x0,
	Predicted = 0x1,
	Forced = 0x2
...
enum EPCGMedadataBooleanOperation:unsigned short
{
	And = 0x0,
	Not = 0x1,
	Or = 0x2,
...
enum ESlateDebuggingStateChangeEvent:unsigned char
{
	MouseCaptureGained = 0x0,
	MouseCaptureLost = 0x1
};

enum EInputDeviceTriggerMask:unsigned char
{
	None = 0x0,
	Left = 0x1,
	Right = 0x2,
...
enum EPCGMedadataCompareOperation:unsigned short
{
	Equal = 0x0,
	NotEqual = 0x1,
	Greater = 0x2,
...
enum ETransactionObjectEventType:unsigned char
{
	UndoRedo = 0x0,
	Finalized = 0x1,
	Snapshot = 0x2
...
enum ETransactionObjectChangeCreatedBy:unsigned char
{
	TransactionRecord = 0x0,
	TransactionAnnotation = 0x1
};

enum ESetParamResult:unsigned char
{
	Succeeded = 0x0,
	Failed = 0x1
};

enum EControlRigFKRigExecuteMode:unsigned char
{
	Replace = 0x0,
	Additive = 0x1,
	Direct = 0x2,
...
enum EPCGMetadataMakeVector3:unsigned char
{
	ThreeValues = 0x0,
	Vector2AndValue = 0x1
};

enum EPCGMetadataMakeVector4:unsigned char
{
	FourValues = 0x0,
...
enum EPCGMedadataMathsOperation:unsigned short
{
	UnaryOp = 0x400,
	Sign = 0x401,
	Frac = 0x402,
...
enum EPCGMetadataSettingsBaseMode:int
{
	Inferred = 0x0,
	NoBroadcast = 0x1,
	Broadcast = 0x2
...
enum EPCGMetadataSettingsBaseTypes:int
{
	AutoUpcastTypes = 0x0,
	StrictTypes = 0x1
};

enum EMetasoundFrontendVertexAccessType:int
{
	Reference = 0x0,
	Value = 0x1,
	Unset = 0x2
...
enum EMetasoundFrontendClassType:unsigned char
{
	External = 0x0,
	Graph = 0x1,
	Input = 0x2,
...
enum EPCGMedadataRotatorOperation:unsigned short
{
	RotatorOp = 0x0,
	Combine = 0x1,
	Invert = 0x2,
...
enum EPCGMedadataTransformOperation:unsigned short
{
	Compose = 0x0,
	Invert = 0x1,
	Lerp = 0x2
...
enum EPCGTransformLerpMode:unsigned short
{
	QuatInterp = 0x0,
	EulerInterp = 0x1,
	DualQuatInterp = 0x2
...
enum EPCGMedadataTrigOperation:unsigned short
{
	Acos = 0x0,
	Asin = 0x1,
	Atan = 0x2,
...
enum EPCGMedadataVectorOperation:unsigned short
{
	VectorOp = 0x0,
	Cross = 0x1,
	Dot = 0x2,
...
enum ETransactionStateEventType:unsigned char
{
...
enum EPCGActorSelection:unsigned char
{
	ByTag = 0x0,
	ByName = 0x1,
	ByClass = 0x2
...
enum EPCGActorFilter:unsigned char
{
	Self = 0x0,
	Parent = 0x1,
	Root = 0x2,
...
enum EPCGAttributeFilterOperation:int
{
	KeepSelectedAttributes = 0x0,
	DeleteSelectedAttributes = 0x1
};

enum EPCGAttributeReduceOperation:int
{
	Average = 0x0,
	Max = 0x1,
	Min = 0x2
...
enum EPCGAttributeSelectOperation:int
{
	Min = 0x0,
	Max = 0x1,
	Median = 0x2
...
enum EPCGAttributeSelectAxis:int
{
	X = 0x0,
	Y = 0x1,
	Z = 0x2,
...
enum EPCGBoundsModifierMode:unsigned char
{
	Set = 0x0,
	Intersect = 0x1,
	Include = 0x2,
...
enum EPCGCopyPointsInheritanceMode:unsigned char
{
	Relative = 0x0,
	Source = 0x1,
	Target = 0x2
...
enum EPCGCopyPointsMetadataInheritanceMode:unsigned char
{
	SourceFirst = 0x0,
	TargetFirst = 0x1,
	SourceOnly = 0x2,
...
enum EPCGCreateSplineMode:unsigned char
{
	CreateDataOnly = 0x0,
	CreateComponent = 0x1,
	CreateNewActor = 0x2
...
enum EPCGGetDataFromActorMode:unsigned char
{
...
enum EPerQualityLevels:unsigned char
{
	Low = 0x0,
	Medium = 0x1,
	High = 0x2,
...
enum EAccessibleType:unsigned char
{
	Main = 0x0,
	Summary = 0x1
};

enum EPCGDensityNoiseMode:unsigned char
{
	Set = 0x0,
	Minimum = 0x1,
	Maximum = 0x2,
...
enum ECompiledPartialDerivativeVariation:int
{
...
enum EPCGSettingsType:unsigned char
{
	InputOutput = 0x0,
	Spatial = 0x1,
	Density = 0x2,
...
enum EOutputDeviceRedirectorFlushOptions:unsigned int
{
	None = 0x0,
	Async = 0x1
};

enum EPCGFilterByTagOperation:int
{
	KeepTagged = 0x0,
	RemoveTagged = 0x1
};

enum EPCGPointExtentsModifierMode:unsigned char
{
	Set = 0x0,
	Minimum = 0x1,
	Maximum = 0x2,
...
enum EPCGPointFilterOperator:unsigned char
{
	Greater = 0x0,
	GreaterOrEqual = 0x1,
	Lesser = 0x2,
...
enum EPCGPointTargetFilterType:unsigned char
{
	Property = 0x0,
	Metadata = 0x1
};

enum EPCGPointThresholdType:unsigned char
{
	Property = 0x0,
	Metadata = 0x1,
	Constant = 0x2
...
enum EPCGPointFilterConstantType:unsigned char
{
	Integer64 = 0x0,
	Float = 0x1,
	Vector = 0x2,
...
enum EDebugSerializationFlags:int
{
	DSF_None = 0x0,
	DSF_IgnoreDiff = 0x1,
...
enum EManagedArrayType:unsigned char
{
	FNoneType = 0x0,
	FVectorType = 0x1,
	FIntVectorType = 0x2,
...
enum EPCGSelfPruningType:unsigned char
{
	LargeToSmall = 0x0,
	SmallToLarge = 0x1,
	AllEqual = 0x2,
...
enum EPropertyBagContainerType:unsigned char
{
	None = 0x0,
	Array = 0x1
};

enum EPropertyBagPropertyType:unsigned char
{
	None = 0x0,
	Bool = 0x1,
	Byte = 0x2,
...
enum EPropertyBagResult:unsigned char
{
	Success = 0x0,
	TypeMismatch = 0x1,
	OutOfBounds = 0x2,
...
enum EPCGSpawnActorOption:unsigned char
{
	CollapseActors = 0x0,
	MergePCGOnly = 0x1,
	NoMerging = 0x2
...
enum EPCGSpawnActorGenerationTrigger:unsigned char
{
	Default = 0x0,
	ForceGenerate = 0x1,
...
enum EPowerSavingEligibility:unsigned char
{
	Unknown = 0x0,
	Eligible = 0x1,
	NotEligible = 0x2
...
enum EMetasoundFrontendNodeStyleDisplayVisibility:unsigned char
{
	Visible = 0x0,
	Hidden = 0x1
};

enum ESlateTraceApplicationFlags:unsigned char
{
	None = 0x0,
...
enum EConstraintInterpType:unsigned char
{
	Average = 0x0,
	Shortest = 0x1,
	Max = 0x2
...
enum EHLODBatchingPolicy:unsigned char
{
	None = 0x0,
	MeshSection = 0x1,
	Instancing = 0x2
...
enum EControlRigModifyBoneMode:unsigned char
{
	OverrideLocal = 0x0,
	OverrideGlobal = 0x1,
	AdditiveLocal = 0x2,
...
enum ELocalFrameMode:int
{
	FromObject = 0x0,
	FromGeometry = 0x1
};

enum EInputDevices:int
{
	None = 0x0,
	Keyboard = 0x1,
	Mouse = 0x2,
...
enum EInputCaptureRequestType:int
{
	Begin = 0x1,
	Ignore = 0x2
};

enum EInputCaptureState:int
{
	Begin = 0x1,
	Continue = 0x2,
	End = 0x3,
...
enum ERigVMSimPointIntegrateType:unsigned char
{
	Verlet = 0x0,
	SemiExplicitEuler = 0x1
};

enum ETypedElementChildInclusionMethod:unsigned char
{
	None = 0x0,
	Immediate = 0x1,
	Recursive = 0x2
...
enum ETypedElementSelectionMethod:unsigned char
{
	Primary = 0x0,
	Secondary = 0x1
};

enum EToolContextTransformGizmoMode:unsigned char
{
	NoGizmo = 0x0,
	Translation = 0x1,
	Rotation = 0x2,
...
enum EToolChangeTrackingMode:int
{
...
enum ESetMeshMaterialMode:unsigned char
{
	Original = 0x0,
	Checkerboard = 0x1,
	Override = 0x2
...
enum EMeshEditingMaterialModes:int
{
...
enum ECreateModelingObjectResult:unsigned char
{
	Ok = 0x0,
	Cancelled = 0x1,
	Failed_Unknown = 0x2,
...
enum ECreateMeshObjectSourceMeshType:unsigned char
{
	MeshDescription = 0x0,
	DynamicMesh = 0x1
};
...
enum EMakeMeshPolygroupMode:unsigned char
{
	PerShape = 0x0,
	PerFace = 0x1,
	PerQuad = 0x2
...
enum EMakeMeshPlacementType:unsigned char
{
	GroundPlane = 0x0,
	OnScene = 0x1
};

enum EMakeMeshPivotLocation:unsigned char
{
	Base = 0x0,
	Centered = 0x1,
	Top = 0x2
...
enum EProceduralRectType:int
{
	Rectangle = 0x0,
	RoundedRectangle = 0x1
};

enum EProceduralDiscType:int
{
	Disc = 0x0,
	PuncturedDisc = 0x1
};

enum EProceduralSphereType:int
{
	LatLong = 0x0,
	Box = 0x1
};

enum EProceduralStairsType:int
{
	Linear = 0x0,
	Floating = 0x1,
	Curved = 0x2,
...
enum ESQLitePreparedStatementFlags:unsigned char
{
	None = 0x0,
	Persistent = 0x1
};

enum ESQLiteDatabaseOpenMode:unsigned char
{
	ReadOnly = 0x0,
	ReadWrite = 0x1,
	ReadWriteCreate = 0x2
...
enum ESQLitePreparedStatementStepResult:unsigned char
{
	Error = 0x0,
	Busy = 0x1,
	Row = 0x2,
...
enum ESQLiteColumnType:unsigned char
{
	Integer = 0x0,
	Float = 0x1,
	String = 0x2,
...
enum ESQLitePreparedStatementExecuteRowResult:unsigned char
{
	Continue = 0x0,
	Stop = 0x1,
	Error = 0x2
...
enum ESceneSnapQueryType:unsigned char
{
	Position = 0x1,
	Rotation = 0x2
};

enum EShouldCookBlueprintPropertyGuids:int
{
	No = 0x0,
	Yes = 0x1,
	Inherit = 0x2
...
enum EBakeTextureBitDepth:int
{
	ChannelBits8 = 0x0,
	ChannelBits16 = 0x1
};

enum EWindowTitleBarMode:unsigned char
{
	Overlay = 0x0,
	VerticalBox = 0x1
};

enum EHandleSourcesMethod:unsigned char
{
	DeleteSources = 0x0,
	HideSources = 0x1,
	KeepSources = 0x2,
...
enum EBaseCreateFromSelectedTargetType:int
{
	NewObject = 0x0,
...
enum EMeshSelectionElementType:int
{
	Vertex = 0x0,
	Face = 0x1,
	Edge = 0x2,
...
enum ECSGOperation:unsigned char
{
	DifferenceAB = 0x0,
	DifferenceBA = 0x1,
	Intersect = 0x2,
...
enum ETrimOperation:unsigned char
{
	TrimA = 0x0,
	TrimB = 0x1
};

enum ETrimSide:unsigned char
{
	RemoveInside = 0x0,
	RemoveOutside = 0x1
};

enum ERevolvePropertiesPolygroupMode:unsigned char
{
	PerShape = 0x0,
	PerFace = 0x1,
	PerRevolveStep = 0x2,
...
enum ERevolvePropertiesQuadSplit:unsigned char
{
	Uniform = 0x0,
	Compact = 0x1
};

enum ERevolvePropertiesCapFillMode:unsigned char
{
	None = 0x0,
	CenterFan = 0x1,
	Delaunay = 0x2,
...
enum EUVLayoutPreviewSide:int
{
	Left = 0x0,
	Right = 0x1
};

enum ECollectSurfacePathDoneMode:int
{
	SnapCloseLoop = 0x0,
	SnapDoubleClick = 0x1,
...
enum EModelingComponentsPlaneVisualizationMode:unsigned char
{
	SimpleGrid = 0x0,
...
enum EDrawPolygonDrawMode:unsigned char
{
	Freehand = 0x0,
	Circle = 0x1,
	Square = 0x2,
...
enum EDrawPolygonExtrudeMode:unsigned char
{
	Flat = 0x0,
	Fixed = 0x1,
	Interactive = 0x2
...
enum EToolActivityStartResult:int
{
	Running = 0x0,
	FailedStart = 0x1
};

enum EToolActivityEndResult:int
{
	Completed = 0x0,
	Cancelled = 0x1,
	ErrorDuringEnd = 0x2
...
enum EEditMeshPolygonsToolActions:int
{
	NoAction = 0x0,
	AcceptCurrent = 0x1,
	CancelCurrent = 0x2,
...
enum EEditMeshPolygonsToolSelectionMode:int
{
	Faces = 0x0,
	Edges = 0x1,
	Vertices = 0x2,
...
enum EPCGMeshSelectorMaterialOverrideMode:unsigned char
{
	NoOverride = 0x0,
	StaticOverride = 0x1,
...
enum EPolyEditOffsetModeOptions:int
{
	VertexNormals = 0x2,
...
enum EPolyEditExtrudeDistanceMode:int
{
	ClickInViewport = 0x0,
	Fixed = 0x1
};

enum EPolyEditExtrudeDirection:int
{
	SelectionNormal = 0x0,
	WorldX = 0x1,
	WorldY = 0x2,
...
enum EPolyEditExtrudeModeOptions:int
{
	SingleDirection = 0x3,
	SelectedTriangleNormals = 0x0,
	SelectedTriangleNormalsEven = 0x1
...
enum EPolyEditPushPullModeOptions:int
{
	SelectedTriangleNormals = 0x0,
	SelectedTriangleNormalsEven = 0x1,
	SingleDirection = 0x3,
...
enum EGroupEdgeInsertionMode:int
{
	Retriangulate = 0x0,
	PlaneCut = 0x1
};

enum EAttribStorageType:signed char
{
	Invalid = 0xFF,
	INT = 0x0,
	INT64 = 0x1,
...
enum EEdgeLoopPositioningMode:int
{
	Even = 0x0,
...
enum EEdgeLoopInsertionMode:int
{
	Retriangulate = 0x0,
	PlaneCut = 0x1
};

enum EHoudiniGeoType:unsigned char
{
	Invalid = 0x0,
	Default = 0x1,
	Intermediate = 0x2,
...
enum EHoudiniPartType:unsigned char
{
	Invalid = 0x0,
	Mesh = 0x1,
	Instancer = 0x2,
...
enum EHoudiniInstancerType:unsigned char
{
	Invalid = 0x0,
	ObjectInstancer = 0x1,
	PackedPrimitive = 0x2,
...
enum EPolyEditCutPlaneOrientation:int
{
	FaceNormals = 0x0,
	ViewDirection = 0x1
};

enum EHoudiniHandleType:unsigned char
{
	Xform = 0x0,
	Bounder = 0x1,
	Unsupported = 0x2
...
enum EXformParameter:unsigned char
{
	TX = 0x0,
	TY = 0x1,
	TZ = 0x2,
...
enum EHoudiniCurveType:signed char
{
	Invalid = 0xFF,
	Polygon = 0x0,
	Nurbs = 0x1,
...
enum EHoudiniCurveMethod:signed char
{
	Invalid = 0xFF,
	CVs = 0x0,
	Breakpoints = 0x1,
...
enum EHoudiniCurveBreakpointParameterization:signed char
{
	Invalid = 0xFF,
	Uniform = 0x0,
	Chord = 0x1,
...
enum EHoudiniLandscapeExportType:unsigned char
{
	Heightfield = 0x0,
	Mesh = 0x1,
	Points = 0x2
...
enum EUnrealObjectInputNodeType:unsigned char
{
	Invalid = 0x0,
	Container = 0x1,
	Reference = 0x2,
...
enum EHoudiniInputObjectType:unsigned char
{
	Invalid = 0x0,
	Object = 0x1,
	StaticMesh = 0x2,
...
enum EHoudiniXformType:unsigned char
{
	None = 0x0,
	IntoThisObject = 0x1,
	Auto = 0x2
...
enum EOS_UI_EKeyCombination:unsigned __int64
{
...
enum EOS_EAntiCheatClientMode:int
{
...
enum EOS_EAntiCheatCommonClientType:int
{
...
enum EOS_EAntiCheatCommonClientPlatform:int
{
...
enum EEOSApiVersion:unsigned char
{
	v2022_10_28 = 0x0,
	v2022_05_20 = 0x1,
	v2022_02_11 = 0x2
...
enum EPresenceAdvertisementType:unsigned char
{
	None = 0x0,
	Party = 0x1,
	Session = 0x2
...
enum EPartyJoinabilityConstraint:unsigned char
{
	AllowPlayersInMultipleParties = 0x0,
	IgnoreInvitesIfAlreadyInParty = 0x1
};

enum EDedicatedServersDistributionMode:unsigned char
{
	DevelopersOnly = 0x0,
...
enum ENetworkAuthenticationMode:unsigned char
{
	Default = 0x0,
	IDToken = 0x1,
	Off = 0x2
...
enum ESlateAccessibleBehavior:unsigned char
{
	NotAccessible = 0x0,
	Auto = 0x1,
	Summary = 0x2,
...
enum ESlateVisibility:unsigned char
{
	Visible = 0x0,
	Collapsed = 0x1,
	Hidden = 0x2,
...
enum EWidgetAnimationEvent:unsigned char
{
	Started = 0x0,
	Finished = 0x1
};

enum EWidgetTickFrequency:unsigned char
{
	Never = 0x0,
	Auto = 0x1
};

enum EReplayResult:unsigned int
{
	Success = 0x0,
	ReplayNotFound = 0x1,
	Corrupt = 0x2,
...
enum EEOSUserInterface_SignInOrCreateAccount_Choice:unsigned char
{
	SignIn = 0x0,
	CreateAccount = 0x1
};

enum EUVProjectionMethod:unsigned char
{
	Box = 0x0,
	Cylinder = 0x1,
	Plane = 0x2,
...
enum EUVProjectionToolActions:int
{
	NoAction = 0x0,
	AutoFit = 0x1,
	AutoFitAlign = 0x2,
...
enum EEOSUserInterface_SwitchToCrossPlatformAccount_Choice:unsigned char
{
...
enum EUVProjectionToolInitializationMode:int
{
	Default = 0x0,
	UsePrevious = 0x1,
	AutoFit = 0x2,
...
enum EOS_EExternalCredentialType:int
{
	EOS_ECT_EPIC = 0x0,
...
enum EBakeNormalSpace:int
{
	Tangent = 0x0,
	Object = 0x1
};

enum EBakeCurvatureTypeMode:int
{
	MeanAverage = 0x0,
	Max = 0x1,
	Min = 0x2,
...
enum EBakeCurvatureColorMode:int
{
	Grayscale = 0x0,
	RedBlue = 0x1,
	RedGreenBlue = 0x2
...
enum EBakeCurvatureClampMode:int
{
	None = 0x0,
	OnlyPositive = 0x1,
	OnlyNegative = 0x2
...
enum EExtrudeMeshSelectionInteractionMode:unsigned char
{
	Interactive = 0x0,
	Fixed = 0x1
};

enum EExtrudeMeshSelectionRegionModifierMode:unsigned char
{
	OriginalShape = 0x0,
	FlattenToPlane = 0x1,
	RaycastToPlane = 0x2
...
enum ESculptBrushOpTargetType:unsigned char
{
	SculptMesh = 0x0,
	TargetMesh = 0x1,
	ActivePlane = 0x2
...
enum EBrushToolSizeType:unsigned char
{
	Adaptive = 0x0,
	World = 0x1
};

enum EMeshSculptFalloffType:unsigned char
{
	Smooth = 0x0,
	Linear = 0x1,
	Inverse = 0x2,
...
enum EPatternToolShape:unsigned char
{
	Line = 0x0,
	Grid = 0x1,
	Circle = 0x2
...
enum EPatternToolSingleAxis:unsigned char
{
	XAxis = 0x0,
	YAxis = 0x1,
	ZAxis = 0x2
...
enum EPatternToolSinglePlane:unsigned char
{
	XYPlane = 0x0,
	XZPlane = 0x1,
	YZPlane = 0x2
...
enum EPatternToolAxisSpacingMode:unsigned char
{
	ByCount = 0x0,
	StepSize = 0x1,
	Packed = 0x2
...
enum EMeshBoundaryConstraint:unsigned char
{
	Fixed = 0x7,
	Refine = 0x5,
	Free = 0x1
...
enum EGroupBoundaryConstraint:unsigned char
{
	Fixed = 0x7,
	Refine = 0x5,
	Free = 0x1,
...
enum EMaterialBoundaryConstraint:unsigned char
{
	Fixed = 0x7,
	Refine = 0x5,
	Free = 0x1,
...
enum EAlignObjectsAlignTypes:int
{
	Pivots = 0x0,
	BoundingBoxes = 0x1
};

enum EAlignObjectsAlignToOptions:int
{
	FirstSelected = 0x0,
	LastSelected = 0x1,
	Combined = 0x2
...
enum EAlignObjectsBoxPoint:int
{
	Center = 0x0,
	Bottom = 0x1,
	Top = 0x2,
...
enum EPlaneBrushSideMode:unsigned char
{
	BothSides = 0x0,
	PushDown = 0x1,
	PullTowards = 0x2
...
enum EUsdActiveAllocator:int
{
	Unreal = 0x0,
	System = 0x1
};

enum EUsdSaveDialogBehavior:unsigned char
{
	NeverSave = 0x0,
	AlwaysSave = 0x1,
	ShowPrompt = 0x2
...
enum ECameraFocusMethod:unsigned char
{
	DoNotOverride = 0x0,
	Manual = 0x1,
	Tracking = 0x2,
...
enum EBakeVertexOutput:int
{
	RGBA = 0x0,
	PerChannel = 0x1
};

enum EBakeVertexChannel:int
{
	R = 0x0,
	G = 0x1,
	B = 0x2,
...
enum EOffsetMeshSelectionDirectionMode:unsigned char
{
	VertexNormals = 0x0,
	FaceNormals = 0x1,
	ConstantWidth = 0x2
...
enum EOffsetMeshSelectionInteractionMode:unsigned char
{
	Fixed = 0x0
};

enum EMobileHDRMode:int
{
	Unset = 0x0,
	Disabled = 0x1,
	EnabledFloat16 = 0x2
...
enum ESoundWaveFFTSize:unsigned char
{
	VerySmall_64 = 0x0,
	Small_256 = 0x1,
	Medium_512 = 0x2,
...
enum UDLSSSupport:unsigned char
{
	Supported = 0x0,
	NotSupported = 0x1,
	NotSupportedIncompatibleHardware = 0x2,
...
enum EUpscaleMethod:unsigned char
{
	Nearest = 0x0,
	Bilinear = 0x1,
	Directional = 0x2,
...
enum EDebugCameraStyle:unsigned char
{
	None = 0x0,
	Fixed = 0x1,
	ThirdPerson = 0x2,
...
enum ECameraAutoFollowMode:unsigned char
{
	None = 0x0,
	LazyFollow = 0x1,
	FullFollow = 0x2
...
enum ESteelShieldEnvironment:unsigned char
{
	Production = 0x0,
	Development = 0x1
};
...
enum EWarpingDirectionSource:int
{
	Goals = 0x0,
	Chain = 0x1
};

enum EJWTCertificateType:unsigned char
{
	HS256 = 0x0,
	HS384 = 0x1,
	HS512 = 0x2,
...
enum EIKRigGoalSpace:unsigned char
{
	Component = 0x0,
	Additive = 0x1,
	World = 0x2
...
enum EIKRigGoalTransformSource:unsigned char
{
	Manual = 0x0,
	Bone = 0x1,
	ActorComponent = 0x2
...
enum ERetargetRotationMode:unsigned char
{
	Interpolated = 0x0,
	OneToOne = 0x1,
...
enum ERetargetTranslationMode:unsigned char
{
	None = 0x0,
	GloballyScaled = 0x1,
	Absolute = 0x2
...
enum EArchiveValueType:int
{
	...
	LazyObjectPtr = 0x17,
	RawData = 0x18,
	AttributedValue = 0x19,
	Attribute = 0x1A
};

enum ERetargetSourceOrTarget:unsigned char
{
	Source = 0x0,
	Target = 0x1
};
...
enum ELiveLinkSourceMode:unsigned char
{
	Latest = 0x0,
	EngineTime = 0x1,
	Timecode = 0x2
...
enum EPBIKRootBehavior:unsigned char
{
	PrePull = 0x0,
	PinToInput = 0x1,
	Free = 0x2
...
enum ETimedDataInputEvaluationType:unsigned char
{
	None = 0x0,
	Timecode = 0x1,
	PlatformTime = 0x2
...
enum ETimedDataInputState:unsigned char
{
	Connected = 0x0,
	Unresponsive = 0x1,
	Disconnected = 0x2
...
enum EPBIKLimitType:unsigned char
{
	Free = 0x0,
	Limited = 0x1,
	Locked = 0x2
...
enum EDeferredParamStrictness:int
{
	ELoose = 0x0,
	EStrict = 0x1
};

enum EDatasmithImportLightmapMin:unsigned char
{
	LIGHTMAP_16 = 0x0,
	LIGHTMAP_32 = 0x1,
	LIGHTMAP_64 = 0x2,
...
enum EDatasmithImportLightmapMax:unsigned char
{
	LIGHTMAP_64 = 0x0,
	LIGHTMAP_128 = 0x1,
	LIGHTMAP_256 = 0x2,
...
enum EDatasmithImportScene:unsigned char
{
	NewLevel = 0x0,
	CurrentLevel = 0x1,
	AssetsOnly = 0x2
...
enum EDatasmithCADStitchingTechnique:unsigned char
{
	StitchingNone = 0x0,
	StitchingHeal = 0x1,
	StitchingSew = 0x2
...
enum EDatasmithCADRetessellationRule:unsigned char
{
	All = 0x0,
	SkipDeletedSurfaces = 0x1
};

enum EDatasmithImportSearchPackagePolicy:unsigned char
{
	Current = 0x0,
	All = 0x1
};

enum EDatasmithImportAssetConflictPolicy:unsigned char
{
	Replace = 0x0,
	Update = 0x1,
	Use = 0x2,
...
enum EDatasmithImportActorPolicy:unsigned char
{
	Update = 0x0,
	Full = 0x1,
	Ignore = 0x2
...
enum EDatasmithImportMaterialQuality:unsigned char
{
...
enum EDatasmithAreaLightActorType:unsigned char
{
	Point = 0x0,
	Spot = 0x1,
	Rect = 0x2
...
enum EDatasmithAreaLightActorShape:unsigned char
{
	Rectangle = 0x0,
	Disc = 0x1,
	Sphere = 0x2,
...
enum EColorBlockAlphaDisplayMode:unsigned char
{
	Combined = 0x0,
	Separate = 0x1,
	Ignore = 0x2
...
enum EHoudiniLandscapeOutputBakeType:unsigned char
{
	Detachment = 0x0,
	BakeToImage = 0x1,
	BakeToWorld = 0x2,
...
enum EHoudiniCurveOutputType:unsigned char
{
	UnrealSpline = 0x0,
	HoudiniSpline = 0x1
};
...
enum ECommonFrameRate:unsigned char
{
	FPS_12 = 0x0,
	FPS_15 = 0x1,
	FPS_24 = 0x2,
...
enum EHoudiniProxyRefineResult:unsigned char
{
	Invalid = 0x0,
	Failed = 0x1,
	Success = 0x2,
...
enum EHoudiniProxyRefineRequestResult:unsigned char
{
	Invalid = 0x0,
	None = 0x1,
	PendingCooks = 0x2,
...
enum ECrashTrigger:int
{
	Debug = 0xFF,
	Normal = 0x0
};

enum ETimecodeProviderSynchronizationState:int
{
	Closed = 0x0,
	Error = 0x1,
	Synchronized = 0x2,
...
enum ELiveLinkTimecodeProviderEvaluationType:int
{
	Lerp = 0x0,
	Nearest = 0x1,
	Latest = 0x2
...
enum ELiveLinkAxis:unsigned char
{
	X = 0x0,
	Y = 0x1,
	Z = 0x2,
...
enum EConvexOverlapRemoval:int
{
	None = 0x0,
	All = 0x1,
	OnlyClusters = 0x2,
...
enum EProximityMethod:int
{
	Precise = 0x0,
	ConvexHull = 0x1
};

enum EProximityContactMethod:unsigned char
{
	MinOverlapInProjectionToMajorAxes = 0x0
};

enum EDataflowFieldFalloffType:unsigned char
{
...
enum EDataflowSetMaskConditionType:unsigned char
{
...
enum EOS_EOnlineSessionPermissionLevel:int
{
...
enum EOS_ESessionAttributeAdvertisementType:int
{
	EOS_SAAT_DontAdvertise = 0x0,
	EOS_SAAT_Advertise = 0x1
};

enum EDataflowWaveFunctionType:unsigned char
{
...
enum EDataflowFloatFieldOperationType:unsigned char
{
...
enum EDataflowVectorFieldOperationType:unsigned char
{
...
enum ESetMaterialOperationTypeEnum:unsigned char
{
...
enum EStreamlineSettingOverride:unsigned char
{
	Enabled = 0x0,
	Disabled = 0x1,
	UseProjectSettings = 0x2
...
enum EClusterSizeMethodEnum:unsigned char
{
...
enum EVisibiltyOptionsEnum:unsigned char
{
...
enum EModulationDestination:unsigned char
{
	Volume = 0x0,
	Pitch = 0x1,
	Lowpass = 0x2,
...
enum EAudioBusChannels:unsigned char
{
	Mono = 0x0,
	Stereo = 0x1,
	Quad = 0x3,
...
enum ESourceBusChannels:unsigned char
{
	Mono = 0x0,
	Stereo = 0x1
};

enum EMeshBooleanOperationEnum:unsigned char
{
...
enum EMakeBoxDataTypeEnum:unsigned char
{
...
enum EFloatToIntFunctionEnum:unsigned char
{
...
enum EFloatArrayToIntArrayFunctionEnum:unsigned char
{
	Dataflow_FloatToInt_Function_Floor = 0x0,
	Dataflow_FloatToInt_Function_Ceil = 0x1,
	Dataflow_FloatToInt_Function_Round = 0x2,
...
enum EMathConstantsEnum:unsigned char
{
...
enum ERotationOrderEnum:unsigned char
{
...
enum ECompareOperationEnum:unsigned char
{
...
enum EAnchorStateEnum:unsigned char
{
...
enum EStandardGroupNameEnum:unsigned char
{
...
enum ECustomAttributeTypeEnum:unsigned char
{
...
enum EStreamlineSupport:unsigned char
{
	Supported = 0x0,
	NotSupported = 0x1,
...
enum EStreamlineFeatureSupport:int
{
	Supported = 0x0,
	NotSupported = 0x1,
	NotSupportedIncompatibleHardware = 0x2,
...
enum ENISHalfPrecisionPermutation:int
{
	Float32 = 0x0,
	Min16Float = 0x1,
	Min16FloatDXC = 0x2,
...
enum NISGPUArchitecture:unsigned int
{
	NVIDIA_Generic = 0x0,
	AMD_Generic = 0x1,
	Intel_Generic = 0x2,
...
enum ESetOperationEnum:unsigned char
{
...
enum ERangeSettingEnum:unsigned char
{
...
enum ESelectSubjectTypeEnum:unsigned char
{
...
enum ENDIExport_GPUAllocationMode:unsigned char
{
	FixedSize = 0x0,
	PerParticle = 0x1
};

enum EHairInstanceCount:unsigned char
{
...
enum EHairViewRayTracingMask:int
{
	RayTracing = 0x1,
	PathTracing = 0x2
};
...
enum EInputActionValueType:unsigned char
{
	Boolean = 0x0,
	Axis1D = 0x1,
	Axis2D = 0x2,
...
enum EMappingQueryIssue:unsigned char
{
	NoIssue = 0x0,
...
enum EAnalyticsBuildType:unsigned char
{
	Development = 0x0,
	Test = 0x1,
	Debug = 0x2,
...
enum EMappingQueryResult:unsigned char
{
...
enum ETriggerState:unsigned char
{
	None = 0x0,
	Ongoing = 0x1,
	Triggered = 0x2
...
enum ETriggerEvent:unsigned char
{
	None = 0x0,
	Triggered = 0x1,
	Started = 0x2,
...
enum EDeadZoneType:unsigned char
{
	Axial = 0x0,
	Radial = 0x1
};

enum EFOVScalingType:unsigned char
{
	Standard = 0x0,
	UE4_BackCompat = 0x1
};

enum EInputAxisSwizzle:unsigned char
{
	YXZ = 0x0,
	ZYX = 0x1,
	XZY = 0x2,
...
enum ETriggerType:unsigned char
{
	Explicit = 0x0,
	Implicit = 0x1,
	Blocker = 0x2
...
enum EPlayerMappableKeySettingBehaviors:unsigned char
{
...
enum EGroomBasisType:unsigned char
{
	NoBasis = 0x0,
	BezierBasis = 0x1,
	BsplineBasis = 0x2,
...
enum EGroomCurveType:unsigned char
{
	Cubic = 0x0,
	Linear = 0x1,
	VariableOrder = 0x2
...
enum EInputBindingClone:unsigned char
{
	ForceClone = 0x0
};

enum EOptimusGroomExecDomain:unsigned char
{
	None = 0x0,
	ControlPoint = 0x1,
	Curve = 0x2
...
enum EGroomCacheImportType:unsigned char
{
	None = 0x0,
	Strands = 0x1,
	Guides = 0x2,
...
enum EOptimusDataDomainType:int
{
	Dimensional = 0x0,
	Expression = 0x1
};

enum EHairStrandsShaderType:int
{
	Strands = 0x0,
	Cards = 0x1,
	Meshes = 0x2,
...
enum EHairMaterialCompatibility:unsigned char
{
	Valid = 0x0,
...
enum EHairMeshBatchType:int
{
	Raster = 0x0,
	Raytracing = 0x1
};

enum EInputMappingRebuildType:unsigned char
{
	None = 0x0,
	Rebuild = 0x1,
...
enum EFollicleMaskChannel:unsigned char
{
	R = 0x0,
	G = 0x1,
	B = 0x2,
...
enum EStrandsTexturesTraceType:unsigned char
{
	TraceInside = 0x0,
	TraceOuside = 0x1,
...
enum EStrandsTexturesMeshType:unsigned char
{
	Static = 0x0,
	Skeletal = 0x1
};

enum EHairStrandsProjectionMeshType:int
{
	RestMesh = 0x0,
	DeformedMesh = 0x1,
	SourceMesh = 0x2,
...
enum EDebugProjectionHairType:int
{
	HairFrame = 0x0,
	HairTriangle = 0x1,
	HairSamples = 0x2
...
enum HairStrandsTriangleType:int
{
	RestPose = 0x0,
	DeformedPose = 0x1
};

enum EHairStrandsInterpolationType:int
{
	RenderStrands = 0x0,
	SimulationStrands = 0x1
};

enum EOptimusDefaultDeformerMode:unsigned char
{
	Never = 0x0,
	SkinCacheOnly = 0x1,
	Always = 0x2
...
enum EDataLayerType:unsigned char
{
	Runtime = 0x0,
	Editor = 0x1,
	Unknown = 0x2,
...
enum EOptimusNodePinDirection:unsigned char
{
	Unknown = 0x0,
	Input = 0x1,
	Output = 0x2
...
enum EOptimusGraphNotifyType:int
{
	NodeAdded = 0x0,
	NodeRemoved = 0x1,
...
enum EOptimusNodePinStorageType:unsigned char
{
	Value = 0x0,
	Resource = 0x1
};

enum EOptimusDataTypeUsageFlags:unsigned char
{
	None = 0x0,
	Resource = 0x1,
	Variable = 0x2,
...
enum EOptimusDataTypeFlags:unsigned char
{
	None = 0x0,
	IsStructType = 0x1,
	ShowElements = 0x2
...
enum EOptimusGlobalNotifyType:int
{
	GraphAdded = 0x0,
	GraphRemoved = 0x1,
...
enum EOptimusDiagnosticLevel:unsigned char
{
	None = 0x0,
	Info = 0x1,
	Warning = 0x2,
...
enum EOptimusNodeGraphType:int
{
	Setup = 0x0,
	Update = 0x1,
	ExternalTrigger = 0x2,
...
enum EEXRCompressionFormat:unsigned char
{
	None = 0x0,
	PIZ = 0x1,
	ZIP = 0x2,
...
enum EDataSourceTypeEnum:unsigned char
{
...
enum ELocationFilteringModeEnum:unsigned char
{
...
enum ELocationXToSpawnEnum:unsigned char
{
...
enum ELocationYToSpawnEnum:unsigned char
{
...
enum ELocationZToSpawnEnum:unsigned char
{
...
enum EDataSortTypeEnum:unsigned char
{
...
enum ERandomVelocityGenerationTypeEnum:unsigned char
{
...
enum EDebugTypeEnum:unsigned char
{
...
enum ECollisionTypeEnum:unsigned char
{
...
enum EImplicitTypeEnum:unsigned char
{
...
enum EInitialVelocityTypeEnum:unsigned char
{
...
enum EAnimNodeReferenceConversionResult:unsigned char
{
	Succeeded = 0x1,
	Failed = 0x0
};

enum EFBIKBoneLimitType:unsigned char
{
	Free = 0x0,
	Limit = 0x1,
	Locked = 0x2
...
enum EPoleVectorOption:unsigned char
{
	Direction = 0x0,
	Location = 0x1
};

enum EUnusedAttributeBehaviour:unsigned char
{
	Copy = 0x0,
	Zero = 0x1,
	None = 0x2,
...
enum EDeterminismLevel:unsigned char
{
	None = 0x0,
	NoDeterminism = 0x0,
	Basic = 0x1,
...
enum EPCGUnitTestDummyEnum:__int64
{
	One = 0x0,
	Two = 0x1,
	Three = 0x2
...
enum EFieldCommandBuffer:unsigned char
{
	GPUFieldBuffer = 0x0,
	CPUReadBuffer = 0x1,
	CPUWriteBuffer = 0x2,
...
enum EOptimusBufferWriteType:unsigned char
{
	Write = 0x0,
	WriteAtomicAdd = 0x1,
	WriteAtomicMin = 0x2,
...
enum EOptimusSkinnedMeshExecDomain:unsigned char
{
	None = 0x0,
	Vertex = 0x1,
	Triangle = 0x2
...
enum EUdpMessageFormat:unsigned char
{
	None = 0x0,
	Json = 0x1,
	TaggedProperty = 0x2,
...
enum EUdpSerializedMessageState:int
{
	Complete = 0x0,
	Incomplete = 0x1,
	Invalid = 0x2
...
enum EUdpMessageSegments:unsigned char
{
	None = 0x0,
	Abort = 0x1,
	Acknowledge = 0x2,
...
enum ELatticeDeformerToolAction:unsigned char
{
	NoAction = 0x0,
	Constrain = 0x1,
...
enum ELatticeInterpolationType:unsigned char
{
	Linear = 0x0,
	Cubic = 0x1
};

enum EBrushFalloffMode:unsigned char
{
	Angle = 0x0,
	Width = 0x1
};

enum EBrushBlendType:unsigned char
{
	AlphaBlend = 0x0,
	Min = 0x1,
	Max = 0x2,
...
enum EBrushActionMode:int
{
	Paint = 0x0,
	FloodFill = 0x1
};

enum EMeshAttributePaintToolActions:int
{
	NoAction = 0x0
};

enum EMeshGroupPaintBrushType:unsigned char
{
	Paint = 0x0,
	Erase = 0x1,
	LastValue = 0x2
...
enum EMeshGroupPaintInteractionType:unsigned char
{
	Brush = 0x0,
	Fill = 0x1,
	GroupFill = 0x2,
...
enum EMeshGroupPaintBrushAreaType:unsigned char
{
	Connected = 0x0,
	Volumetric = 0x1
};

enum EMeshGroupPaintVisibilityType:unsigned char
{
	None = 0x0,
	FrontFacing = 0x1,
	Unoccluded = 0x2
...
enum EMeshGroupPaintToolActions:int
{
	NoAction = 0x0,
	ClearFrozen = 0x1,
	FreezeCurrent = 0x2,
...
enum EMeshInspectorToolDrawIndexMode:unsigned char
{
	None = 0x0,
	VertexID = 0x1,
	TriangleID = 0x2,
...
enum ESteelShieldDataFlags:int
{
...
enum EMeshInspectorMaterialMode:unsigned char
{
	Original = 0x0,
	FlatShaded = 0x1,
	Grey = 0x2,
...
enum EMeshSelectionToolActions:int
{
	NoAction = 0x0,
	SelectAll = 0x1,
...
enum EMeshSelectionToolPrimaryMode:int
{
	Brush = 0x0,
	VolumetricBrush = 0x1,
	AngleFiltered = 0x2,
...
enum ESpectatorClientRequestType:unsigned char
{
	NonePending = 0x0,
	ExistingSessionReservation = 0x1,
	ReservationUpdate = 0x2,
...
enum ENonlinearOperationType:signed char
{
	Bend = 0x0,
	Flare = 0x1,
	Twist = 0x2
...
enum EFlareProfileType:signed char
{
	SinMode = 0x0,
	SinSquaredMode = 0x1,
	TriangleMode = 0x2
...
enum EMeshSpaceDeformerToolAction:int
{
	NoAction = 0x0,
	ShiftToCenter = 0x1
};

enum EMeshVertexSculptBrushType:unsigned char
{
	Move = 0x0,
	PullKelvin = 0x1,
	PullSharpKelvin = 0x2,
...
enum EMeshVertexSculptBrushFilterType:unsigned char
{
	None = 0x0,
	Component = 0x1,
	PolyGroup = 0x2
...
enum EVoipStreamDataFormat:unsigned char
{
	Float = 0x0,
	Int16 = 0x1,
	Unknown = 0x2
...
enum EMirrorOperationMode:unsigned char
{
	MirrorAndAppend = 0x0,
	MirrorExisting = 0x1
};

enum EMirrorCtrlClickBehavior:unsigned char
{
	Reposition = 0x0,
	RepositionAndReorient = 0x1
};

enum EMirrorSaveMode:unsigned char
{
	UpdateAssets = 0x0,
	CreateNewAssets = 0x1
};

enum EMirrorToolAction:int
{
	NoAction = 0x0,
	ShiftToCenter = 0x1,
	Left = 0x2,
...
enum EOffsetMeshToolOffsetType:unsigned char
{
	Iterative = 0x0,
	Implicit = 0x1
};

enum ECollisionGeometryMode:int
{
	Default = 0x0,
...
enum EExtractCollisionOutputType:unsigned char
{
	Simple = 0x0,
	Complex = 0x1
};
...
enum EPropertyLocalizationGathererTextFlags:unsigned char
{
	None = 0x0,
	ForceHasScript = 0x1,
...
enum EPropertyLocalizationGathererResultFlags:unsigned char
{
	Empty = 0x0,
	HasText = 0x1,
	HasScript = 0x2,
...
enum EMoviePipelineDLSSQuality:unsigned char
{
...
enum EPropertyBagMissingEnum:unsigned char
{
	Missing = 0x0
};

enum EStructUtilsResult:unsigned char
{
	Valid = 0x0,
	NotValid = 0x1
};
...
enum ECollisionGeometryType:int
{
	KeepExisting = 0x0,
	AlignedBoxes = 0x1,
	OrientedBoxes = 0x2,
...
enum ESetCollisionGeometryInputMode:int
{
	CombineAll = 0x0,
	PerInputObject = 0x1,
...
enum EProcMeshSliceCapOption:unsigned char
{
	NoCap = 0x0,
...
enum EOcclusionCalculationUIMode:unsigned char
{
	GeneralizedWindingNumber = 0x0,
	RaycastOcclusionSamples = 0x1
};

enum EOcclusionTriangleSamplingUIMode:unsigned char
{
	Vertices = 0x0,
	VerticesAndCentroids = 0x1
};

enum EOccludedAction:unsigned char
{
	Remove = 0x0,
	SetNewGroup = 0x1
};

enum EArkProcMeshSliceCapOption:unsigned char
{
	NoCap = 0x0,
	CreateNewSectionForCap = 0x1,
	UseLastSectionForCap = 0x2
...
enum exr_tile_round_mode_t:int
{
...
enum exr_tile_level_mode_t:int
{
...
enum EActorSequenceObjectReferenceType:unsigned char
{
	ContextActor = 0x0,
	ExternalActor = 0x1,
	Component = 0x2
...
enum ESkinWeightsBindType:unsigned char
{
	DirectDistance = 0x0,
	GeodesicVoxel = 0x1
};

enum ESmoothMeshToolSmoothType:unsigned char
{
	Iterative = 0x0,
	Implicit = 0x1,
	Diffusion = 0x2
...
enum ETransformMeshesTransformMode:unsigned char
{
	SharedGizmo = 0x0,
...
enum ETransformMeshesSnapDragSource:unsigned char
{
	ClickPoint = 0x0,
	Pivot = 0x1,
	LastValue = 0x2
...
enum ETransformMeshesSnapDragRotationMode:unsigned char
{
	Ignore = 0x0,
	Align = 0x1,
	AlignFlipped = 0x2,
...
enum EVoxelBlendOperation:unsigned char
{
	Union = 0x0,
	Subtract = 0x1
};

enum EWaveTableCurve:unsigned char
{
	Linear = 0x0,
	Linear_Inv = 0x1,
	Exp = 0x2,
...
enum EWaveTableResolution:unsigned char
{
	None = 0x0,
	Res_8 = 0x3,
	Res_16 = 0x4,
...
enum VkPipelineStageFlagBits:unsigned __int64
{
...
enum VkAccessFlagBits:unsigned __int64
{
...
enum ERawDistributionOperation:int
{
...
enum EBindingKind:unsigned char
{
	Function = 0x0,
	Property = 0x1
};
...
enum EInstallStatus:unsigned char
{
...
enum EGameModsEvent:unsigned char
{
...
enum EAnalogStick:unsigned char
{
	Left = 0x0,
	Right = 0x1,
	Max = 0x2
...
enum ERenderFocusRule:unsigned char
{
	Always = 0x0,
	NonPointer = 0x1,
	NavigationOnly = 0x2,
...
enum EUIScalingRule:unsigned char
{
	ShortestSide = 0x0,
	LongestSide = 0x1,
	Horizontal = 0x2,
...
enum ECursorMoveGranularity:int
{
	Character = 0x0,
	Word = 0x1
};

enum ERootMotionSourceID:unsigned short
{
	Invalid = 0x0
};

enum ECookOptimizationFlags:int
{
	None = 0x0,
	RemoveTrack = 0x1,
	RemoveObject = 0x2,
...
enum EReferenceChainSearchMode:int
{
	Default = 0x0,
	ExternalOnly = 0x1,
	Shortest = 0x2,
...
enum EOscillatorWaveform:unsigned char
{
	SineWave = 0x0,
	PerlinNoise = 0x1
};

enum ECameraAnimationEasingType:unsigned char
{
	Linear = 0x0,
	Sinusoidal = 0x1,
	Quadratic = 0x2,
...
enum ECameraAnimationPlaySpace:unsigned char
{
	CameraLocal = 0x0,
	World = 0x1,
	UserDefined = 0x2
...
enum ETriggerEffectType:unsigned char
{
	None = 0x0,
	Feedback = 0x1,
	Weapon = 0x2,
...
enum EArchiveReferenceMarkerFlags:unsigned int
{
	None = 0x0,
	SkipCompilingAssets = 0x1
};

enum EInitialWaveOscillatorOffsetType:unsigned char
{
	Random = 0x0,
	Zero = 0x1
};

enum EFourPlayerSplitScreenType:unsigned char
{
	Grid = 0x0,
	Vertical = 0x1,
	Horizontal = 0x2
...
enum EEmissionPatternTypeEnum:unsigned char
{
...
enum EMetasoundSourceAudioFormat:unsigned char
{
	Mono = 0x0,
	Stereo = 0x1,
	Quad = 0x2,
...
enum EMetaSoundMessageLevel:unsigned char
{
	Error = 0x0,
	Warning = 0x1,
	Info = 0x2
...
enum EParticleSignificanceLevel:unsigned char
{
	Low = 0x0,
	Medium = 0x1,
	High = 0x2,
...
enum EGLTFMaterialPropertyGroup:unsigned char
{
	None = 0x0,
...
enum EGLTFMaterialBakeSizePOT:unsigned char
{
	POT_1 = 0x0,
	POT_2 = 0x1,
	POT_4 = 0x2,
...
enum ESolverFlags:unsigned char
{
	None = 0x0,
	Standalone = 0x1
};

enum EGLTFMaterialBakeMode:unsigned char
{
	Disabled = 0x0,
	Simple = 0x1,
	UseMeshData = 0x2
...
enum EGLTFTextureImageFormat:unsigned char
{
	None = 0x0,
	PNG = 0x1,
	JPEG = 0x2
...
enum EGLTFMaterialVariantMode:unsigned char
{
	None = 0x0,
	Simple = 0x1,
	UseMeshData = 0x2
...
enum EMusicState:unsigned char
{
	EMS_LOADING = 0x0,
	EMS_PLAYING = 0x1,
	EMS_FINISHED = 0x2
...
enum EGLTFJsonShadingModel:int
{
	None = 0xFF,
	Default = 0x0,
	Unlit = 0x1,
...
enum EGLTFJsonInterpolation:int
{
	None = 0xFF,
	Linear = 0x0,
	Step = 0x1,
...
enum EGLTFJsonAccessorType:int
{
	None = 0xFF,
	Scalar = 0x0,
	Vec2 = 0x1,
...
enum EGLTFJsonComponentType:int
{
	None = 0xFF,
	Int8 = 0x1400,
	UInt8 = 0x1401,
...
enum EGLTFJsonBufferTarget:unsigned __int64
{
	None = 0xFF,
...
enum EGLTFJsonPrimitiveMode:int
{
	Points = 0x0,
	Lines = 0x1,
	LineLoop = 0x2,
...
enum EGLTFJsonTextureFilter:int
{
	None = 0xFF,
	Nearest = 0x2600,
	Linear = 0x2601,
...
enum EGLTFJsonTextureWrap:unsigned __int64
{
	None = 0xFF,
	Repeat = 0x2901,
...
enum EWirelessTransmissionType:unsigned char
{
	Custom = 0x0,
	Power = 0x1,
	Water = 0x2,
...
enum EReflectionSourceType:unsigned char
{
	CapturedScene = 0x0,
...
enum ESceneCapturePrimitiveRenderMode:unsigned char
{
...
enum EGLTFTaskPriority:unsigned char
{
	Animation = 0x0,
	Mesh = 0x1,
	Material = 0x2,
...
enum EPropertyAccessChangeNotifyMode:unsigned char
{
	Default = 0x0,
	Never = 0x1,
	Always = 0x2
...
enum EPropertyAccessResultFlags:unsigned char
{
	Success = 0x0,
...
enum ECurveTableMode:unsigned char
{
	Empty = 0x0,
	SimpleCurves = 0x1,
	RichCurves = 0x2
...
enum ERuntimeGenerationType:unsigned char
{
	Static = 0x0,
...
enum EVirtualKeyboardTrigger:unsigned char
{
	OnFocusByPointer = 0x0,
	OnAllFocusEvents = 0x1
};

enum EVirtualKeyboardDismissAction:unsigned char
{
...
enum EClusterUnionMethod:unsigned char
{
	PointImplicit = 0x0,
...
enum ESynth1OscType:unsigned char
{
	Sine = 0x0,
	Saw = 0x1,
	Triangle = 0x2,
...
enum ESynthLFOType:unsigned char
{
	Sine = 0x0,
	UpSaw = 0x1,
	DownSaw = 0x2,
...
enum ESynthLFOMode:unsigned char
{
	Sync = 0x0,
	OneShot = 0x1,
	Free = 0x2,
...
enum ESynthLFOPatchType:unsigned char
{
	PatchToNone = 0x0,
	PatchToGain = 0x1,
	PatchToOscFreq = 0x2,
...
enum ESynthModEnvPatch:unsigned char
{
	PatchToNone = 0x0,
	PatchToOscFreq = 0x1,
...
enum ESynthModEnvBiasPatch:unsigned char
{
	PatchToNone = 0x0,
	PatchToOscFreq = 0x1,
	PatchToFilterFreq = 0x2,
...
enum ESynthFilterType:unsigned char
{
	LowPass = 0x0,
	HighPass = 0x1,
	BandPass = 0x2,
...
enum ESynthFilterAlgorithm:unsigned char
{
	OnePole = 0x0,
	StateVariable = 0x1,
	Ladder = 0x2,
...
enum ESynthStereoDelayMode:unsigned char
{
	Normal = 0x0,
	Cross = 0x1,
	PingPong = 0x2,
...
enum ESynth1PatchSource:unsigned char
{
	LFO1 = 0x0,
	LFO2 = 0x1,
	Envelope = 0x2,
...
enum ESynth1PatchDestination:unsigned char
{
	Osc1Gain = 0x0,
	Osc1Frequency = 0x1,
	Osc1Pulsewidth = 0x2,
...
enum EAcceptPartyInvitationCompletionResult:signed char
{
	NotLoggedIn = 0x9C,
	InvitePending = 0x9D,
	AlreadyInParty = 0x9E,
...
enum ESubmixEffectConvolutionReverbBlockSize:unsigned char
{
	BlockSize256 = 0x0,
	BlockSize512 = 0x1,
	BlockSize1024 = 0x2
...
enum EDescendantScrollDestination:unsigned char
{
	IntoView = 0x0,
	TopOrLeft = 0x1,
	Center = 0x2,
...
enum EScrollWhenFocusChanges:unsigned char
{
	NoScroll = 0x0,
	InstantScroll = 0x1,
	AnimatedScroll = 0x2
...
enum CompressTaskState:unsigned int
{
	BusyCompressing = 0x0,
...
enum ESourceEffectDynamicsProcessorType:unsigned char
{
	Compressor = 0x0,
	Limiter = 0x1,
	Expander = 0x2,
...
enum ESourceEffectDynamicsPeakMode:unsigned char
{
	MeanSquared = 0x0,
	RootMeanSquared = 0x1,
	Peak = 0x2,
...
enum EGeometryCollectionPhysicsTypeEnum:unsigned char
{
...
enum EEnvelopeFollowerPeakMode:unsigned char
{
	MeanSquared = 0x0,
	RootMeanSquared = 0x1,
	Peak = 0x2,
...
enum ESourceEffectFilterCircuit:unsigned char
{
	OnePole = 0x0,
	StateVariable = 0x1,
	Ladder = 0x2,
...
enum ESourceEffectFilterType:unsigned char
{
	LowPass = 0x0,
	HighPass = 0x1,
	BandPass = 0x2,
...
enum ESourceEffectFilterParam:unsigned char
{
	FilterFrequency = 0x0,
	FilterResonance = 0x1,
	Count = 0x2
...
enum EStereoChannelMode:unsigned char
{
	MidSide = 0x0,
	LeftRight = 0x1,
	count = 0x2
...
enum ESourceEffectMotionFilterCircuit:unsigned char
{
	OnePole = 0x0,
	StateVariable = 0x1,
	Ladder = 0x2,
...
enum ESourceEffectMotionFilterType:unsigned char
{
	LowPass = 0x0,
	HighPass = 0x1,
	BandPass = 0x2,
...
enum ESourceEffectMotionFilterModSource:unsigned char
{
...
enum ESourceEffectMotionFilterModDestination:unsigned char
{
...
enum EWeaponAmmoReloadState:unsigned char
{
	Playing_Anim = 0x0,
...
enum ESourceEffectMotionFilterTopology:unsigned char
{
	SerialMode = 0x0,
	ParallelMode = 0x1,
	Count = 0x2
...
enum ECameraSetting_BoolCondition:unsigned char
{
	Dont_Care = 0x0,
	Yes = 0x1,
	No = 0x2
...
enum EPhaserLFOType:unsigned char
{
	Sine = 0x0,
	UpSaw = 0x1,
	DownSaw = 0x2,
...
enum ERingModulatorTypeSourceEffect:unsigned char
{
	Sine = 0x0,
	Saw = 0x1,
	Triangle = 0x2,
...
enum EStereoDelaySourceEffect:unsigned char
{
	Normal = 0x0,
	Cross = 0x1,
	PingPong = 0x2,
...
enum EStereoDelayFiltertype:unsigned char
{
	Lowpass = 0x0,
	Highpass = 0x1,
	Bandpass = 0x2,
...
enum FNavigationSystemRunMode:unsigned char
{
	InvalidMode = 0x0,
	GameMode = 0x1,
	EditorMode = 0x2,
...
enum EClusterConnectionTypeEnum:unsigned char
{
...
enum ESubmixFilterType:unsigned char
{
	LowPass = 0x0,
	HighPass = 0x1,
	BandPass = 0x2,
...
enum ESubmixFilterAlgorithm:unsigned char
{
	OnePole = 0x0,
	StateVariable = 0x1,
	Ladder = 0x2,
...
enum EDataTableExportFlags:unsigned char
{
	None = 0x0,
...
enum ETapLineMode:unsigned char
{
	SendToChannel = 0x0,
	Panning = 0x1,
	Disabled = 0x2
...
enum EGranularSynthSeekType:unsigned char
{
	FromBeginning = 0x0,
...
enum EGranularSynthEnvelopeType:unsigned char
{
	Rectangular = 0x0,
	Triangle = 0x1,
...
enum CurveInterpolationType:unsigned char
{
	AUTOINTERP = 0x0,
	LINEAR = 0x1,
	CONSTANT = 0x2
...
enum EShapeBodySetupHelper:int
{
...
enum ESamplePlayerSeekType:unsigned char
{
	FromBeginning = 0x0,
	FromCurrentPosition = 0x1,
	FromEnd = 0x2,
...
enum ESynthSlateSizeType:unsigned char
{
	Small = 0x0,
	Medium = 0x1,
	Large = 0x2,
...
enum ESynthSlateColorStyle:unsigned char
{
	Light = 0x0,
	Dark = 0x1,
	Count = 0x2
...
enum ESynthKnobSize:unsigned char
{
	Medium = 0x0,
	Large = 0x1,
	Count = 0x2
...
enum ETemplateSectionPropertyScaleType:int
{
	FloatProperty = 0x0,
...
enum EOS_ELeaderboardAggregation:int
{
	EOS_LA_Min = 0x0,
	EOS_LA_Max = 0x1,
	EOS_LA_Sum = 0x2,
...
enum ECursorAction:int
{
	MoveCursor = 0x0,
	SelectText = 0x1
};

enum ECursorMoveMethod:int
{
	Cardinal = 0x0,
	ScreenPosition = 0x1
};

enum ESerializedPendingFriendRequestMode:unsigned char
{
...
enum EArchiveReplaceObjectFlags:int
{
	None = 0x0,
	NullPrivateRefs = 0x1,
	IgnoreOuterRef = 0x2,
...
enum EMediaSoundComponentFFTSize:unsigned char
{
	Min_64 = 0x0,
	Small_256 = 0x1,
	Medium_512 = 0x2,
...
enum HighlightStartingPoint:int
{
	TopLeft = 0x0,
	Center = 0x1
};

enum EVoiceChatResult:int
{
	Success = 0x0,
	InvalidState = 0x1,
	NotInitialized = 0x2,
...
enum EVoiceChatChannelType:int
{
	NonPositional = 0x0,
	Positional = 0x1,
	Echo = 0x2
...
enum EVoiceChatTransmitMode:int
{
	None = 0x0,
	All = 0x1,
	Channel = 0x2
...
enum EVoiceChatAttenuationModel:int
{
	None = 0x0,
...
enum EBlackboardNotificationResult:unsigned char
{
	RemoveObserver = 0x0,
	ContinueObserving = 0x1
};

enum EWidgetDesignFlags:unsigned char
{
	None = 0x0,
	Designing = 0x1,
	ShowOutline = 0x2,
...
enum ShowHarvestingElementOption:unsigned int
{
...
enum EUsdDuplicateType:unsigned char
{
...
enum ECDOArrayModificationType:unsigned char
{
	MODIFY = 0x0,
	ADD = 0x1,
	REMOVE = 0x2,
...
enum ERejectPartyInvitationCompletionResult:signed char
{
	NotLoggedIn = 0x9C,
	InvitePending = 0x9D,
	AlreadyInParty = 0x9E,
...
enum EHandshakeInstallState:int
{
	EHIS_None = 0x0,
...
enum EPCGDebugVisScaleMethod:unsigned char
{
	Relative = 0x0,
	Absolute = 0x1,
	Extents = 0x2
...
enum EPCGSettingsExecutionMode:unsigned char
{
	Enabled = 0x0,
	Debug = 0x1,
	Isolated = 0x2,
...
enum EMediaTextureSampleFormat:int
{
	Undefined = 0x0,
	CharAYUV = 0x1,
	CharBGRA = 0x2,
...
enum EBakeScaleMethod:unsigned char
{
	BakeFullScale = 0x0,
...
enum EConvertToPolygonsMode:int
{
...
enum ECubeGridToolFaceSelectionMode:int
{
...
enum EMediaTextureVisibleMipsTiles:unsigned char
{
	None = 0x0,
	Plane = 0x1,
	Sphere = 0x2
...
enum EGroupTopologyDeformationStrategy:unsigned char
{
	Linear = 0x0,
	Laplacian = 0x1
};

enum EQuickTransformerMode:unsigned char
{
	AxisTranslation = 0x0,
	AxisRotation = 0x1
};

enum EWeightScheme:int
{
	Uniform = 0x0,
	Umbrella = 0x1,
	Valence = 0x2,
...
enum EBuildPatchInstallError:int
{
	NoError = 0x0,
	DownloadError = 0x1,
...
enum EDisplaceMeshToolDisplaceType:unsigned char
{
	Constant = 0x0,
	DisplacementMap = 0x1,
	RandomNoise = 0x2,
...
enum EDisplaceMeshToolSubdivisionType:unsigned char
{
	Flat = 0x0,
	PNTriangles = 0x1
};

enum EDisplaceMeshToolTriangleSelectionType:unsigned char
{
	None = 0x0,
	Material = 0x1
};

enum EDisplaceMeshToolChannelType:unsigned char
{
	Red = 0x0,
	Green = 0x1,
	Blue = 0x2,
...
enum EBuildPatchDownloadHealth:int
{
	Disconnected = 0x0,
	Poor = 0x1,
	OK = 0x2,
...
enum EDrawPolyPathWidthMode:int
{
	Fixed = 0x0,
	Interactive = 0x1
};

enum EDrawPolyPathRadiusMode:int
{
	Fixed = 0x0,
	Interactive = 0x1
};

enum EDrawPolyPathExtrudeMode:int
{
	Flat = 0x0,
	Fixed = 0x1,
	Interactive = 0x2,
...
enum EDrawPolyPathExtrudeDirection:int
{
	SelectionNormal = 0x0,
	WorldX = 0x1,
	WorldY = 0x2,
...
enum EDynamicMeshSculptBrushType:unsigned char
{
	Move = 0x0,
	PullKelvin = 0x1,
	PullSharpKelvin = 0x2,
...
enum EEditPivotSnapDragRotationMode:unsigned char
{
	Ignore = 0x0,
	Align = 0x1,
	AlignFlipped = 0x2,
...
enum EEditPivotToolActions:int
{
	NoAction = 0x0,
	Center = 0x1,
	Bottom = 0x2,
...
enum ERequestPartyInvitationCompletionResult:signed char
{
	NotLoggedIn = 0x9C,
	InvitePending = 0x9D,
	AlreadyInParty = 0x9E,
...
enum EMediaRateThinning:int
{
	Thinned = 0x0,
	Unthinned = 0x1
};

enum EMediaSeekDirection:int
{
	Backward = 0x0,
	Beginning = 0x1,
	End = 0x2,
...
enum EMediaPlayerOptionBooleanOverride:unsigned char
{
...
enum EMediaPlayerTrack:unsigned char
{
	Audio = 0x0,
	Caption = 0x1,
	Metadata = 0x2,
...
enum EMediaPlateEventState:unsigned char
{
	Play = 0x0,
	Open = 0x1,
	Close = 0x2,
...
enum EHttpServerResponseCodes:unsigned short
{
	Unknown = 0x0,
	Continue = 0x64,
	SwitchProtocol = 0x65,
...
enum EHttpServerRequestVerbs:unsigned short
{
	VERB_NONE = 0x0,
	VERB_GET = 0x1,
	VERB_POST = 0x2,
...
enum ECollectionScriptingShareType:unsigned char
{
	Local = 0x0,
	Private = 0x1,
	Shared = 0x2
...
enum UStreamlineFeature:unsigned char
{
	DLSSG = 0x0,
	Reflex = 0x1,
	Count = 0x2
...
enum UStreamlineDLSSGMode:unsigned char
{
	Off = 0x0,
	On = 0x1,
	Auto = 0x2
...
enum UStreamlineReflexMode:unsigned char
{
	Disabled = 0x0,
	Enabled = 0x1,
...
enum UNISSupport:unsigned char
{
	Supported = 0x0,
	NotSupported = 0x1
};
...
enum EPropertyValueCategory:unsigned char
{
	Undefined = 0x0,
	Generic = 0x1,
...
enum EWindSourceMode:unsigned char
{
	AtmosphericWind = 0x0,
	FoliageInteraction = 0x1
};

enum EEffectScope:unsigned char
{
	FirstPersonOnly = 0x0,
	ThirdPersonOnly = 0x1,
	AllCameraModes = 0x2
...
enum EPrimalStructurePlacerState:unsigned char
{
	Default = 0x0,
	FadeAway = 0x1,
...
enum EHeightFieldRenderMode:unsigned char
{
	Solid = 0x0,
	Walkable = 0x1
};
...
enum ETimeSliceWorkResult:unsigned char
{
	Failed = 0x0,
	Succeeded = 0x1,
...
enum rcRasterizationFlags:int
{
	RC_PROJECT_TO_BOTTOM = 0x1
};

enum ERasterizeGeomRecastTimeSlicedState:unsigned char
{
	MarkWalkableTriangles = 0x0,
	RasterizeTriangles = 0x1
};

enum ERasterizeGeomTimeSlicedState:unsigned char
{
	RasterizeGeometryTransformCoords = 0x0,
	RasterizeGeometryRecast = 0x1
};

enum EGenerateRecastFilterTimeSlicedState:unsigned char
{
...
enum EDoWorkTimeSlicedState:unsigned char
{
	Invalid = 0x0,
...
enum EGenerateTileTimeSlicedState:unsigned char
{
	Invalid = 0x0,
...
enum EGenerateNavDataTimeSlicedState:unsigned char
{
	Invalid = 0x0,
	Init = 0x1,
	GenerateLayers = 0x2
...
enum EGenerateCompressedLayersTimeSliced:unsigned char
{
	Invalid = 0x0,
	Init = 0x1,
...
enum EProcessTileTasksSyncTimeSlicedState:unsigned char
{
	Init = 0x0,
	DoWork = 0x1,
...
enum EAddGeneratedTilesTimeSlicedState:unsigned char
{
	Init = 0x0,
	AddTiles = 0x1
};

enum FAmazonS3GetObjectStatus:int
{
...
enum EAmazonS3MultipartUploadStatus:int
{
	NotStarted = 0x0,
	Uploading = 0x1,
	Done = 0x2,
...
enum ECrateMovementMode:unsigned char
{
	None = 0x0,
	Regular = 0x1,
	Throttled = 0x2
...
enum ServerSortingTypeType:int
{
	Official_Asc = 0x0,
	Official_Dsc = 0x1,
	Ping_Asc = 0x2,
...
enum EConfigManifestVersion:int
{
	Initial = 0x0,
...
enum EEventLoadNode2:unsigned char
{
...
enum EZenPackageVersion:unsigned int
{
	Initial = 0x0,
...
enum EExportFilterFlags:unsigned char
{
	None = 0x0,
	NotForClient = 0x1,
	NotForServer = 0x2
...
enum EEventLoadNodeExecutionResult:unsigned char
{
	Timeout = 0x0,
	Complete = 0x1
};
...
enum EBTChildIndex:unsigned char
{
	FirstNode = 0x0,
	TaskNode = 0x1
};

enum BattleyePlayerStatus:int
{
...
enum EAsyncPackageLoadingState2:unsigned char
{
	NewPackage = 0x0,
	WaitingForIo = 0x1,
...
enum EPathFollowingReachMode:unsigned char
{
	ExactLocation = 0x0,
	OverlapAgent = 0x1,
	OverlapGoal = 0x2,
...
enum EWorldPartitionInitState:int
{
	Uninitialized = 0x0,
	Initializing = 0x1,
	Initialized = 0x2,
...
enum EOnlineActivityOutcome:int
{
	Completed = 0x0,
	Failed = 0x1,
	Cancelled = 0x2
...
enum EDataLayerRuntimeState:unsigned char
{
	Unloaded = 0x0,
	Loaded = 0x1,
	Activated = 0x2
...
enum EWorldPartitionRuntimeCellState:unsigned char
{
	Unloaded = 0x0,
	Loaded = 0x1,
	Activated = 0x2
...
enum EWorldPartitionRuntimeCellVisualizeMode:int
{
	StreamingPriority = 0x0,
	StreamingStatus = 0x1
};

enum EWorldPartitionStreamingPerformance:unsigned char
{
	Good = 0x0,
	Slow = 0x1,
	Critical = 0x2
...
enum EDataLayerState:unsigned char
{
	Unloaded = 0x0,
	Loaded = 0x1,
	Activated = 0x2
...
enum EIllegalRefReason:unsigned char
{
	None = 0x0,
...
enum EAsyncWriteOptions:int
{
	None = 0x0
};

enum EMIDCreationFlags:unsigned char
{
	None = 0x0,
	Transient = 0x1
};
...
enum EStrataMaterialExportContext:unsigned char
{
	SMEC_Opaque = 0x0,
	SMEC_Translucent = 0x1
};

enum EStrataMaterialExport:unsigned char
{
	SME_None = 0x0,
	SME_Diffuse = 0x1,
	SME_Normal = 0x2,
...
enum EMaterialCompilerType:int
{
	Standard = 0x0,
	Lightmass = 0x1,
	MaterialProxy = 0x2
...
enum EVirtualTextureUnpackType:int
{
	None = 0x0,
	BaseColorYCoCg = 0x1,
	NormalBC3 = 0x2,
...
enum POWER_INFORMATION_LEVEL:int
{
	...
	PowerInformationLevelMaximum = 0x5F
};

enum DWMNCRENDERINGPOLICY:int
{
...
enum FILETYPEATTRIBUTEFLAGS:unsigned __int64
{
	FTA_None = 0x0,
	FTA_Exclude = 0x1,
	FTA_Show = 0x2,
...
enum EAntiDupeTransactionLog:int
{
	Item_Upload = 0x0,
	Dino_Upload = 0x1,
	Player_Upload = 0x2,
...
enum EConstantQFFTSizeEnum:unsigned char
{
	Min = 0x0,
	XXSmall = 0x1,
	XSmall = 0x2,
...
enum EConstantQNormalizationEnum:unsigned char
{
...
enum EBTBranchAction:unsigned short
{
	None = 0x0,
...
enum EBTNodeRelativePriority:unsigned char
{
	Lower = 0x0,
	Same = 0x1,
	Higher = 0x2
...
enum ELoudnessCurveTypeEnum:unsigned char
{
	A = 0x0,
	B = 0x1,
	C = 0x2,
...
enum ELoudnessNRTCurveTypeEnum:unsigned char
{
	A = 0x0,
	B = 0x1,
	C = 0x2,
...
enum ETextHistoryType:signed char
{
	None = 0xFF,
	Base = 0x0,
	NamedFormat = 0x1,
	...
	AsDateTime = 0x9,
	Transform = 0xA,
	StringTableEntry = 0xB,
	TextGenerator = 0xC
};

enum ERequestedCultureOverrideLevel:unsigned char
{
	CommandLine = 0x0,
	EditorSettings = 0x1,
...
enum OodleLZ_Decode_ThreadPhase:int
{
...
enum dictCtx_directive:int
{
	noDictCtx = 0x0,
	usingDictCtxHc = 0x1
};

enum repeat_state_e:int
{
	rep_untested = 0x0,
	rep_not = 0x1,
	rep_confirmed = 0x2
...
enum endCondition_directive:int
{
	endOnOutputSize = 0x0,
	endOnInputSize = 0x1
};

enum variable_length_error:int
{
	loop_error = 0xFE,
	initial_error = 0xFF,
	lz4ok = 0x0
...
enum earlyEnd_directive:int
{
	decode_full_block = 0x0,
	partial_decode = 0x1
};

enum dict_directive:int
{
	noDict = 0x0,
	withPrefix64k = 0x1,
	usingExtDict = 0x2,
...
enum limitedOutput_directive:int
{
	notLimited = 0x0,
	limitedOutput = 0x1,
	fillOutput = 0x2
...
enum dictIssue_directive:int
{
	noDictIssue = 0x0,
	dictSmall = 0x1
};

enum tableType_t:int
{
	clearedTable = 0x0,
	byPtr = 0x1,
	byU32 = 0x2,
...
enum EIoContainerHeaderVersion:unsigned int
{
	Initial = 0x0,
...
enum ECoroTimeoutFlags:unsigned char
{
	Suspend_Named = 0x2,
	Suspend_Worker = 0x4,
	Suspend_All = 0x6
...
enum EIoStoreTocVersion:unsigned char
{
	Invalid = 0x0,
	Initial = 0x1,
	DirectoryIndex = 0x2,
...
enum EIoStoreTocReadOptions:int
{
	Default = 0x0,
...
enum FIoStoreTocEntryMetaFlags:unsigned char
{
	None = 0x0,
	Compressed = 0x1,
	MemoryMapped = 0x2
...
enum MULTICAST_MODE_TYPE:int
{
	MCAST_INCLUDE = 0x0,
	MCAST_EXCLUDE = 0x1
};

enum ESocketBSDReturn:unsigned char
{
	Yes = 0x0,
	No = 0x1,
...
enum ESocketBSDParam:unsigned char
{
	CanRead = 0x0,
	CanWrite = 0x1,
	HasError = 0x2
...
enum EPackageStoreEntryFlags:unsigned int
{
	None = 0x0,
	Redirected = 0x1,
	AutoOptional = 0x2
...
enum EPackageStoreEntryStatus:int
{
	None = 0x0,
	Missing = 0x1,
	Pending = 0x2,
...
enum _NET_IF_CONNECTION_TYPE:int
{
...
enum EDesiredImageFormat:unsigned char
{
	PNG = 0x0,
	JPG = 0x1,
	BMP = 0x2,
...
enum EPrimalStructureElevatorState:int
{
	PSLS_Down = 0x0,
	PSLS_Up = 0x1
};
...
enum EMeterPeakType:unsigned char
{
	MeanSquared = 0x0,
	RootMeanSquared = 0x1,
	Peak = 0x2,
...
enum mi_segment_kind_e:int
{
	MI_SEGMENT_NORMAL = 0x0,
	MI_SEGMENT_HUGE = 0x1
};

enum mi_option_e:int
{
...
enum MEM_EXTENDED_PARAMETER_TYPE:int
{
...
enum EStyleColor:unsigned char
{
	Black = 0x0,
	Background = 0x1,
	Title = 0x2,
...
enum EAsyncPackageLoadingState:unsigned char
{
	NewPackage = 0x0,
...
enum pffft_direction_t:int
{
	PFFFT_FORWARD = 0x0,
	PFFFT_BACKWARD = 0x1
};

enum pffft_transform_t:int
{
	PFFFT_REAL = 0x0,
	PFFFT_COMPLEX = 0x1
};

enum ERaQualityMode:unsigned char
{
	STEREO_PANNING = 0x0,
	BINAURAL_LOW = 0x1,
	BINAURAL_MEDIUM = 0x2,
...
enum ERaSpatializationMethod:unsigned char
{
	STEREO_PANNING = 0x0,
	HRTF = 0x1
};

enum ERaDistanceRolloffModel:unsigned char
{
	LOGARITHMIC = 0x0,
	LINEAR = 0x1,
	NONE = 0x2
...
enum EResonanceRenderMode:unsigned char
{
	StereoPanning = 0x0,
...
enum EEntryCategory:unsigned char
{
	LearnedNotes = 0x0,
	TheIsland = 0x1,
	ScorchedEarth = 0x2,
...
enum ETrackedSlateWidgetOperations:unsigned char
{
	AddedTrackedWidget = 0x0,
	RemovedTrackedWidget = 0x1
};

enum EBlendListTransitionType:unsigned char
{
	StandardBlend = 0x0,
	Inertialization = 0x1
};
...
enum EGameplayTaskState:unsigned char
{
	Uninitialized = 0x0,
...
enum ETaskResourceOverlapPolicy:unsigned char
{
	StartOnTop = 0x0,
	StartAtEnd = 0x1,
...
enum EPathFollowingVelocityMode:unsigned char
{
	Reset = 0x0,
	Keep = 0x1
};
...
enum EGameplayTaskRunResult:unsigned char
{
	Error = 0x0,
	Failed = 0x1,
	Success_Paused = 0x2,
...
enum EGameplayTaskEvent:unsigned char
{
	Add = 0x0,
	Remove = 0x1
};
...
enum ECustomDepthPassLocation:unsigned int
{
	BeforeBasePass = 0x0,
	AfterBasePass = 0x1
};
...
enum ELayoutExtensionPosition:int
{
	Before = 0x0,
	After = 0x1,
	Above = 0x2,
...
enum EDecalRasterizerState:unsigned char
{
	Undefined = 0x0,
	CCW = 0x1,
	CW = 0x2
...
enum XXH_alignment:int
{
	XXH_aligned = 0x0,
	XXH_unaligned = 0x1
};

enum XXH_INLINE_XXH_errorcode:int
{
	XXH_INLINE_XXH_OK = 0x0,
	XXH_INLINE_XXH_ERROR = 0x1
};

enum ScalableAllocationResult:int
{
	TBBMALLOC_OK = 0x0,
...
enum ETabDrawerOpenDirection:unsigned char
{
	Left = 0x0,
	Right = 0x1,
	Bottom = 0x2
...
enum _HEAP_INFORMATION_CLASS:int
{
	HeapCompatibilityInformation = 0x0,
	HeapEnableTerminationOnCorruption = 0x1
};

enum EBlockCanary:unsigned char
{
	Zero = 0x0,
	Value = 0xE3
};

enum ETextHitPoint:unsigned char
{
	WithinText = 0x0,
	LeftGutter = 0x1,
	RightGutter = 0x2
...
enum EHangulTextWrappingMethod:unsigned char
{
	PerSyllable = 0x0,
	PerWord = 0x1
};

enum EAmbientOcclusionMethod:int
{
	Disabled = 0x0,
	SSAO = 0x1,
	SSGI = 0x2,
...
enum EVelocityPass:unsigned int
{
	Opaque = 0x0,
	Translucent = 0x1,
	Count = 0x2
...
enum ESkyAtmospherePassLocation:unsigned int
{
	BeforeOcclusion = 0x0,
	BeforeBasePass = 0x1
};

enum ETranslucencyView:int
{
	None = 0x0,
	UnderWater = 0x1,
	AboveWater = 0x2,
...
enum EHairStrandsCompositionType:unsigned char
{
...
enum EOITSortingType:int
{
	SortedTriangles = 0x0,
	SortedPixels = 0x1
};

enum FTriangleSortingOrder:int
{
	FrontToBack = 0x0,
	BackToFront = 0x1
};

enum ERayTracingPipelineCompatibilityFlags:int
{
	FullPipeline = 0x1,
	Inline = 0x2
};

enum ETextFilterExpressionType:unsigned char
{
	Invalid = 0x0,
	Empty = 0x1,
	BasicString = 0x2,
...
enum ETextFilterExpressionEvaluatorMode:unsigned char
{
	BasicString = 0x0,
	Complex = 0x1
};

enum EColorGradingModes:int
{
	Saturation = 0x0,
	Contrast = 0x1,
	Gamma = 0x2,
...
enum EColorPickerModes:int
{
	Spectrum = 0x0,
	Wheel = 0x1
};

enum ECustomizedToolMenuVisibility:int
{
	None = 0x0,
	Visible = 0x1,
	Hidden = 0x2
...
enum ERayTracingPrimaryRaysFlag:unsigned int
{
	None = 0x0,
...
enum ECbValidateMode:unsigned int
{
	None = 0x0,
	Default = 0x1,
	Names = 0x2,
...
enum ECbValidateError:unsigned int
{
	None = 0x0,
	OutOfBounds = 0x1,
	InvalidType = 0x2,
...
enum _PROC_THREAD_ATTRIBUTE_NUM:int
{
...
enum _LOGICAL_PROCESSOR_RELATIONSHIP:unsigned __int64
{
...
enum _MEMORY_RESOURCE_NOTIFICATION_TYPE:int
{
	LowMemoryResourceNotification = 0x0,
	HighMemoryResourceNotification = 0x1
};

enum _PROCESSOR_CACHE_TYPE:int
{
	CacheUnified = 0x0,
...
enum FGCLockBehavior:int
{
	Default = 0x0,
	Legacy = 0x1
};

enum EScreenProbeIndirectArgs:int
{
	GroupPerProbe = 0x0,
	ThreadPerProbe = 0x1,
	ThreadPerTrace = 0x2,
...
enum ERadiosityIndirectArgs:int
{
	NumTracesDiv64 = 0x0,
	NumTracesDiv32 = 0xC,
	ThreadPerProbe = 0x18,
...
enum EDownsampleQuality:unsigned char
{
	Low = 0x0,
	High = 0x1,
	MAX = 0x2
...
enum EFXAAQuality:unsigned int
{
	Q0 = 0x0,
	Q1 = 0x1,
	Q2 = 0x2,
...
enum EPathPermissionListType:int
{
	Default = 0x0,
	ClassPaths = 0x1
};

enum EBloomQuality:unsigned int
{
	Disabled = 0x0,
	Q1 = 0x1,
	Q2 = 0x2,
...
enum EByteBufferResourceType:int
{
	Float4_Buffer = 0x0,
...
enum EDownsampleFlags:unsigned char
{
	None = 0x0,
	ForceRaster = 0x1
};
...
enum _MINIDUMP_STREAM_TYPE:unsigned __int64
{
	UnusedStream = 0x0,
	ReservedStream0 = 0x1,
	ReservedStream1 = 0x2,
...
enum _MINIDUMP_TYPE:unsigned __int64
{
	MiniDumpNormal = 0x0,
...
enum ESceneRenderCleanUpMode:int
{
	Immediate = 0x0,
	Deferred = 0x1,
...
enum EShadowOcclusionQueryIntersectionMode:int
{
	SOQ_None = 0x0,
...
enum EUnicodeBlockRange:unsigned short
{
...
enum EDownsampleDepthFilter:int
{
	Point = 0x0,
	Max = 0x1,
	Checkerboard = 0x2,
...
enum EPluginDescriptorVersion:unsigned char
{
	Invalid = 0x0,
	Initial = 0x1,
	NameHash = 0x2,
...
enum EBitmapHeaderVersion:unsigned char
{
...
enum EBitmapCSType:unsigned int
{
...
enum EDecalDepthInputState:int
{
	DDS_Undefined = 0x0,
	DDS_Always = 0x1,
	DDS_DepthTest = 0x2,
...
enum EStrataTileType:unsigned int
{
	ESimple = 0x0,
	ESingle = 0x1,
	EComplex = 0x2,
...
enum EIndirectShadowingPrimitiveTypes:int
{
	CapsuleShapes = 0x0,
...
enum ECapsuleShadowingType:int
{
...
enum EShadowDepthCacheMode:int
{
...
enum EDynamicCustomDataPassType:unsigned char
{
	AllocationPass = 0x0,
	OutputPass = 0x1,
	MAX = 0x2
...
enum ESparseVolumePackedDataFormat:unsigned char
{
	Unorm8 = 0x0,
	Float16 = 0x1,
	Float32 = 0x2
...
enum EShadowMeshSelection:unsigned char
{
	SM = 0x1,
	VSM = 0x2,
	All = 0x3
...
enum EPipelineCacheFileFormatVersions:unsigned int
{
	FirstWorking = 0x7,
	LibraryID = 0x9,
	ShaderMetaData = 0xA,
...
enum EShadowProjectionVertexShaderFlags:int
{
	None = 0x0,
	DrawingFrustum = 0x1
};

enum EPropertyCollectFlags:unsigned int
{
	None = 0x0,
	SkipTransient = 0x1,
	NeedsReferencer = 0x2,
...
enum EPSOPrecacheStateMask:unsigned char
{
	None = 0x0,
	Compiling = 0x1,
	Succeeded = 0x2,
...
enum EEyeTrackerStatus:unsigned char
{
	NotConnected = 0x0,
	NotTracking = 0x1,
	Tracking = 0x2
...
enum EClusterPassInputType:unsigned char
{
	GBuffer = 0x0,
	Strata = 0x1,
	HairStrands = 0x2
...
enum EDecalRenderStage:unsigned char
{
	None = 0x0,
	BeforeBasePass = 0x1,
	BeforeLighting = 0x2,
...
enum EAOTechnique:int
{
	SSAO = 0x0,
	GTAO = 0x1
};

enum EDecalRenderTargetMode:unsigned char
{
	None = 0x0,
	DBuffer = 0x1,
...
enum EDecalDBufferMaskTechnique:int
{
	Disabled = 0x0,
	PerPixel = 0x1,
	WriteMask = 0x2
...
enum ERDGTransientResourceLifetimeState:int
{
	Deallocated = 0x0,
	Allocated = 0x1,
...
enum ERDGTextureAccessFlags:int
{
	None = 0x0,
	RenderTarget = 0x1
};

enum ELandscapeResizeMode:unsigned char
{
	Resample = 0x0,
	Clip = 0x1,
	Expand = 0x2
...
enum ESubLevelStripMode:unsigned char
{
	ExactClass = 0x0,
	IsChildOf = 0x1
};

enum ELightSourceShape:int
{
	Directional = 0x0,
	Capsule = 0x1,
	Rect = 0x2,
...
enum ECoreOnlineDummy:unsigned char
{
	Dummy = 0x0
};

enum ENaniteMaterialPass:unsigned int
{
	EmitGBuffer = 0x0,
...
enum _WINHTTP_REQUEST_STAT_ENTRY:int
{
...
enum _WINHTTP_REQUEST_TIME_ENTRY:int
{
...
enum CURLoption:unsigned __int64
{
...
enum FLightOcclusionType:unsigned char
{
	Shadowmap = 0x0,
	Raytraced = 0x1
};

enum EClearReplacementValueType:int
{
	Float = 0x0,
	Int32 = 0x1,
	Uint32 = 0x2
...
enum EClearReplacementResourceType:int
{
	Buffer = 0x0,
	Texture2D = 0x1,
	Texture2DArray = 0x2,
...
enum ELightShaftBloomOutput:int
{
	SceneColor = 0x0,
	SeparateTranslucency = 0x1
};

enum EWinHttpCallbackStatus:unsigned int
{
	ResolvingName = 0x1,
	NameResolved = 0x2,
...
enum ELightShaftTechnique:int
{
	Occlusion = 0x0,
	Bloom = 0x1
};

enum ECopyTextureResourceType:int
{
	Texture2D = 0x0,
	Texture2DArray = 0x1,
	Texture3D = 0x2
...
enum ECopyTextureValueType:int
{
	Float = 0x0,
	Int32 = 0x1,
	Uint32 = 0x2
...
enum EARSessionStatus:unsigned char
{
	NotStarted = 0x0,
	Running = 0x1,
	NotSupported = 0x2,
...
enum EARTrackingState:unsigned char
{
	Unknown = 0x0,
	Tracking = 0x1,
	NotTracking = 0x2,
...
enum EARCandidateImageOrientation:unsigned char
{
	Landscape = 0x0,
	Portrait = 0x1
};

enum EARObjectClassification:unsigned char
{
	NotApplicable = 0x0,
	Unknown = 0x1,
	Wall = 0x2,
...
enum EARSpatialMeshUsageFlags:unsigned char
{
	NotApplicable = 0x0,
	Visible = 0x1,
	Collision = 0x2
...
enum EARSessionConfigFlags:unsigned char
{
	None = 0x0,
...
enum EPlaneComponentDebugMode:unsigned char
{
	None = 0x0,
	ShowNetworkRole = 0x1,
...
enum EDeferredMaterialMode:int
{
	None = 0x0,
	Gather = 0x1,
	Shade = 0x2,
...
enum EFaceComponentDebugMode:unsigned char
{
	None = 0x0,
	ShowEyeVectors = 0x1,
	ShowFaceMesh = 0x2
...
enum EARFaceTransformMixing:unsigned char
{
	ComponentOnly = 0x0,
...
enum EImageComponentDebugMode:unsigned char
{
	None = 0x0,
	ShowDetectedImage = 0x1
};

enum EQRCodeComponentDebugMode:unsigned char
{
	None = 0x0,
	ShowQRCode = 0x1
};

enum EPoseComponentDebugMode:unsigned char
{
	None = 0x0,
	ShowSkeleton = 0x1
};
...
enum EGeoAnchorComponentDebugMode:unsigned char
{
	None = 0x0,
	ShowGeoData = 0x1
};

enum EARAltitudeSource:unsigned char
{
	Precise = 0x0,
	Coarse = 0x1,
	UserDefined = 0x2,
...
enum ESwapRootBone:unsigned char
{
...
enum EAnimExecutionContextConversionResult:unsigned char
{
	Succeeded = 0x1,
	Failed = 0x0
};

enum AnimPhysCollisionType:unsigned char
{
	CoM = 0x0,
	CustomSphere = 0x1,
	InnerSphere = 0x2,
...
enum AnimPhysLinearConstraintType:unsigned char
{
	Free = 0x0,
	Limited = 0x1
};

enum AnimPhysAngularConstraintType:unsigned char
{
	Angular = 0x0,
	Cone = 0x1
};

enum AnimPhysTwistAxis:unsigned char
{
	AxisX = 0x0,
	AxisY = 0x1,
	AxisZ = 0x2
...
enum ESphericalLimitType:unsigned char
{
	Inner = 0x0,
	Outer = 0x1
};

enum AnimPhysSimSpaceType:unsigned char
{
	Component = 0x0,
	Actor = 0x1,
	World = 0x2,
...
enum EARPlaneOrientation:unsigned char
{
	Horizontal = 0x0,
	Vertical = 0x1,
	Diagonal = 0x2
...
enum EARFaceBlendShape:unsigned char
{
	EyeBlinkLeft = 0x0,
	EyeLookDownLeft = 0x1,
	EyeLookInLeft = 0x2,
...
enum EAREye:unsigned char
{
	LeftEye = 0x0,
	RightEye = 0x1
};

enum EARTextureType:unsigned char
{
	Unknown = 0x0,
	CameraImage = 0x1,
	CameraDepth = 0x2,
...
enum EARJointTransformSpace:unsigned char
{
	Model = 0x0,
	ParentJoint = 0x1
};

enum EARWorldAlignment:unsigned char
{
	Gravity = 0x0,
...
enum EARSessionType:unsigned char
{
	None = 0x0,
	Orientation = 0x1,
	World = 0x2,
...
enum EARPlaneDetectionMode:unsigned char
{
	None = 0x0,
...
enum EARLightEstimationMode:unsigned char
{
	None = 0x0,
...
enum EARFrameSyncMode:unsigned char
{
	SyncTickWithCameraImage = 0x0,
	SyncTickWithoutCameraImage = 0x1
};

enum EAREnvironmentCaptureProbeType:unsigned char
{
	None = 0x0,
	Manual = 0x1,
	Automatic = 0x2
...
enum EARFaceTrackingDirection:unsigned char
{
	FaceRelative = 0x0,
	FaceMirrored = 0x1
};

enum EARFaceTrackingUpdate:unsigned char
{
	CurvesAndGeo = 0x0,
	CurvesOnly = 0x1
};

enum EARSessionTrackingFeature:unsigned char
{
	None = 0x0,
	PoseDetection2D = 0x1,
...
enum EARSceneReconstruction:unsigned char
{
	None = 0x0,
	MeshOnly = 0x1,
...
enum EARDepthQuality:unsigned char
{
	Unkown = 0x0,
	Low = 0x1,
	High = 0x2
...
enum EARDepthAccuracy:unsigned char
{
	Unkown = 0x0,
	Approximate = 0x1,
	Accurate = 0x2
...
enum EARTrackingQuality:unsigned char
{
	NotTracking = 0x0,
	OrientationOnly = 0x1,
	OrientationAndPosition = 0x2
...
enum EARCaptureType:unsigned char
{
	Camera = 0x0,
	QRCode = 0x1,
	SpatialMapping = 0x2,
...
enum EARLineTraceChannels:unsigned char
{
	None = 0x0,
	FeaturePoint = 0x1,
	GroundPlane = 0x2,
...
enum ESurfaceCacheCompression:unsigned char
{
	Disabled = 0x0,
	UAVAliasing = 0x1,
...
enum EARWorldMappingState:unsigned char
{
	NotAvailable = 0x0,
...
enum EInertializationBoneState:unsigned char
{
	Invalid = 0x0,
	Valid = 0x1,
	Excluded = 0x2
...
enum EInertializationSpace:unsigned char
{
	Default = 0x0,
	WorldSpace = 0x1,
	WorldRotation = 0x2
...
enum EInertializationState:unsigned char
{
	Inactive = 0x0,
	Pending = 0x1,
	Active = 0x2
...
enum EARGeoTrackingState:unsigned char
{
	Initializing = 0x0,
	Localized = 0x1,
	Localizing = 0x2,
...
enum EARGeoTrackingAccuracy:unsigned char
{
	Undetermined = 0x0,
	Low = 0x1,
	Medium = 0x2,
...
enum EAnimFunctionCallSite:int
{
	OnInitialize = 0x0,
	OnUpdate = 0x1,
...
enum ELumenIndirectLightingSteps:int
{
	None = 0x0,
...
enum EDiffuseIndirectMethod:int
{
	Disabled = 0x0,
	SSGI = 0x1,
	RTGI = 0x2,
...
enum ELayeredBoneBlendMode:unsigned char
{
	BranchFilter = 0x0,
	BlendMask = 0x1
};

enum EModifyCurveApplyMode:unsigned char
{
	Add = 0x0,
	Scale = 0x1,
	Blend = 0x2,
...
enum EMobileShadowQuality:unsigned char
{
	NoFiltering = 0x0,
	PCF_1x1 = 0x1,
	PCF_3x3 = 0x2,
...
enum EARServiceAvailability:unsigned char
{
	UnknownError = 0x0,
	UnknownChecking = 0x1,
	UnknownTimedOut = 0x2,
...
enum EARServiceInstallRequestResult:unsigned char
{
	Installed = 0x0,
...
enum EARServicePermissionRequestResult:unsigned char
{
	Granted = 0x0,
	Denied = 0x1
};

enum ERBFDistanceMethod:unsigned char
{
	Euclidean = 0x0,
	Quaternion = 0x1,
	SwingAngle = 0x2,
...
enum ERBFFunctionType:unsigned char
{
	Gaussian = 0x0,
	Exponential = 0x1,
	Linear = 0x2,
...
enum EPoseDriverSource:unsigned char
{
	Rotation = 0x0,
	Translation = 0x1
};

enum EPoseDriverOutput:unsigned char
{
	DrivePoses = 0x0,
	DriveCurves = 0x1
};

enum ERBFSolverType:unsigned char
{
	Additive = 0x0,
	Interpolative = 0x1
};

enum ERBFNormalizeMethod:unsigned char
{
...
enum EPoseDriverType:unsigned char
{
	SwingAndTwist = 0x0,
	SwingOnly = 0x1,
	Translation = 0x2
...
enum ESnapshotSourceMode:unsigned char
{
	NamedSnapshot = 0x0,
	SnapshotPin = 0x1
};

enum ERandomDataIndexType:int
{
	Current = 0x0,
	Next = 0x1
};

enum ChaosDeformableSimSpace:unsigned char
{
	World = 0x0,
	ComponentXf = 0x1,
	Bone = 0x2
...
enum EVRSGenerationFlags:unsigned int
{
	None = 0x0,
	StereoRendering = 0x1,
...
enum EHairStrandsCommonPassType:int
{
	Composition = 0x0,
	DOF = 0x1,
	TAAFastResolve = 0x2,
...
enum EDrivenBoneModificationMode:unsigned char
{
	AddToInput = 0x0,
...
enum EDrivenDestinationMode:unsigned char
{
	Bone = 0x0,
	MorphTarget = 0x1,
...
enum EConstraintOffsetOption:unsigned char
{
	None = 0x0,
	Offset_RefPose = 0x1
};

enum CopyBoneDeltaMode:unsigned char
{
	Accumulate = 0x0,
	Copy = 0x1
};

enum ESimulationSpace:unsigned char
{
	ComponentSpace = 0x0,
	WorldSpace = 0x1,
	BaseBoneSpace = 0x2
...
enum ESimulationTiming:unsigned char
{
	Default = 0x0,
	Synchronous = 0x1,
	Deferred = 0x2
...
enum EScaleChainInitialLength:unsigned char
{
...
enum ESplineBoneAxis:unsigned char
{
	None = 0x0,
	X = 0x1,
	Y = 0x2,
...
enum EHairStrandsRasterPassType:unsigned char
{
	FrontDepth = 0x0,
	DeepOpacityMap = 0x1
};

enum EHairLightingIntegrationType:unsigned char
{
	SceneColor = 0x0,
	AdHoc = 0x1,
	Uniform = 0x2,
...
enum EHairLightingSourceType:unsigned char
{
	SceneColor = 0x0,
	ReflectionProbe = 0x1,
	Lumen = 0x2,
...
enum ELumenSurfaceCacheLayer:unsigned char
{
	Depth = 0x0,
	Albedo = 0x1,
	Opacity = 0x2,
...
enum ERTDrawingType:unsigned char
{
	RTAtlas = 0x0,
...
enum EHeightmapRTType:unsigned char
{
...
enum EWeightmapRTType:unsigned char
{
...
enum EScreenProbeIrradianceFormat:unsigned char
{
	SH3 = 0x0,
	Octahedral = 0x1,
	MAX = 0x2
...
enum ELandscapeGizmoSnapType:int
{
	None = 0x0,
	Component = 0x1,
	Texel = 0x2
...
enum EGrassScaling:unsigned char
{
	Uniform = 0x0,
	Free = 0x1,
	LockXY = 0x2
...
enum EGrassSurfaceFilter:unsigned char
{
	UpOnly = 0x0,
	DownOnly = 0x1,
	All = 0x2
...
enum EHairVisibilityVendor:int
{
...
enum EScreenProbeIntegrateTileClassification:int
{
	SimpleDiffuse = 0x0,
...
enum EHairVisibilityRenderMode:int
{
...
enum ECompactedTracingIndirectArgs:int
{
	NumTracesDiv64 = 0x0,
	NumTracesDiv32 = 0xC,
...
enum ERayTracingViewMaskMode:unsigned char
{
	RayTracing = 0x0,
	PathTracing = 0x1,
	LightMapTracing = 0x2
...
enum ETemporalDenoisingMode:unsigned int
{
	ETDM_DISABLED = 0x0,
	ETDM_OFFLINE = 0x1,
	ETDM_ONLINE = 0x2,
...
enum ETemporalDenoiserType:int
{
	NONE = 0xFF,
...
enum ETemporalDenoiserMotionVectorType:int
{
	NONE = 0xFF,
	BUILTIN = 0x0,
	PLUGIN = 0x1,
...
enum EFeatureFusionCategory:unsigned int
{
	SOURCE = 0x0,
	TARGET = 0x1,
	MAX = 0x2
...
enum ESubsurfaceMode:unsigned int
{
	FullRes = 0x0,
	HalfRes = 0x1,
	Bypass = 0x2,
...
enum EMeshTrackerVertexColorMode:unsigned char
{
	None = 0x0,
	Confidence = 0x1,
	Block = 0x2
...
enum EVirtualShadowMapProjectionInputType:int
{
	GBuffer = 0x0,
	HairStrands = 0x1
};

enum EHairTransmittancePassType:unsigned char
{
	PerLight = 0x0,
	OnePass = 0x1
};

enum EWindSourceType:unsigned char
{
	Directional = 0x0,
	Point = 0x1
};

enum EGPUSkinCacheEntryMode:int
{
	Raster = 0x0,
	RayTracing = 0x1
};
...
enum EHairAuxilaryPassType:int
{
	MaterialData = 0x0,
...
enum ELevelVisibility:unsigned char
{
	Visible = 0x0,
	Hidden = 0x1
};

enum EWidgetBlendMode:unsigned char
{
	Opaque = 0x0,
	Masked = 0x1,
	Transparent = 0x2
...
enum EWidgetSpace:unsigned char
{
	World = 0x0,
	Screen = 0x1
};

enum EWidgetGeometryMode:unsigned char
{
	Plane = 0x0,
	Cylinder = 0x1
};

enum EWindowVisibility:unsigned char
{
	Visible = 0x0,
	SelfHitTestInvisible = 0x1
};

enum ETickMode:unsigned char
{
	Disabled = 0x0,
	Enabled = 0x1,
	Automatic = 0x2
...
enum EWidgetTimingPolicy:unsigned char
{
	RealTime = 0x0,
	GameTime = 0x1
};

enum EVoxelizeShapeMode:int
{
	VMode_Primitive_Sphere = 0x0,
	VMode_Object_Box = 0x1
};

enum EDistanceFieldPrimitiveType:int
{
...
enum EDistanceFieldShadowingType:int
{
...
enum EVolumetricCloudRenderViewPsPermutations:int
{
...
enum EOutputFormat:int
{
	LDR_GAMMA_32 = 0x0,
	HDR_LINEAR_64 = 0x1
};

enum EVolumetricCloudTracingMaxDistanceMode:unsigned char
{
	DistanceFromCloudLayerEntryPoint = 0x0,
	DistanceFromPointOfView = 0x1
};

enum EPhysXFilterDataFlags:int
{
...
enum ESimulationInitializationState:unsigned char
{
	Unintialized = 0x0,
	Activated = 0x1,
	Created = 0x2,
...
enum ECollectionAttributeEnum:unsigned char
{
	Chaos_Active = 0x0,
	Chaos_DynamicState = 0x1,
...
enum ECollectionGroupEnum:unsigned char
{
	Chaos_Traansform = 0x0,
	Chaos_Max = 0x1
};

enum EChaosCollisionSortMethod:unsigned char
{
	SortNone = 0x0,
...
enum EChaosBreakingSortMethod:unsigned char
{
	SortNone = 0x0,
	SortByHighestMass = 0x1,
	SortByHighestSpeed = 0x2,
...
enum EChaosTrailingSortMethod:unsigned char
{
	SortNone = 0x0,
	SortByHighestMass = 0x1,
	SortByHighestSpeed = 0x2,
...
enum EChaosRemovalSortMethod:unsigned char
{
	SortNone = 0x0,
	SortByHighestMass = 0x1,
...
enum EPhysicsInterfaceScopedLockType:unsigned char
{
	Read = 0x0,
	Write = 0x1
};

enum EGeometryCollectionDebugDrawActorHideGeometry:unsigned char
{
	HideNone = 0x0,
...
enum FMaterialGPUMessageFlags:unsigned int
{
	None = 0x0,
...
enum EIcmpEchoManyStatus:unsigned char
{
	Invalid = 0x0,
	Success = 0x1,
	Failure = 0x2,
...
enum ESplineModulationColorMask:unsigned char
{
	Red = 0x0,
	Green = 0x1,
	Blue = 0x2,
...
enum ELandscapeDirtyingMode:unsigned char
{
	Auto = 0x0,
...
enum EAnalyticsSessionShutdownType:int
{
	Shutdown = 0x0,
	Terminated = 0x1,
	Debugged = 0x2,
...
enum ESslTlsProtocol:unsigned char
{
	Minimum = 0x0,
	SSLv2 = 0x0,
	SSLv3 = 0x1,
...
enum _PinDirection:int
{
	PINDIR_INPUT = 0x0,
	PINDIR_OUTPUT = 0x1
};

enum _FilterState:int
{
	State_Stopped = 0x0,
	State_Paused = 0x1,
	State_Running = 0x2
...
enum tagQualityMessageType:int
{
	Famine = 0x0,
	Flood = 0x1
};

enum tagAnalogVideoStandard:unsigned __int64
{
...
enum tagPhysicalConnectorType:int
{
...
enum tagVideoProcAmpProperty:int
{
...
enum tagCameraControlProperty:int
{
...
enum AMPROPERTY_PIN:int
{
	AMPROPERTY_PIN_CATEGORY = 0x0,
	AMPROPERTY_PIN_MEDIUM = 0x1
};

enum _AM_AUDIO_RENDERER_STAT_PARAM:int
{
...
enum VIDEOENCODER_BITRATE_MODE:int
{
	ConstantBitRate = 0x0,
...
enum VMR_ASPECT_RATIO_MODE:int
{
	VMR_ARMODE_NONE = 0x0,
	VMR_ARMODE_LETTER_BOX = 0x1
};

enum EMobileBasePass:int
{
	Opaque = 0x0,
	Translucent = 0x1
};

enum EOpusMode:unsigned char
{
	File = 0x0,
	AudioStream = 0x1,
	VoiceStream = 0x2
...
enum EOpusFrameSizes:unsigned char
{
	Min = 0x0,
	Small = 0x1,
	MediumLow = 0x2,
...
enum MovieScene3DPathSection_Axis:unsigned char
{
	X = 0x0,
	Y = 0x1,
	Z = 0x2,
...
enum EGainParamMode:unsigned char
{
	Linear = 0x0,
	Decibels = 0x1
};

enum EParticleSystemInsignificanceReaction:unsigned char
{
	Auto = 0x0,
	Complete = 0x1,
	DisableTick = 0x2,
...
enum ECameraShakeAttenuation:unsigned char
{
	Linear = 0x0,
	Quadratic = 0x1
};

enum ECameraShakeSourceShakeStatus:unsigned char
{
	NotStarted = 0x0,
	Started = 0x1,
	BlendingOut = 0x2
...
enum EParticleKey:unsigned char
{
	Activate = 0x0,
	Deactivate = 0x1,
	Trigger = 0x2
...
enum ECustomDataRowCountMethod:int
{
	RCM_Constant = 0x0,
	RCM_ScalarParam = 0x1,
...
enum EDecalsWriteFlags:unsigned int
{
	None = 0x0,
	BaseColor = 0x1,
	Normal = 0x2,
...
enum ERayTracingInstanceMaskType:unsigned char
{
	Opaque = 0x0,
	Translucent = 0x1,
	ThinShadow = 0x2,
...
enum EMessageTracerDispatchTypes:int
{
	Direct = 0x0,
	Pending = 0x1,
	TaskGraph = 0x2
...
enum EHttpConnectionContextState:int
{
	Continue = 0x0,
	Done = 0x1,
	Error = 0x2
...
enum EMediaAudioSampleFormat:int
{
	Undefined = 0x0,
	Double = 0x1,
	Float = 0x2,
...
enum EAnimNodeInitializationStatus:int
{
	NotUpdated = 0x0,
	InitialUpdate = 0x1,
	Updated = 0x2
...
enum EMediaOverlaySampleType:int
{
	Caption = 0x0,
	Subtitle = 0x1,
	Text = 0x2
...
enum ECompactedReflectionTracingIndirectArgs:int
{
	NumTracesDiv64 = 0x0,
	NumTracesDiv32 = 0xC,
	MAX = 0x2
...
enum ELumenDispatchCardTilesIndirectArgsOffset:int
{
...
enum EHttpReplayResult:unsigned int
{
	Success = 0x0,
	FailedJsonParse = 0x1,
	DataUnavailable = 0x2,
...
enum EVisibilityTrackAction:int
{
	EVTA_Hide = 0x0,
	EVTA_Show = 0x1,
	EVTA_Toggle = 0x2,
...
enum EVisibilityTrackCondition:int
{
	EVTC_Always = 0x0,
...
enum EInterpTrackMoveRotMode:int
{
	IMR_Keyframed = 0x0,
	IMR_LookAtGroup = 0x1,
	IMR_Ignore = 0x2,
...
enum ETrackActiveCondition:int
{
	ETAC_Always = 0x0,
...
enum ENetSubObjectStatus:unsigned char
{
	Active = 0x0,
	TearOff = 0x1,
	Delete = 0x2
...
enum EDerivedDataCacheStatus:int
{
	None = 0x0,
	Information = 0x1,
	Warning = 0x2,
...
enum EWidgetInteractionSource:unsigned char
{
	World = 0x0,
	Mouse = 0x1,
	CenterScreen = 0x2,
...
enum ESkyAtmosphereTransformMode:unsigned char
{
...
enum EAssetDataCanBeSubobject:int
{
	Yes = 0x0,
	No = 0x1
};

enum ELightMapVirtualTextureType:int
{
	LightmapLayer0 = 0x0,
	LightmapLayer1 = 0x1,
	ShadowMask = 0x2,
...
enum EComputeNTBsOptions:unsigned int
{
	None = 0x0,
	Normals = 0x1,
	Tangents = 0x2,
...
enum EMotionBlurQuality:unsigned int
{
	Low = 0x0,
	Medium = 0x1,
	High = 0x2,
...
enum EMotionBlurFilter:unsigned int
{
	Unified = 0x0,
	Separable = 0x1
};

enum ELensFlareQuality:unsigned int
{
	Disabled = 0x0,
	Low = 0x1,
	High = 0x2,
...
enum EBloomSetupOutputType:unsigned int
{
	Bloom = 0x1,
	SunShaftAndDof = 0x2,
	EyeAdaptation = 0x4
...
enum EBoneSocketSourceIndexMode:unsigned char
{
	SourceLocations = 0x0,
...
enum EDDSCaps:unsigned __int64
{
	DDSC_CubeMap = 0x200,
...
enum FDataDrivenCVarType:unsigned char
{
	CVarFloat = 0x0,
	CVarInt = 0x1,
	CVarBool = 0x2
...
enum EDiffPropertiesFlags:unsigned int
{
	None = 0x0,
	Sync = 0x1,
...
enum EMotionBlurVelocityScatterPass:unsigned int
{
	DrawMin = 0x0,
	DrawMax = 0x1,
	MAX = 0x2
...
enum EShadowDepthVertexShaderMode:int
{
...
enum EShadowDepthPixelShaderMode:int
{
...
enum EPreviousBoneTransformUpdateMode:int
{
	None = 0x0,
	UpdatePrevious = 0x1,
...
enum ELandscapeImportAlphamapType:unsigned char
{
	Additive = 0x0,
	Layered = 0x1
};

enum ELandscapeLayerPaintingRestriction:unsigned char
{
	None = 0x0,
	UseMaxLayers = 0x1,
	ExistingOnly = 0x2,
...
enum ELandscapeLayerDisplayMode:unsigned char
{
	Default = 0x0,
	Alphabetical = 0x1,
	UserSpecific = 0x2
...
enum EInterpTrackParticleReplayDragType:int
{
	PRDT_LeftEdge = 0xA,
	PRDT_RightEdge = 0xB
};

enum EInterpTrackAnimControlDragType:int
{
	ACDT_AnimBlockLeftEdge = 0x0,
	ACDT_AnimBlockRightEdge = 0x1
};

enum EGPUSortTest:int
{
...
enum ESlateGesture:unsigned char
{
	None = 0x0,
	Scroll = 0x1,
	Magnify = 0x2,
...
enum EAddComponentResult:unsigned char
{
	Fail = 0x0,
...
enum EDispatchComputeRenderSlot:unsigned char
{
	CRS_None = 0x0,
	CRS_PreRender = 0x1,
	CRS_PostOpaque = 0x2,
...
enum EFrameNumberDisplayFormats:unsigned char
{
...
enum EAnimPropertyAccessCallSite:int
{
...
enum EInterpToBehaviourType:unsigned char
{
	OneShot = 0x0,
	OneShot_Reverse = 0x1,
	Loop_Reset = 0x2,
...
enum ESkelAnimRotationOrder:int
{
	XYZ = 0x0,
	XZY = 0x1,
	YXZ = 0x2,
...
enum EPcmBitDepthConversion:unsigned char
{
	SameAsSource = 0x0,
	Int16 = 0x1,
	Float32 = 0x2
...
enum ESyncOption:unsigned char
{
	Drive = 0x0,
	Passive = 0x1,
	Disabled = 0x2
...
enum ESparseVolumeTextureShaderUniform:int
{
...
enum EGameUserSettingsVersion:int
{
...
enum EMovieScene2DTransformChannel:unsigned int
{
	None = 0x0,
	TranslationX = 0x1,
	TranslationY = 0x2,
...
enum ETextureEncodeEffort:unsigned char
{
	Default = 0x0,
	Low = 0xA,
	Normal = 0x14,
...
enum ETextureUniversalTiling:unsigned char
{
	Disabled = 0x0,
	Enabled_256KB = 0x1,
	Enabled_64KB = 0x2
...
enum EDynamicBoxType:unsigned char
{
	Horizontal = 0x0,
	Vertical = 0x1,
	Wrap = 0x2,
...
enum EVirtualTextureCodec:unsigned char
{
	Black = 0x0,
	OpaqueBlack = 0x1,
	White = 0x2,
...
enum EGPUSkinCacheDispatchFlags:int
{
	DispatchPrevPosition = 0x1,
	DispatchPosition = 0x2
};

enum ERootParameterKeys:int
{
	PS_SRVs = 0x0,
	PS_CBVs = 0x1,
	PS_RootCBVs = 0x2,
...
enum ViewSubresourceSubsetFlags:int
{
...
enum EResourceAllocationStrategy:int
{
	kPlacedResource = 0x0,
	kManualSubAllocation = 0x1
};

enum ERHIPoolResourceTypes:int
{
	Buffers = 0x1,
	RTDSTextures = 0x2,
	NonRTDSTextures = 0x4,
...
enum ERHITransientHeapFlags:unsigned char
{
	AllowBuffers = 0x1,
	AllowTextures = 0x2,
...
enum EDynamicParameterUpdateFlags:int
{
...
enum EGizmoElementState:unsigned char
{
	None = 0x0,
	Visible = 0x2,
	Hittable = 0x4,
...
enum EGizmoElementInteractionState:int
{
	None = 0x0,
	Hovering = 0x1,
	Interacting = 0x2
...
enum EGizmoElementViewDependentType:int
{
	None = 0x0,
	Axis = 0x1,
	Plane = 0x2
...
enum EGizmoElementViewAlignType:int
{
	None = 0x0,
	PointOnly = 0x1,
	PointEye = 0x2,
...
enum EGizmoElementPartialType:int
{
	None = 0x0,
	Partial = 0x1,
...
enum EGizmoElementArrowHeadType:int
{
	Cone = 0x0,
	Cube = 0x1
};

enum EOverlaysFileType:int
{
	Unknown = 0x0,
	SubRipSubtitles = 0x1
};

enum EAudioDeviceChangedRole:unsigned char
{
	Invalid = 0x0,
	Console = 0x1,
	Multimedia = 0x2,
...
enum EAudioDeviceChangedState:unsigned char
{
	Invalid = 0x0,
	Active = 0x1,
	Disabled = 0x2,
...
enum EClothingWindMethod_Legacy:unsigned char
{
	Legacy = 0x0,
	Accurate = 0x1
};

enum EWeightMapTargetCommon:unsigned char
{
	None = 0x0,
	MaxDistance = 0x1,
...
enum EClothMassMode:unsigned char
{
	UniformMass = 0x0,
	TotalMass = 0x1,
	Density = 0x2,
...
enum EVectorVMBaseTypes:unsigned char
{
	Float = 0x0,
	Int = 0x1,
	Bool = 0x2,
...
enum GFSDK_Aftermath_Context_Status:unsigned int
{
...
enum EMediaAudioCaptureDeviceFilter:unsigned char
{
	None = 0x0,
	Card = 0x1,
	Microphone = 0x2,
...
enum EMediaVideoCaptureDeviceFilter:unsigned char
{
	None = 0x0,
	Card = 0x1,
	Software = 0x2,
...
enum EMediaWebcamCaptureDeviceFilter:unsigned char
{
	None = 0x0,
	DepthSensor = 0x1,
	Front = 0x2,
...
enum EMediaCaptureDeviceType:unsigned int
{
	Unknown = 0x0,
	Audio = 0x1,
	AudioCard = 0x2,
...
enum ERigVMBreakpointAction:unsigned char
{
	None = 0x0,
	Resume = 0x1,
	StepOver = 0x2,
...
enum CrowdBoundaryFlags:int
{
	DT_CROWD_BOUNDARY_IGNORE = 0x1
};

enum dtStraightPathFlags:int
{
...
enum dtCompressedTileFlags:int
{
	DT_COMPRESSEDTILE_FREE_DATA = 0x1
};

enum dtRegionPartitioning:int
{
...
enum dtTileFlags:int
{
	DT_TILE_FREE_DATA = 0x1
};

enum duDebugDrawPrimitives:int
{
	DU_DRAW_POINTS = 0x0,
	DU_DRAW_LINES = 0x1,
	DU_DRAW_TRIS = 0x2,
...
enum BINKPLUGINDRAWFLAGS:unsigned __int64
{
	BinkDrawDecodeSRGB = 0x80000000
};

enum BINKPLUGINAPI:int
{
	BinkRHI = 0x0
};
...
enum GFSDK_Aftermath_GpuCrashDumpWatchedApiFlags:unsigned int
{
...
enum GFSDK_Aftermath_GpuCrashDumpFeatureFlags:unsigned int
{
...
enum EImageOwnerType:unsigned char
{
	None = 0x0,
	LocalOwner = 0x1,
	ExternalOwner = 0x2,
...
enum ELiveLinkCameraProjectionMode:unsigned char
{
	Perspective = 0x0,
	Orthographic = 0x1
};
...
enum EBLASBuildDataUsage:int
{
	Rendering = 0x0,
	Size = 0x1
};

enum ERayTracingBufferType:int
{
	AccelerationStructure = 0x0,
	Scratch = 0x1
};

enum GFSDK_Aftermath_GpuCrashDumpDecoderFlags:unsigned int
{
...
enum GFSDK_Aftermath_GpuCrashDumpFormatterFlags:unsigned int
{
...
enum GFSDK_Aftermath_GpuCrashDumpDescriptionKey:unsigned int
{
...
enum GFSDK_Aftermath_ShaderType:unsigned int
{
...
enum GFSDK_Aftermath_GraphicsApi:unsigned int
{
...
enum ENavSystemOverridePolicy:unsigned char
{
	Override = 0x0,
	Append = 0x1,
	Skip = 0x2
...
enum EReverseForEachResult:unsigned char
{
	UnTouched = 0x0,
	Modified = 0x1
};

enum EGatherTilesCopyMode:int
{
	NoCopy = 0x0,
	CopyData = 0x1,
	CopyCacheData = 0x2,
...
enum ELocalFileChunkType:unsigned int
{
	Header = 0x0,
	ReplayData = 0x1,
	Checkpoint = 0x2,
...
enum EDelayAcquireImageType:int
{
	None = 0x0,
	DelayAcquire = 0x1,
	LazyAcquire = 0x2
...
enum EGameplayTagSourceType:unsigned char
{
	Native = 0x0,
	DefaultTagList = 0x1,
	TagList = 0x2,
...
enum EReadReplayInfoFlags:unsigned int
{
	None = 0x0,
	SkipHeaderChunkTest = 0x1
};

enum ENativeGameplayTagToken:int
{
	PRIVATE_USE_MACRO_INSTEAD = 0x0
};

enum ELocalFileReplayResult:unsigned int
{
	Success = 0x0,
...
enum ENavMeshDetailFlags:unsigned char
{
	TriangleEdges = 0x0,
	PolyEdges = 0x1,
	BoundaryEdges = 0x2,
...
enum EForEachResult:unsigned char
{
	Break = 0x0,
	Continue = 0x1
};

enum EGameplayTagSelectionType:unsigned char
{
	None = 0x0,
...
enum EGameplayDebuggerShape:unsigned char
{
	Invalid = 0x0,
	Point = 0x1,
	Segment = 0x2,
...
enum EGameplayDebuggerDataPack:unsigned char
{
	Persistent = 0x0,
...
enum EGameplayDebuggerInputMode:unsigned char
{
	Local = 0x0,
	Replicated = 0x1
};
...
enum EGameplayDebuggerCategoryState:unsigned char
{
...
enum EEnvTestDot:unsigned char
{
	Dot3D = 0x0,
	Dot2D = 0x1
};

enum EGameplayDebuggerOverrideMode:unsigned char
{
	Enable = 0x0,
	Disable = 0x1,
	UseDefault = 0x2
...
enum EBTDecoratorAbortRequest:unsigned char
{
	ConditionResultChanged = 0x0,
	ConditionPassing = 0x1
};

enum EMetaPathUpdateReason:unsigned char
{
	PathFinished = 0x0,
	MoveTick = 0x1
};

enum ECrowdSimulationState:unsigned char
{
	Enabled = 0x0,
	ObstacleOnly = 0x1,
	Disabled = 0x2
...
enum EMovieSceneCaptureProtocolState:unsigned char
{
	Idle = 0x0,
	Initialized = 0x1,
	Capturing = 0x2,
...
enum EStringParserToken:unsigned char
{
	OpenTag = 0x0,
	CloseTag = 0x1,
	NewLine = 0x2,
...
enum EWorldContentState:int
{
	NoContent = 0x0,
	ContentBundleInjected = 0x1
};

enum EContentBundleClientState:int
{
	Unregistered = 0x0,
	Registered = 0x1,
...
enum ELevelInstanceCreationType:unsigned char
{
	LevelInstance = 0x0,
	PackedLevelActor = 0x1
};

enum ELevelInstancePivotType:unsigned char
{
	CenterMinZ = 0x0,
	Center = 0x1,
	Actor = 0x2,
...
enum ELevelInstanceRuntimeBehavior:unsigned char
{
	None = 0x0,
...
enum ESplatBlendOp:unsigned char
{
	SBO_None = 0x0,
	SBO_Min = 0x1,
	SBO_Max = 0x2,
...
enum EParticleUVFlipMode:unsigned char
{
	None = 0x0,
	FlipUV = 0x1,
	FlipUOnly = 0x2,
...
enum EPropertyAccessSegmentFlags:unsigned short
{
	Unresolved = 0x0,
	Struct = 0x1,
	Leaf = 0x2,
	...
	ArrayOfStructs = 0x7,
	ArrayOfObjects = 0x8,
	LastExclusiveValue = 0x8,
	Function = 0xFFFF8000,
	ModifierFlags = 0xFFFF8000
};

enum EPropertyAccessCopyType:unsigned char
{
	None = 0x0,
	Plain = 0x1,
	Complex = 0x2,
...
enum EPropertyAccessObjectType:unsigned char
{
	None = 0x0,
	Object = 0x1,
	WeakObject = 0x2,
...
enum EPropertyAccessIndirectionType:unsigned char
{
	Offset = 0x0,
	Object = 0x1,
	Array = 0x2,
...
enum ESingleMultiOrTest:unsigned char
{
	Single = 0x0,
	Multi = 0x1,
	Test = 0x2
...
enum ESweepOrRay:unsigned char
{
	Raycast = 0x0,
	Sweep = 0x1
};
...
enum EFrameHitchType:unsigned char
{
	NoHitch = 0x0,
	UnknownUnit = 0x1,
	GameThread = 0x2,
...
enum ETemperatureSeverityType:unsigned char
{
	Unknown = 0x0,
	Good = 0x1,
	Bad = 0x2,
...
enum EDynamicResolutionStateEvent:unsigned char
{
	BeginFrame = 0x0,
...
enum EPinResolveType:unsigned char
{
	OwningNode = 0x0,
	LinkedTo = 0x1,
	SubPins = 0x2,
...
enum EHLODLayerType:unsigned char
{
	Instancing = 0x0,
	MeshMerge = 0x1,
	MeshSimplify = 0x2,
...
enum ETransferPersistentDataMode:unsigned char
{
	Move = 0x0,
	Copy = 0x1
};

enum EPinResolveResult:unsigned char
{
	FailedParse = 0x0,
	FailedSafely = 0x1,
	Deferred = 0x2,
...
enum EParticleCollisionShaderMode:int
{
	PCM_None = 0x0,
	PCM_DepthBuffer = 0x1,
...
enum EVertexPaintAxis:unsigned char
{
	X = 0x0,
	Y = 0x1,
	Z = 0x2
...
enum EPropertyAccessCopyBatch:unsigned char
{
...
enum EBuildPatchDataType:int
{
	ChunkData = 0x0,
	FileData = 0x1
};

enum EConstructionError:unsigned char
{
	None = 0x0,
...
enum EInstallBundleManagerInitResult:int
{
	OK = 0x0,
...
enum EInstallBundleManagerPatchCheckResult:unsigned int
{
	NoPatchRequired = 0x0,
...
enum EInstallBundlePauseFlags:unsigned int
{
	None = 0x0,
...
enum EInstallBundleCacheReserveResult:signed char
{
	Fail_CacheFull = 0x0,
	Fail_NeedsEvict = 0x1,
...
enum EInstallBundleReleaseResult:int
{
	OK = 0x0,
...
enum EInstallBundleRequestInfoFlags:int
{
	None = 0x0,
	EnqueuedBundles = 0x1,
...
enum EInstallBundleSourceUpdateBundleInfoResult:unsigned char
{
	OK = 0x0,
	NotInitailized = 0x1,
	AlreadyMounted = 0x2,
...
enum EOpenGLCurrentContext:int
{
	CONTEXT_Other = 0xFE,
...
enum EOpenGLShaderTargetPlatform:int
{
	OGLSTP_Unknown = 0x0,
	OGLSTP_Desktop = 0x1,
	OGLSTP_Android = 0x2,
...
enum EOpenGLFormatCapabilities:unsigned int
{
	None = 0x0,
	Texture = 0x1,
	Render = 0x2,
...
enum EClothingWindMethodNv:unsigned char
{
	Legacy = 0x0,
	Accurate = 0x1
};

enum _NvAPI_Status:unsigned __int64
{
	NVAPI_OK = 0x0,
	NVAPI_ERROR = 0xFF,
...
enum NV_STATIC_METADATA_DESCRIPTOR_ID:int
{
...
enum GFSDK_Aftermath_Version:unsigned int
{
	GFSDK_Aftermath_Version_API = 0x212
};

enum GFSDK_Aftermath_FeatureFlags:unsigned int
{
...
enum GFSDK_Aftermath_Result:unsigned int
{
...
enum EStreamReadRequestStatus:int
{
	Scheduled = 0x0,
	Completed = 0x1,
	Cancelled = 0x2
...
enum AGSDriverVersionResult:int
{
...
enum ERigUnitDebugPointMode:unsigned char
{
	Point = 0x0,
	Vector = 0x1,
	Max = 0x2
...
enum ERigUnitVisualDebugPointMode:unsigned char
{
	Point = 0x0,
	Vector = 0x1,
	Max = 0x2
...
enum ERigUnitDebugTransformMode:unsigned char
{
	Point = 0x0,
	Axes = 0x1,
	Box = 0x2,
...
enum ERBFKernelType:unsigned char
{
	Gaussian = 0x0,
	Exponential = 0x1,
	Linear = 0x2,
...
enum ERBFVectorDistanceType:unsigned char
{
	Euclidean = 0x0,
	Manhattan = 0x1,
	ArcLength = 0x2
...
enum EAISenseNotifyType:unsigned char
{
...
enum FAIDistanceType:unsigned char
{
	Distance3D = 0x0,
	Distance2D = 0x1,
	DistanceZ = 0x2,
...
enum EGenericAICheck:unsigned char
{
	Less = 0x0,
	LessOrEqual = 0x1,
	Equal = 0x2,
...
enum EAIParamType:unsigned char
{
	Float = 0x0,
	Int = 0x1,
	Bool = 0x2,
...
enum EAITaskPriority:unsigned char
{
	Lowest = 0x0,
	Low = 0x40,
	AutonomousAI = 0x7F,
...
enum ESingleThreadedPSOCreateMode:int
{
	None = 0x0,
	All = 0x1,
	Precompile = 0x2,
...
enum EEQSNormalizationType:unsigned char
{
	Absolute = 0x0,
	RelativeToScores = 0x1
};

enum EPawnActionTaskResult:unsigned char
{
	Unknown = 0x0,
	TaskFinished = 0x1,
	TaskAborted = 0x2,
...
enum EEnvQueryHightlightMode:unsigned char
{
	All = 0x0,
	Best5Pct = 0x1,
	Best25Pct = 0x2
...
enum EPointOnCircleSpacingMethod:unsigned char
{
	BySpaceBetween = 0x0,
	ByNumberOfPoints = 0x1
};

enum BINKPLUGINSNDTRACK:int
{
	BinkSndNone = 0x0,
	BinkSndSimple = 0x1,
