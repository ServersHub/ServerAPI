...
struct FXxHash64
{
	[[nodiscard]] static FXxHash64 HashBuffer(FMemoryView View);
	[[nodiscard]] static FXxHash64 HashBuffer(const void* Data, uint64 Size);
	[[nodiscard]] static FXxHash64 HashBuffer(const FCompositeBuffer& Buffer);
...
{
public:
	[[nodiscard]] static FXxHash128 HashBuffer(FMemoryView View);
	[[nodiscard]] static FXxHash128 HashBuffer(const void* Data, uint64 Size);
	[[nodiscard]] static FXxHash128 HashBuffer(const FCompositeBuffer& Buffer);
...
public:
	...
	[[nodiscard]] FXxHash64 Finalize() const;
...
public:
	...
	[[nodiscard]] FXxHash128 Finalize() const;
