...
namespace SSE
{
	...
	VectorRegister4Float sin_ps    (VectorRegister4Float x);
	VectorRegister4Float cos_ps    (VectorRegister4Float x);
	void                 sincos_ps (VectorRegister4Float x, VectorRegister4Float* s, VectorRegister4Float* c);
	VectorRegister4Float log_ps    (VectorRegister4Float x);
	VectorRegister4Float exp_ps    (VectorRegister4Float x);
	VectorRegister4Float tan_ps    (VectorRegister4Float x);
	VectorRegister4Float cot_ps    (VectorRegister4Float x);
	VectorRegister4Float atan_ps   (VectorRegister4Float x);
	VectorRegister4Float atan2_ps  (VectorRegister4Float y, VectorRegister4Float x);
};
