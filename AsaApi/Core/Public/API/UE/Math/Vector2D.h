...
template<> const FVector2f FVector2f::ZeroVector;
template<> const FVector2f FVector2f::UnitVector;
template<> const FVector2f FVector2f::Unit45Deg;
template<> const FVector2d FVector2d::ZeroVector;
template<> const FVector2d FVector2d::UnitVector;
template<> const FVector2d FVector2d::Unit45Deg;
#endif
