...
private:
	...
	friend bool LoadFromCompactBinary(FCbFieldView Field, FMD5Hash& OutHash); // inlining not available because we don't want FCbFieldView defined
...
public:
	...
	friend FCbWriter& operator<<(FCbWriter& Writer, const FSHAHash& Hash);
