...
extern const int32					GPackageFileUE4Version;				// Unreal4 Version Number.

UE_DEPRECATED(5.0, "Use GPackageFileLicenseeUEVersion instead")
extern const int32					GPackageFileLicenseeUE4Version;		// Licensee Version Number.

extern const FPackageFileVersion	GPackageFileUEVersion;				// Unreal Version Number.
extern const FPackageFileVersion	GOldestLoadablePackageFileUEVersion;// The oldest Unreal Version number that we can load.
extern const int32					GPackageFileLicenseeUEVersion;		// Licensee Version Number.
