...
our %config = (
    "AR" => "C:\\Program Files\\Microsoft Visual Studio\\2022\\Community\\VC\\Tools\\MSVC\\14.37.32822\\bin\\Hostx64\\x86\\lib.exe",
    "ARFLAGS" => [
        "-machine:X86 -nologo"
    ],
    "AS" => "C:\\Users\\Pelayo\\AppData\\Local\\vcpkg\\downloads\\tools\\nasm\\nasm-2.16.01\\nasm.exe",
    "CC" => "C:\\Program Files\\Microsoft Visual Studio\\2022\\Community\\VC\\Tools\\MSVC\\14.37.32822\\bin\\Hostx64\\x86\\cl.exe",
    "CFLAGS" => [
    ...
    "LD" => "C:\\Program Files\\Microsoft Visual Studio\\2022\\Community\\VC\\Tools\\MSVC\\14.37.32822\\bin\\Hostx64\\x86\\link.exe",
    "LDFLAGS" => [
    ...
    "PERL" => "C:\\Users\\Pelayo\\AppData\\Local\\vcpkg\\downloads\\tools\\perl\\5.32.1.1\\perl\\bin\\perl.exe",
    "RC" => "rc",
    "RCFLAGS" => [],
    "afalgeng" => "",
    "api" => "30100",
    ...
    "openssldir" => "D:\\ArkAscendedApi\\ServerAPI\\AsaApi\\vcpkg_installed\\vcpkg\\pkgs\\openssl_x86-windows\\debug",
    "options" => "enable-static-engine enable-capieng enable-shared --debug --prefix=D:\\ArkAscendedApi\\ServerAPI\\AsaApi\\vcpkg_installed\\vcpkg\\pkgs\\openssl_x86-windows\\debug --openssldir=D:\\ArkAscendedApi\\ServerAPI\\AsaApi\\vcpkg_installed\\vcpkg\\pkgs\\openssl_x86-windows\\debug no-acvp-tests no-afalgeng no-apps no-asan no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fips no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-ktls no-loadereng no-makedepend no-md2 no-msan no-rc5 no-sctp no-ssl3 no-ssl3-method no-tests no-trace no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
    "patch" => "4",
    "perl_archname" => "MSWin32-x86-multi-thread-64int",
    "perl_cmd" => "C:\\Users\\Pelayo\\AppData\\Local\\vcpkg\\downloads\\tools\\perl\\5.32.1.1\\perl\\bin\\perl.exe",
    "perl_version" => "5.32.1",
    "perlargv" => [
        ...
        "VC-WIN32",
        "--debug",
        "--prefix=D:\\ArkAscendedApi\\ServerAPI\\AsaApi\\vcpkg_installed\\vcpkg\\pkgs\\openssl_x86-windows\\debug",
        "--openssldir=D:\\ArkAscendedApi\\ServerAPI\\AsaApi\\vcpkg_installed\\vcpkg\\pkgs\\openssl_x86-windows\\debug",
        "AS=C:\\Users\\Pelayo\\AppData\\Local\\vcpkg\\downloads\\tools\\nasm\\nasm-2.16.01\\nasm.exe",
        "CC=C:\\Program Files\\Microsoft Visual Studio\\2022\\Community\\VC\\Tools\\MSVC\\14.37.32822\\bin\\Hostx64\\x86\\cl.exe",
...
unless (caller) {
    ...
    use lib 'D:/ArkAscendedApi/ServerAPI/AsaApi/vcpkg_installed/vcpkg/blds/openssl/x86-windows-dbg/util/perl';
    use OpenSSL::fallback 'D:/ArkAscendedApi/ServerAPI/AsaApi/vcpkg_installed/vcpkg/blds/openssl/x86-windows-dbg/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib 'D:/ArkAscendedApi/ServerAPI/AsaApi/vcpkg_installed/vcpkg/blds/openssl/x86-windows-dbg/Configurations';
        use gentemplate;
