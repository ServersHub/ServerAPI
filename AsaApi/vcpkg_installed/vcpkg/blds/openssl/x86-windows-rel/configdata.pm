...
our %config = (
    ...
    "perlargv" => [
        ...
        "no-makedepend",
        "VC-WIN32",
        "--prefix=D:\\ArkAscendedApi\\ServerAPI\\AsaApi\\vcpkg_installed\\vcpkg\\pkgs\\openssl_x86-windows",
        "--openssldir=D:\\ArkAscendedApi\\ServerAPI\\AsaApi\\vcpkg_installed\\vcpkg\\pkgs\\openssl_x86-windows",
        "AS=C:\\Users\\Pelayo\\AppData\\Local\\vcpkg\\downloads\\tools\\nasm\\nasm-2.16.01\\nasm.exe",
        "CC=C:\\Program Files\\Microsoft Visual Studio\\2022\\Community\\VC\\Tools\\MSVC\\14.37.32822\\bin\\Hostx64\\x86\\cl.exe",
...
unless (caller) {
    ...
    use lib 'D:/ArkAscendedApi/ServerAPI/AsaApi/vcpkg_installed/vcpkg/blds/openssl/x86-windows-rel/util/perl';
    use OpenSSL::fallback 'D:/ArkAscendedApi/ServerAPI/AsaApi/vcpkg_installed/vcpkg/blds/openssl/x86-windows-rel/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib 'D:/ArkAscendedApi/ServerAPI/AsaApi/vcpkg_installed/vcpkg/blds/openssl/x86-windows-rel/Configurations';
        use gentemplate;
