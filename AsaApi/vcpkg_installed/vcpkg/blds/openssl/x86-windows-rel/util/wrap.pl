...
BEGIN {
    ...
    require 'D:/ArkAscendedApi/ServerAPI/AsaApi/vcpkg_installed/vcpkg/blds/openssl/x86-windows-rel/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = 'D:/ArkAscendedApi/ServerAPI/AsaApi/vcpkg_installed/vcpkg/blds/openssl/x86-windows-rel/test/fips-and-base.cnf';
    shift;
